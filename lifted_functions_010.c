...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00463020(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->esi;
    ...
    if (*(uint32_t*)(cpu->eax + ((uint32_t)(cpu->ebx) * 4u)) == (uint32_t)(0u)) goto label_00063088;
    ++cpu->ebx;
    goto label_00063058;
    label_00063088:
    ...
    *(uint32_t*)(cpu->esp + 0x30u) = cpu->ebx;
    ...
    cpu->eax = cpu->edi;
    *(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->ebx) * 4u)) = cpu->ebp;
    *(uint32_t*)(cpu->ebp) = 0u;
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    ...
    if (*(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->esi) * 4u)) != (uint32_t)(0u)) goto label_0006318B;
    label_00063158:
    ...
    *(uint32_t*)(cpu->ebp + 0xE80u) = 0xFFu;
    cpu->eax = (cpu->eax & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->ebx)) & 0xFFu);
    cpu->edi = 0u;
    cpu->edx = 0u;
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ecx;
    ...
    cpu->eax = (int64_t)(int32_t)(cpu->eax) * (int64_t)(int32_t)(*(uint32_t*)(cpu->esp + ((uint32_t)(cpu->edi) * 4u) + 0x30u));
    *(uint32_t*)(cpu->esp + ((uint32_t)(cpu->edi) * 4u) + 0x30u) = cpu->eax;
    ...
    *(uint32_t*)(cpu->esp + ((uint32_t)(cpu->edi) * 4u) + 0x30u) = 0u;
    goto label_000632BC;
    label_00063269:
    cpu->ecx = *(uint32_t*)(cpu->esp + ((uint32_t)(cpu->edi) * 4u) + 0x30u);
    ...
    cpu->ebx = *(uint32_t*)(((uint32_t)(cpu->ebx) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_font_atlas_layout_runtime.code_base[0]));
    { uint64_t l=(uint64_t)(cpu->ebx), r=(uint64_t)(cpu->ecx), c=(uint64_t)(0u), v=l + r + c; lift_flags_add(cpu,l,r,c,v,32u); cpu->ebx = v; }
    *(uint32_t*)(cpu->esp + ((uint32_t)(cpu->edi) * 4u) + 0x30u) = cpu->ebx;
    cpu->ebx = *(uint32_t*)(cpu->esp + 0x14u);
    label_00063288:
    cpu->eax = cpu->eax & 0xFFu;
    cpu->ecx = cpu->eax;
    cpu->ecx <<= 4u;
    if (*(uint32_t*)(cpu->ecx + ((uint32_t)(uintptr_t)&g_sfera_font_runtime.glyphs[0].defined)) != (uint32_t)(0u)) goto label_000632A8;
    cpu->eax = *(uint32_t*)(cpu->esi + 0x6DB0u);
    cpu->ecx = *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_static_render_lookup_runtime.glyph_metrics[124][0]));
    goto label_000632B8;
    label_000632A8:
    cpu->eax = (uint32_t)(cpu->eax + ((uint32_t)(cpu->eax) * 4u));
    cpu->eax += *(uint32_t*)(cpu->esi + 0x6DB0u);
    cpu->ecx = *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_static_render_lookup_runtime.glyph_metrics[0][0]));
    label_000632B8:
    *(uint32_t*)(cpu->esp + ((uint32_t)(cpu->edi) * 4u) + 0x30u) = (uint64_t)(*(uint32_t*)(cpu->esp + ((uint32_t)(cpu->edi) * 4u) + 0x30u)) + (uint64_t)(cpu->ecx) + (uint64_t)(0u);
    label_000632BC:
    cpu->eax = (cpu->eax & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->ebx + 1u)) & 0xFFu);
    ++cpu->ebx;
    ...
    *(uint32_t*)(cpu->ebp + 0x2Cu) = cpu->edi;
    ...
    cpu->ecx = (int64_t)(int32_t)(cpu->ecx) * (int64_t)(int32_t)(*(uint32_t*)(cpu->eax + ((uint32_t)(uintptr_t)&g_sfera_font_atlas_layout_runtime.cell_step[0])));
    cpu->ecx += *(uint32_t*)(cpu->eax + ((uint32_t)(uintptr_t)&g_sfera_font_atlas_layout_runtime.span[0]));
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->edx;
    ...
    { uint64_t l=(uint64_t)(*(uint8_t*)(cpu->esi + 0x6DACu)), r=(uint64_t)(1u), v=l & r; lift_flags_logic(cpu,v,8u); }
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->ecx;
    if ((int32_t)*(uint32_t*)(cpu->esp + 0x18u) <= (int32_t)(uint32_t)(cpu->eax)) goto label_000633BC;
    if ((uint8_t)((*(uint8_t*)(cpu->esi + 0x6DACu)) & (4u)) == 0u) goto label_000633BC;
    cpu->ecx = cpu->eax;
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x10u)) + (uint64_t)(cpu->ecx) + (uint64_t)(0u);
    ...
    if ((uint8_t)((*(uint8_t*)(cpu->esi + 0x6DACu)) & (8u)) == 0u) goto label_000633D9;
    cpu->edx = cpu->ecx;
    cpu->edx -= cpu->eax;
    cpu->ebx += cpu->edx;
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->ecx;
    ...
    if ((uint8_t)((*(uint8_t*)(cpu->esi + 0x6DACu)) & (4u)) == 0u) goto label_000633F6;
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = 0u;
    ...
    if ((uint8_t)((*(uint8_t*)(cpu->esi + 0x6DACu)) & (8u)) == 0u) goto label_00063407;
    cpu->eax -= cpu->ebx;
    cpu->ebx = 0u;
    label_00063407:
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x10u);
    ...
    *(uint32_t*)(cpu->ebp + 0x18u) = cpu->eax;
    ...
    cpu->ebp += 0x30u;
    label_00063424:
    if ((uint8_t)((*(uint8_t*)(cpu->esi + 0x6DACu)) & (0x10u)) == 0u) goto label_00063443;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x14u);
    cpu->eax -= *(uint32_t*)(cpu->esp + ((uint32_t)(cpu->ecx) * 4u) + 0x30u);
    cpu->edx = ((int32_t)cpu->eax < 0) ? 0xFFFFFFFFu : 0u;
    { uint64_t l=(uint64_t)(cpu->eax), r=(uint64_t)(cpu->edx), c=(uint64_t)(0u), v=l - r - c; lift_flags_sub(cpu,l,r,c,v,32u); cpu->eax = v; }
    cpu->eax = (uint32_t)((int32_t)(cpu->eax) >> 1u);
    cpu->eax += *(uint32_t*)(cpu->esp + 0x10u);
    ...
    *(uint32_t*)(cpu->ebp) = cpu->eax;
    cpu->eax = *(uint32_t*)(cpu->esi + 0x6DB0u);
    cpu->eax += cpu->eax;
    cpu->edx = *(uint32_t*)(cpu->eax + cpu->eax + ((uint32_t)(uintptr_t)&g_sfera_font_atlas_layout_runtime.cell_step[0]));
    cpu->eax += cpu->eax;
    cpu->edx = (int64_t)(int32_t)(cpu->edx) * (int64_t)(int32_t)(cpu->ecx);
    cpu->edx -= *(uint32_t*)(cpu->eax + ((uint32_t)(uintptr_t)&g_sfera_font_atlas_layout_runtime.origin[0]));
    ++cpu->ecx;
    ...
    *(uint32_t*)(cpu->ebp + 0x4ACu) = cpu->edx;
    ...
    label_00063488:
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_main_view_state_runtime.projection_sample_count) = (uint64_t)((*(uint32_t*)(void*)&g_sfera_main_view_state_runtime.projection_sample_count)) + 1u;
    if ((uint8_t)((*(uint8_t*)(cpu->esi + 0x6DACu)) & (0x20u)) == 0u) goto label_000634BE;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_004634E0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    if (*(uint32_t*)(cpu->eax + ((uint32_t)(cpu->esi) * 4u)) == (uint32_t)(0u)) goto label_00063AE1;
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463553u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x463553u));
    ...
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x440u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46356Bu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46356Bu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0x30u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x444u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463583u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x463583u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x444u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46359Bu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46359Bu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x448u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4635B3u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x4635B3u));
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x2Cu));
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x448u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4635CBu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x4635CBu));
    ...
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4636EFu)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x4636EFu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x14u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463703u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x463703u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0x30u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x18u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463717u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x463717u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x18u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46372Bu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46372Bu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x1Cu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46373Fu)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x46373Fu));
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x2Cu));
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x1Cu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463753u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x463753u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u)); lift_x87_push(cpu, cpu->fpu[0u]);
    ...
    *(uint32_t*)(cpu->esi + 0x160u) = cpu->eax;
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x160u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x150u)));
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x15Cu));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x154u)));
    cpu->fpu[1u] = cpu->fpu[1u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esi + 0x164u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x158u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x154u)));
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x160u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x14Cu)));
    cpu->fpu[1u] = cpu->fpu[1u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esi + 0x168u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x15Cu));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x14Cu)));
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x158u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x150u)));
    cpu->fpu[1u] = cpu->fpu[1u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esi + 0x16Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x24u)); lift_x87_push(cpu, cpu->fpu[0u]);
    lift_x87_push(cpu, cpu->fpu[2u]);
    lift_x87_push(cpu, cpu->fpu[1u]);
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46395Bu)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x46395Bu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    ...
    *(float*)(cpu->esi + 0x1Cu) = cpu->fpu[0u];
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463979u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x463979u));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46398Eu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46398Eu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x2Cu)); lift_x87_push(cpu, cpu->fpu[0u]);
    ...
    *(float*)(cpu->esp + 0x24u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    goto label_00063A3F;
    label_000639EC:
    if (*(uint8_t*)(cpu->esi + 0x138u) != (uint8_t)(0u)) goto label_00063547;
    ...
    *(float*)(cpu->esi + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00063A3F:
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x28u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463A48u)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x463A48u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    cpu->fpu[0u] = (4.7123894691467285) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463A63u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x463A63u));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x1Cu)));
    *(double*)(cpu->esp + 0x30u) = cpu->fpu[0u];
    lift_x87_pop(cpu); lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463A7Cu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x463A7Cu));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x18u)));
    cpu->fpu[0u] = (*(double*)(cpu->esp + 0x30u)) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463A9Du)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x463A9Du));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    cpu->fpu[0u] = (1.5707964897155762) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00463B30(LiftCpu* cpu, uint32_t stop_address) {
    ...
    label_00063B63:
    cpu->eax = g_sfera_world_objects.object_handles.data;
    if (*(uint32_t*)(cpu->eax + ((uint32_t)(cpu->esi) * 4u)) == (uint32_t)(0u)) goto label_00063E72;
    ...
    label_00063B97:
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x14u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x2CCu));
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x18u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x2D0u));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]); lift_x87_pop(cpu); lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=(uint64_t)(((cpu->eax >> 8u) & 0xFFu)), r=(uint64_t)(0x44u), v=l & r; lift_flags_logic(cpu,v,8u); }
    if ((cpu->eflags & LIFT_FLAG_PF) != 0u) goto label_00063BD1;
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x1Cu));
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x2D4u));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]); lift_x87_pop(cpu); lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=(uint64_t)(((cpu->eax >> 8u) & 0xFFu)), r=(uint64_t)(0x44u), v=l & r; lift_flags_logic(cpu,v,8u); }
    ...
    *(uint32_t*)(cpu->esi + 0x2D4u) = cpu->eax;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463BF4u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x463BF4u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x14u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463C08u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x463C08u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x18u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463C1Cu)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x463C1Cu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0x28u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x18u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463C30u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x463C30u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0x24u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x1Cu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463C44u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x463C44u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 0x30u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x1Cu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x463C58u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x463C58u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u)); lift_x87_push(cpu, cpu->fpu[0u]);
    ...
    *(float*)(cpu->esi + 0x164u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[1u] = cpu->fpu[1u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esi + 0x168u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x14Cu));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x15Cu)));
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x150u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x158u)));
    cpu->fpu[1u] = cpu->fpu[1u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esi + 0x16Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->esi = lift_pop32(cpu);
    cpu->esp += 0x434u;
    cpu->esp += 4u; cpu->eip = stop_address; return;
    label_00063E26:
    if (*(uint8_t*)(cpu->esi + 0x138u) != (uint8_t)(0u)) goto label_00063B97;
    cpu->edx = *(uint32_t*)(cpu->esi + 4u);
    cpu->ecx = g_sfera_model_runtime.repository;
    lift_push32(cpu, cpu->edx);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00463EC0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->ebp;
    goto label_00063F4B;
    label_00063EFD:
    if (*(uint8_t*)(cpu->eax + 0x138u) != (uint8_t)(0u)) goto label_00063F45;
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->eax;
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x150u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)g_sfera_scene_vector_runtime.render_scale.y.f32));
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x14Cu));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)g_sfera_scene_vector_runtime.render_scale.x.f32));
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x154u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)g_sfera_scene_vector_runtime.render_scale.z.f32));
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    ...
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[0u] = (1.100000023841858) - (cpu->fpu[0u]);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (8.000000093488779e-07);
    *(float*)(cpu->esp + 0x38u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_compare(cpu, cpu->fpu[0u], 0.985);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    ...
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x20u)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[7u] = cpu->fpu[7u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4640A4u)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x4640A4u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    cpu->fpu[0u] = (4.7123894691467285) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4640BFu)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x4640BFu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4640D4u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x4640D4u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u)); lift_x87_push(cpu, cpu->fpu[0u]);
    ...
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x464148u)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x464148u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (4.7123894691467285) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x464163u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x464163u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x34u)));
    *(double*)(cpu->esp + 0x1Cu) = cpu->fpu[0u];
    lift_x87_pop(cpu); lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46417Cu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46417Cu));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x30u)));
    cpu->fpu[0u] = (*(double*)(cpu->esp + 0x1Cu)) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x2Cu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46419Du)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x46419Du));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (1.5707964897155762) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[1u] = (cpu->fpu[1u]) * (cpu->fpu[0u]);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4641C4u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x4641C4u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    cpu->fpu[0u] = -cpu->fpu[0u];
    cpu->esi = cpu->eax;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[1u]);
    cpu->esi &= 0xFFFFu;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4641D9u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x4641D9u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    cpu->fpu[0u] = -cpu->fpu[0u];
    cpu->ebx = cpu->eax;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[1u]);
    cpu->ebx &= 0xFFFFu;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4641EEu)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x4641EEu));
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x14u));
    cpu->eax &= 0xFFFFu;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[1u]);
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x464201u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x464201u));
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x18u));
    cpu->edi = cpu->eax;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[1u]);
    cpu->edi &= 0xFFFFu;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x464213u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x464213u));
    cpu->ebp = cpu->eax;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x28u);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->eax + 0x1Cu)));
    cpu->ebp &= 0xFFFFu;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x464227u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x464227u));
    cpu->eax &= 0xFFFFu;
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->eax;
    cpu->ecx = cpu->esi;
    cpu->ecx -= cpu->edi;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00464340(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->edi);
    cpu->fpu[0u] = -cpu->fpu[0u];
    *(float*)(cpu->esi + 0x150u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edi = *(uint32_t*)(cpu->esi + 0x14Cu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x168u));
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->edi;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x154u)));
    cpu->edi = *(uint32_t*)(cpu->esi + 0x150u);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x16Cu));
    ...
    *(uint32_t*)(cpu->esp + 0x2Cu) = cpu->eax;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x16Cu)));
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x164u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x154u)));
    cpu->fpu[1u] = cpu->fpu[1u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x18u);
    ...
    *(uint32_t*)(cpu->esp + 0x34u) = cpu->edx;
    ...
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46445Cu)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x46445Cu));
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u));
    cpu->fpu[0u] = (4.7123894691467285) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u));
    *(float*)(cpu->esi + 0x1Cu) = cpu->fpu[0u];
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46447Au)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x46447Au));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46448Fu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46448Fu));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x20u)); lift_x87_push(cpu, cpu->fpu[0u]);
    ...
    *(float*)(cpu->esp + 0x30u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    goto label_0006453C;
    label_000644E7:
    if (*(uint8_t*)(cpu->esi + 0x138u) != (uint8_t)(0u)) goto label_0006437C;
    ...
    *(float*)(cpu->esi + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x464549u)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x464549u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    cpu->fpu[0u] = (4.7123894691467285) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x464564u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x464564u));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x28u)));
    *(double*)(cpu->esp + 0xCu) = cpu->fpu[0u];
    lift_x87_pop(cpu); lift_x87_push(cpu, (double)*(float*)(cpu->esp + 8u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46457Du)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46457Du));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x24u)));
    cpu->fpu[0u] = (*(double*)(cpu->esp + 0xCu)) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x20u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46459Eu)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x46459Eu));
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 4u));
    cpu->fpu[0u] = (1.5707964897155762) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00464600(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(double*)(cpu->esp + 0x20u) = cpu->fpu[0u];
    lift_x87_pop(cpu); lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x464785u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x464785u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = -cpu->fpu[0u];
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x14u)));
    ...
    *(double*)(cpu->esp + 0x20u) = cpu->fpu[0u];
    lift_x87_pop(cpu); lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4647AAu)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x4647AAu));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x14u)));
    cpu->fpu[0u] = (*(double*)(cpu->esp + 0x20u)) - (cpu->fpu[0u]);
    *(float*)(cpu->esi + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    goto label_00064822;
    label_000647BF:
    if (*(uint8_t*)(cpu->eax + 0x138u) != (uint8_t)(0u)) goto label_0006471A;
    ...
    *(float*)(cpu->eax + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    label_000648EE:
    if (*(uint32_t*)(cpu->esp + 0x1Cu) == (uint32_t)(2u)) goto label_00064902;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00464BA0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x210u) = cpu->esi;
    ...
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(((uint32_t)(uintptr_t)"Error.log") + 8u)) & 0xFFFFu);
    cpu->ecx = *(uint32_t*)(((uint32_t)(uintptr_t)"Error.log") + 4u);
    cpu->eax = 0x6F727245u;
    cpu->ebx = native_function_address32(&::fflush);
    cpu->ebp = native_function_address32(&::fclose);
    *(uint32_t*)((uintptr_t)&g_sfera_log_runtime.files[0].path.words[1]) = cpu->ecx;
    cpu->ecx = *(uint32_t*)(((uint32_t)(uintptr_t)"test.log") + 4u);
    *(uint16_t*)((uintptr_t)&g_sfera_log_runtime.files[0].path.text[8]) = cpu->edx & 0xFFFFu;
    cpu->edx = (cpu->edx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)"test.log") + 8u)) & 0xFFu);
    g_sfera_log_runtime.files[0].path.words[0] = (uint32_t)(cpu->eax);
    cpu->eax = *(uint32_t*)((uintptr_t)"test.log");
    *(uint32_t*)((uintptr_t)&g_sfera_log_runtime.files[1].path.words[1]) = cpu->ecx;
    cpu->ecx = *(uint32_t*)((uintptr_t)"logs\\memory.log");
    *(uint8_t*)((uintptr_t)&g_sfera_log_runtime.files[1].path.text[8]) = cpu->edx & 0xFFu;
    cpu->edx = *(uint32_t*)(((uint32_t)(uintptr_t)"logs\\memory.log") + 4u);
    *(uint32_t*)((uintptr_t)&g_sfera_log_runtime.files[1].path.words[0]) = cpu->eax;
    cpu->eax = 0x7A120u;
    *(uint32_t*)((uintptr_t)&g_sfera_log_runtime.files[2].path.words[0]) = cpu->ecx;
    cpu->ecx = *(uint32_t*)(((uint32_t)(uintptr_t)"logs\\memory.log") + 8u);
    *(uint32_t*)((uintptr_t)&g_sfera_log_runtime.files[2].path.words[1]) = cpu->edx;
    cpu->edx = *(uint32_t*)(((uint32_t)(uintptr_t)"logs\\memory.log") + 0xCu);
    ...
    *(uint32_t*)((uintptr_t)&g_sfera_log_runtime.files[2].path.words[2]) = cpu->ecx;
    *(uint32_t*)((uintptr_t)&g_sfera_log_runtime.files[2].path.words[3]) = cpu->edx;
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->esi;
    ...
    cpu->esi = 0u;
    label_00064CD2:
    if (*(uint32_t*)(cpu->edi + 0xFFFFFFFCu) != (uint32_t)(cpu->esi)) goto label_00064DF3;
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x14u);
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    ...
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)"_e") + 2u)) & 0xFFu);
    ...
    label_000650D3:
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)((uint32_t)(uintptr_t)"_p")) & 0xFFFFu);
    cpu->eax = (cpu->eax & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)"_p") + 2u)) & 0xFFu);
    ...
    label_000650F5:
    cpu->ecx = (cpu->ecx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)((uint32_t)(uintptr_t)"_i")) & 0xFFFFu);
    cpu->edx = (cpu->edx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)"_i") + 2u)) & 0xFFu);
    ...
    label_00065119:
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)((uint32_t)(uintptr_t)"_d")) & 0xFFFFu);
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)"_d") + 2u)) & 0xFFu);
    (*(uint16_t*)(void*)&g_sfera_font_runtime.language_suffix[0]) = (uint16_t)((cpu->eax & 0xFFFFu));
    (*(uint8_t*)(void*)&g_sfera_font_runtime.language_suffix[2]) = (uint8_t)((cpu->ecx & 0xFFu));
    goto label_00064F06;
    label_00065136:
    ...
    cpu->eax = (cpu->eax & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)"_spa") + 4u)) & 0xFFu);
    ...
    *(uint8_t*)((uintptr_t)&g_sfera_font_runtime.language_suffix[4]) = cpu->eax & 0xFFu;
    ...
    label_0006515F:
    cpu->ecx = (cpu->ecx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)((uint32_t)(uintptr_t)"_f")) & 0xFFFFu);
    cpu->edx = (cpu->edx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)"_f") + 2u)) & 0xFFu);
    (*(uint16_t*)(void*)&g_sfera_font_runtime.language_suffix[0]) = (uint16_t)((cpu->ecx & 0xFFFFu));
    (*(uint8_t*)(void*)&g_sfera_font_runtime.language_suffix[2]) = (uint8_t)((cpu->edx & 0xFFu));
    goto label_00064F06;
    label_0006517E:
    ...
    cpu->esp = (uint32_t)(cpu->esp);
    label_000651A0:
    *(uint8_t*)(cpu->eax + ((uint32_t)(uintptr_t)g_sfera_ascii_lower_runtime.table)) = cpu->eax & 0xFFu;
    ++cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) < (int32_t)(uint32_t)(0x100u)) goto label_000651A0;
    for (uint32_t letter = 'A'; letter <= 'Z'; ++letter) { *(uint8_t*)(letter + ((uint32_t)(uintptr_t)g_sfera_ascii_lower_runtime.table)) = (uint8_t)(letter + ('a' - 'A')); }
    ...
    label_0006521F:
    if (*(uint8_t*)(cpu->eax + 0x3E7u) != (uint8_t)(2u)) goto label_00065244;
    *(uint8_t*)(cpu->eax + 0x3E7u) = 1u;
    cpu->eax = *(uint32_t*)(void*)&g_sfera_main_input_state_runtime.input_mode;
    cpu->eax = (cpu->eax & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->eax + 0x3E7u)) & 0xFFu);
    ...
    *(uint32_t*)(cpu->esp + 0x34u) = 1u;
    ...
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_input_device_runtime.minimum_lod_distance.f32));
    lift_x87_push(cpu, 0.0);
    lift_x87_push(cpu, cpu->fpu[0u]);
    ...
    *(float*)((uint32_t)(uintptr_t)&g_sfera_input_device_runtime.minimum_lod_distance.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_0006537D:
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_input_device_runtime.lod_distance.f32));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]); lift_x87_pop(cpu); lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=(uint64_t)(((cpu->eax >> 8u) & 0xFFu)), r=(uint64_t)(0x44u), v=l & r; lift_flags_logic(cpu,v,8u); }
    if ((cpu->eflags & LIFT_FLAG_PF) != 0u) goto label_00065398;
    lift_x87_push(cpu, (double)20.0f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_input_device_runtime.lod_distance.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00065398:
    ...
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_cursor_manager_runtime.initialized_flags) = (uint64_t)(g_sfera_cursor_manager_runtime.initialized_flags) | (uint64_t)(cpu->ebp);
    ...
    *(uint8_t*)(cpu->esp + 0x210u) = 0u;
    ...
    goto label_00065589;
    label_0006550E:
    { uint64_t l=(uint64_t)(*(uint8_t*)(cpu->esp + 0x38u)), r=(uint64_t)(0x10u), v=l & r; lift_flags_logic(cpu,v,8u); }
    lift_push32(cpu, cpu->eax);
    ...
    *(uint32_t*)(cpu->eax + 0xCu) = cpu->ebx;
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    cpu->eax += 0x20u;
    *(float*)(cpu->eax + 0xFFFFFFE4u) = cpu->fpu[0u];
    ...
    *(uint32_t*)((uintptr_t)&g_sfera_world_load_runtime.snow_path_object) = cpu->eax;
    cpu->eax = *(uint32_t*)(void*)&g_sfera_client_config_runtime.state_09;
    *(uint8_t*)(cpu->esp + 0x210u) = 0u;
    ...
    cpu->eax = *(uint32_t*)(((uint32_t)(uintptr_t)"fonts\\font1.pcx") + 4u);
    cpu->ecx = *(uint32_t*)(((uint32_t)(uintptr_t)"fonts\\font1.pcx") + 8u);
    *(uint32_t*)(cpu->esp + 0x160u) = cpu->edx;
    cpu->edx = *(uint32_t*)(((uint32_t)(uintptr_t)"fonts\\font1.pcx") + 0xCu);
    ...
    *(uint32_t*)(cpu->esp + 0x16Cu) = cpu->edx;
    ...
    cpu->edx = *(uint32_t*)(((uint32_t)(uintptr_t)"fonts\\font2.pcx") + 4u);
    cpu->eax = *(uint32_t*)(((uint32_t)(uintptr_t)"fonts\\font2.pcx") + 8u);
    *(uint32_t*)(cpu->esp + 0x160u) = cpu->ecx;
    cpu->ecx = *(uint32_t*)(((uint32_t)(uintptr_t)"fonts\\font2.pcx") + 0xCu);
    ...
    *(uint32_t*)(cpu->esp + 0x16Cu) = cpu->ecx;
    ...
    lift_x87_push(cpu, 0.0);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[0][0]) = cpu->fpu[0u];
    cpu->eax = 0u;
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[1][0]) = cpu->fpu[0u];
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    lift_x87_push(cpu, 1.0);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[2][0]) = cpu->fpu[0u];
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[3][0]) = cpu->fpu[0u];
    lift_x87_push(cpu, (double)-1.0f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[0][1]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[1][2]) = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[1][1]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[2][1]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[3][1]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[0][2]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[2][2]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[3][2]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[0][3]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[1][3]) = cpu->fpu[0u];
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[2][3]) = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_model_coordinate_matrix.m[3][3]) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 6.0);
    label_00065755:
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x14u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) / (cpu->fpu[1u]);
    *(float*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_static_render_lookup_runtime.normalized_levels[0])) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax += cpu->ebp;
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) < (int32_t)(uint32_t)(7u)) goto label_00065755;
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)2.0f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_render_sample_runtime.blend_weights[0].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)0.20000000298023224f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_render_sample_runtime.blend_weights[1].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)0.75f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_render_sample_runtime.blend_weights[2].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)1.2000000476837158f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_render_sample_runtime.blend_weights[3].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)2.5f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_render_sample_runtime.blend_weights[4].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)3.0f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_render_sample_runtime.blend_weights[5].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)4.0f);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_render_sample_runtime.blend_weights[6].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->edi;
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) + (1.0);
    cpu->fpu[0u] = (cpu->fpu[0u]) - (0.041666666666666664);
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (0.5);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4657F9u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x4657F9u));
    --cpu->eax;
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    ...
    ++cpu->ebp;
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->edi;
    *(float*)(cpu->edx + ((uint32_t)(cpu->ebp) * 4u) + 0xFFFFFFFCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->ebp) = cpu->ebx;
    ...
    if (*(uint32_t*)(cpu->ebp) == (uint32_t)(cpu->ebx)) goto label_00065A9C;
    cpu->ebp += 0x10u;
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[2u]);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4658E6u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x4658E6u));
    lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->ebx = (uint32_t)(cpu->eax + 0xFFFFFFFFu);
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->ebx;
    cpu->fpu[0u] = (cpu->fpu[0u]) - ((double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x18u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (cpu->fpu[2u]);
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (64.0);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[2u]);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46590Au)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46590Au));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (0.0833333358168602);
    *(uint8_t*)(cpu->esi + cpu->ebp + ((uint32_t)(uintptr_t)&g_sfera_static_render_lookup_runtime.quantization_b[0])) = cpu->eax & 0xFFu;
    *(uint8_t*)(cpu->esi + cpu->ebp + ((uint32_t)(uintptr_t)&g_sfera_static_render_lookup_runtime.quantization_a[0])) = cpu->ebx & 0xFFu;
    ++cpu->esi;
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x14u)))));
    ++cpu->edx;
    *(uint16_t*)(cpu->esp + 0x14u) = cpu->fpu_control;
    cpu->ecx += 4u;
    ...
    *(uint16_t*)(cpu->esp + 0x14u) = cpu->fpu_control;
    ...
    cpu->eax |= 0xC00u;
    *(uint32_t*)(cpu->esp + 0x2Cu) = cpu->eax;
    cpu->fpu_control = *(uint16_t*)(cpu->esp + 0x2Cu);
    *(uint32_t*)(cpu->esp + 0x2Cu) = lift_x87_round(cpu, cpu->fpu[0u], 0u);
    lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->eax;
    cpu->fpu_control = *(uint16_t*)(cpu->esp + 0x28u);
    *(uint32_t*)(cpu->esp + 0x28u) = lift_x87_round(cpu, cpu->fpu[0u], 0u);
    lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = lift_x87_round(cpu, cpu->fpu[0u], 0u);
    lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x18u)) + 1u;
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint8_t*)(((uint32_t)(cpu->ebx) * 2u) + ((uint32_t)(uintptr_t)&g_sfera_main_input_state_runtime.landscape_texture_lut[0][0])) = cpu->ebx & 0xFFu;
    *(uint8_t*)(((uint32_t)(cpu->ebx) * 2u) + ((uint32_t)(uintptr_t)&g_sfera_main_input_state_runtime.landscape_texture_lut[0][1])) = 0u;
    goto label_00065AEF;
    label_00065A9C:
    ...
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x20u)));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[2u]);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x465AC9u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x465AC9u));
    cpu->ecx = cpu->eax;
    cpu->eax = cpu->ebx;
    cpu->eax -= cpu->ecx;
    ...
    *(uint8_t*)(((uint32_t)(cpu->ebx) * 2u) + ((uint32_t)(uintptr_t)&g_sfera_main_input_state_runtime.landscape_texture_lut[0][0])) = cpu->ecx & 0xFFu;
    *(uint8_t*)(((uint32_t)(cpu->ebx) * 2u) + ((uint32_t)(uintptr_t)&g_sfera_main_input_state_runtime.landscape_texture_lut[0][1])) = cpu->eax & 0xFFu;
    label_00065AEF:
    ++cpu->ebx;
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->ebx;
    ...
    cpu->esp += 0xCu;
    *(uint8_t*)((uintptr_t)&g_sfera_static_render_lookup_runtime.glyph_presence[0xFF]) = 1u;
    ...
    *(uint8_t*)((uintptr_t)&g_sfera_static_render_lookup_runtime.glyph_presence[0x2E]) = 1u;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00465B80(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint8_t*)(cpu->esi + cpu->ecx) = cpu->edx & 0xFFu;
    ...
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)".mdl") + 4u)) & 0xFFu);
    ...
    *(uint32_t*)(cpu->esp + 8u) = cpu->esi;
    ...
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->ebx + 0x17u)) & 0xFFu);
    (*(uint8_t*)(void*)&g_sfera_main_command_state_runtime.command_enabled) = (uint8_t)((cpu->ecx & 0xFFu));
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->ebx + 0x18u)) & 0xFFFFu);
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->ebx + 0xF6u));
    *(float*)((uint32_t)(uintptr_t)&g_sfera_landscape_patch_lookup_runtime.parameter.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax += cpu->ecx;
    label_00065E96:
    if (*(uint32_t*)(cpu->esp + 0x10u) == (uint32_t)(cpu->eax)) goto label_00065EAB;
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->edi;
    ...
    cpu->esp += 0xCu;
    *(uint8_t*)(cpu->esi + ((uint32_t)(uintptr_t)&g_sfera_model_material_lookup_runtime.material_name[0])) = 0u;
    ...
    *(uint16_t*)(cpu->edx + ((uint32_t)(cpu->eax) * 2u)) = cpu->ebp & 0xFFFFu;
    ++cpu->eax;
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    ...
    *(uint32_t*)(cpu->ebp + 0x84u) = cpu->eax;
    ...
    lift_movs32(cpu, 1u);
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_landscape_patch_lookup_runtime.parameter.f32));
    *(float*)(cpu->ebp + 0x194u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)2.0f);
    lift_x87_compare(cpu, cpu->fpu[0u], ((double)*(float*)(cpu->ebp + 0x194u)));
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    ...
    *(uint32_t*)(cpu->ebp + 0x19Cu) = cpu->edx;
    ...
    if (*(uint8_t*)(cpu->ebp + 0x50u) != (uint8_t)(0u)) goto label_000660A1;
    cpu->eax = 1u;
    goto label_000660A3;
    label_0006608D:
    ...
    *(float*)(cpu->ebp + 0x1D4u) = cpu->fpu[0u];
    lift_push32(cpu, 0u);
    *(float*)(cpu->ebp + 0x1D8u) = cpu->fpu[0u];
    *(uint32_t*)(cpu->ebp + 0x1BCu) = cpu->eax;
    *(float*)(cpu->ebp + 0x1DCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->ebp + 0x1A8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_000660F6:
    lift_push32(cpu, 0u);
    ...
    lift_x87_push(cpu, (double)-1.0f);
    *(float*)(cpu->ebp + 0x1ACu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_0006611D:
    lift_push32(cpu, 0u);
    ...
    *(float*)(cpu->ebp + 0x1B0u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00066144:
    lift_push32(cpu, 0u);
    ...
    *(float*)(cpu->ebp + 0x1B8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_0006616B:
    lift_push32(cpu, 0u);
    ...
    lift_x87_push(cpu, (double)2.0f);
    *(float*)(cpu->ebp + 0x1B4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00066192:
    lift_push32(cpu, 0u);
    ...
    lift_x87_push(cpu, (double)-1.0f);
    *(float*)(cpu->ebp + 0x1C0u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_000661B9:
    lift_push32(cpu, 0u);
    ...
    *(double*)(cpu->esp) = cpu->fpu[0u];
    lift_x87_pop(cpu);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4661F5u)); sfera_sub_004EED66(cpu, LIFT_CODE_TOKEN_VA(0x4661F5u));
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->esp += 8u;
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x466205u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x466205u));
    ...
    *(uint32_t*)(cpu->ebp + 0x24u) = cpu->eax;
    ...
    cpu->ecx += g_sfera_process_runtime.packed_layout_bytes;
    label_00066278:
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_process_runtime.packed_layout_bytes) = (uint64_t)(g_sfera_process_runtime.packed_layout_bytes) + (uint64_t)(cpu->eax) + (uint64_t)(0u);
    ...
    *(uint32_t*)(cpu->ebp + 0x3Cu) = cpu->ecx;
    ...
    label_000662E8:
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_process_runtime.packed_layout_bytes) = (uint64_t)(g_sfera_process_runtime.packed_layout_bytes) + (uint64_t)(cpu->ecx) + (uint64_t)(0u);
    ...
    *(uint32_t*)(cpu->ebp + 0x68u) = cpu->ecx;
    ...
    cpu->ecx += g_sfera_process_runtime.packed_layout_bytes;
    label_00066413:
    { uint64_t l=(uint64_t)(g_sfera_process_runtime.packed_layout_bytes), r=(uint64_t)(cpu->eax), c=(uint64_t)(0u), v=l + r + c; lift_flags_add(cpu,l,r,c,v,32u); *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_process_runtime.packed_layout_bytes) = v; }
    ...
    *(uint32_t*)(cpu->esi + 8u) = cpu->eax;
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->ecx + cpu->esi + 0x18u));
    cpu->eax = *(uint32_t*)(cpu->ebp + 0x24u);
    *(float*)(cpu->eax + cpu->edx + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->esi = g_sfera_recovered_static_runtime.animation_state;
    cpu->eax = *(uint32_t*)(cpu->ebp + 0x24u);
    lift_x87_push(cpu, (double)*(float*)(cpu->ecx + cpu->esi + 0x1Cu));
    *(float*)(cpu->eax + cpu->edx + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x14u);
    ++cpu->eax;
    cpu->ecx += 0x20u;
    cpu->edx += 0x24u;
    ...
    *(uint8_t*)(cpu->edi + cpu->eax) = cpu->edx & 0xFFu;
    ...
    cpu->edx = *(uint16_t*)(cpu->edi + ((uint32_t)(cpu->edx) * 2u));
    ...
    *(uint16_t*)(cpu->eax + cpu->ecx + 0x10u) = cpu->edx & 0xFFFFu;
    ...
    if (*(uint8_t*)(cpu->ecx + 0x84u) == (uint8_t)(0u)) goto label_0006665C;
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = 0u;
    ...
    cpu->ecx = (uint32_t)(cpu->ecx);
    label_000666A0:
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->edi)) & 0xFFu);
    ...
    *(uint8_t*)(cpu->esi + cpu->ecx + 0x20u) = cpu->eax & 0xFFu;
    if (*(uint8_t*)(cpu->ebp + 0x50u) == (uint8_t)(0u)) goto label_00066717;
    cpu->eax = g_sfera_recovered_static_runtime.client_state_04;
    cpu->eax = *(uint8_t*)(cpu->edx + cpu->eax + 0x23u);
    cpu->ecx = *(uint32_t*)(cpu->ebp + 0x3Cu);
    *(uint8_t*)(cpu->esi + cpu->ecx + 0x25u) = cpu->eax & 0xFFu;
    cpu->eax = g_sfera_recovered_static_runtime.client_state_04;
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edx + cpu->eax + 0x24u)) & 0xFFFFu);
    cpu->ecx = *(uint32_t*)(cpu->ebp + 0x3Cu);
    ...
    *(uint32_t*)(cpu->edx + 0xCu) = cpu->eax;
    ...
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->eax + cpu->edx)) & 0xFFFFu);
    cpu->ecx = *(uint32_t*)(cpu->ebp + 0x58u);
    *(uint16_t*)(cpu->eax + cpu->ecx) = cpu->edx & 0xFFFFu;
    cpu->edx = g_sfera_spatial_index_runtime.quadtree_state;
    cpu->edx = (cpu->edx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->eax + cpu->edx + 2u)) & 0xFFu);
    cpu->ecx = *(uint32_t*)(cpu->ebp + 0x58u);
    ...
    *(uint32_t*)(cpu->ecx + 0x14u) = cpu->eax;
    ...
    cpu->eax = g_sfera_client_main_scalar_runtime.state_05;
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + cpu->eax + 0xCu));
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x3Cu);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->esi + cpu->eax)));
    *(float*)(cpu->esp + 0x34u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + cpu->eax + 0x10u));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->esi + cpu->eax + 4u)));
    *(float*)(cpu->esp + 0x38u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + cpu->eax + 0x14u));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->esi + cpu->eax + 8u)));
    ...
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4669D9u)); sfera_sub_004EE9EC(cpu, LIFT_CODE_TOKEN_VA(0x4669D9u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x14u);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x3Cu);
    ++cpu->eax;
    *(float*)(cpu->edi + cpu->edx + 0xA8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    cpu->esi += 0x18u;
    cpu->edi += 0xACu;
    if ((int32_t)(uint32_t)(cpu->eax) < (int32_t)(uint32_t)(g_sfera_recovered_static_runtime.input_state_a)) goto label_000668D0;
    label_00066A09:
    if (*(uint32_t*)(cpu->ebp + 0x6Cu) != (uint32_t)(2u)) goto label_00066A51;
    cpu->eax = g_sfera_main_aux_runtime.resource_word;
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = 0u;
    ...
    cpu->ecx = *(uint32_t*)(cpu->ebp + 0x3Cu);
    cpu->edx = (cpu->edx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->esp + 0x18u)) & 0xFFu);
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    ...
    label_00066B7D:
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0xC4u));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0x88u)));
    *(float*)(cpu->esp + 0x40u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x40u);
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0xC8u));
    *(uint32_t*)(cpu->esp + 0x34u) = cpu->ecx;
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0x8Cu)));
    *(float*)(cpu->esp + 0x44u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x44u);
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0xCCu));
    *(uint32_t*)(cpu->esp + 0x38u) = cpu->edx;
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0x90u)));
    *(float*)(cpu->esp + 0x48u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x48u);
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x88u));
    *(uint32_t*)(cpu->esp + 0x3Cu) = cpu->eax;
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0xACu)));
    *(float*)(cpu->esp + 0x28u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x28u);
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x8Cu));
    *(uint32_t*)(cpu->esp + 0x5Cu) = cpu->ecx;
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0xB0u)));
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x2Cu);
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x90u));
    *(uint32_t*)(cpu->esp + 0x60u) = cpu->edx;
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0xB4u)));
    *(float*)(cpu->esp + 0x30u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x64u) = cpu->eax;
    ...
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x466C3Bu)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x466C3Bu));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (4.7123894691467285) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x58u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x58u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x466C56u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x466C56u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x58u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x466C6Bu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x466C6Bu));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x58u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x466CDEu)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x466CDEu));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (4.7123894691467285) - (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x54u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x54u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x466CF9u)); sfera_sub_004EE9F2(cpu, LIFT_CODE_TOKEN_VA(0x466CF9u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x3Cu)));
    *(double*)(cpu->esp + 0x20u) = cpu->fpu[0u];
    lift_x87_pop(cpu); lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x54u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x466D12u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x466D12u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    ...
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x34u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x466D33u)); sfera_sub_004EEC4E(cpu, LIFT_CODE_TOKEN_VA(0x466D33u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[4u]; cpu->fpu[4u] = temporary; }
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->ebp + 0x188u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->eax + 0x14u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[2u]);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[4u]);
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->ebp + 0x18Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->ebp + 0x190u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (*(uint32_t*)(cpu->ebp + 0x6Cu) != (uint32_t)(0u)) goto label_00066E8C;
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x7Cu));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0x70u)));
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x80u));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0x74u)));
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00066E6A:
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x84u));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ebp + 0x78u)));
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00066ED0:
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    *(float*)(cpu->ebp + 0x198u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0x198u));
    lift_x87_compare(cpu, cpu->fpu[0u], 0.05000000074505806);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=(uint64_t)(((cpu->eax >> 8u) & 0xFFu)), r=(uint64_t)(5u), v=l & r; lift_flags_logic(cpu,v,8u); }
    ...
    cpu->ecx = (uint32_t)(cpu->ecx);
    label_00066F10:
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->eax + ((uint32_t)(uintptr_t)&g_sfera_log_runtime.files[0].path.text[0]))) & 0xFFu);
    ...
    *(double*)(cpu->esp) = cpu->fpu[0u];
    ...
    g_sfera_log_runtime.files[0].has_written = (uint32_t)(1u);
    label_000670AB:
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0xDCu));
    cpu->eax = (uint32_t)(uintptr_t)&g_sfera_log_runtime.files[0].path.text[0];
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edx = (uint32_t)(cpu->eax + 1u);
    cpu->ecx = (uint32_t)(cpu->ecx);
    ...
    *(double*)(cpu->esp) = cpu->fpu[0u];
    ...
    g_sfera_log_runtime.files[0].has_written = (uint32_t)(1u);
    label_000671D9:
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0xE0u));
    cpu->eax = (uint32_t)(uintptr_t)&g_sfera_log_runtime.files[0].path.text[0];
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edx = (uint32_t)(cpu->eax + 1u);
    label_000671F0:
    ...
    *(double*)(cpu->esp) = cpu->fpu[0u];
    ...
    g_sfera_log_runtime.files[0].has_written = (uint32_t)(1u);
    label_00067309:
    lift_x87_push(cpu, (double)*(float*)(cpu->ebp + 0xE4u));
    cpu->eax = (uint32_t)(uintptr_t)&g_sfera_log_runtime.files[0].path.text[0];
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edx = (uint32_t)(cpu->eax + 1u);
    label_00067320:
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->esi;
    if ((uint16_t)((cpu->edx & 0xFFFFu)) >= *(uint16_t*)(cpu->eax + 0xAu)) goto label_000674B4;
    cpu->edx = *(uint32_t*)(cpu->esp + 0x10u);
    ...
    *(uint32_t*)(cpu->eax + cpu->edx + 0x20u) = cpu->esi;
    ...
    cpu->eax = (int64_t)(int32_t)(cpu->eax) * (int64_t)(int32_t)(0xACu);
    cpu->eax += *(uint32_t*)(cpu->ebp + 0x3Cu);
    if (*(uint8_t*)(cpu->eax) != (uint8_t)(0x5Fu)) goto label_00067659;
    cpu->eax = (cpu->eax & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->eax + 1u)) & 0xFFu);
    if ((uint8_t)((cpu->eax & 0xFFu)) != (uint8_t)(0x75u)) goto label_00067530;
    cpu->eax = 0u;
    cpu->edx = 0u;
    if ((uint16_t)((cpu->eax & 0xFFFFu)) >= *(uint16_t*)(cpu->ecx + 0xAu)) goto label_00067659;
    ...
    *(uint32_t*)(cpu->eax + 8u) = cpu->esi;
    ...
    cpu->edx = 0u;
    *(uint32_t*)(cpu->esp + 0x18u) = 0u;
    if ((uint16_t)((cpu->edx & 0xFFFFu)) >= *(uint16_t*)(cpu->ecx + 0xAu)) goto label_00067659;
    lift_x87_push(cpu, cpu->fpu[1u]);
    cpu->eax = (uint32_t)(cpu->esi + ((uint32_t)(cpu->esi) * 8u));
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax += cpu->eax;
    ...
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x20u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4675B5u)); sfera_sub_004EE9EC(cpu, LIFT_CODE_TOKEN_VA(0x4675B5u));
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x20u));
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_004676F0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->ebx;
    ...
    label_000677AC:
    cpu->ecx = g_sfera_interface_runtime.windows.data;
    if (*(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->esi) * 4u)) != (uint32_t)(0u)) goto label_000677BB;
    ++cpu->esi;
    goto label_0006778A;
    label_000677BB:
    ...
    *(uint32_t*)(((uint32_t)(cpu->edi) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_spatial_index_runtime.ui_sort_indices[0])) = cpu->esi;
    *(uint32_t*)(((uint32_t)(cpu->edi) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_main_view_state_runtime.ui_sort_keys[0])) = cpu->eax;
    ++cpu->edi;
    ++cpu->esi;
    ...
    label_00067859:
    cpu->esi = *(uint32_t*)(((uint32_t)(cpu->edi) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_spatial_index_runtime.ui_sort_indices[0]));
    ...
    if (*(uint32_t*)(cpu->eax) != (uint32_t)(1u)) goto label_000678A4;
    if ((int32_t)(uint32_t)(cpu->ebp) < (int32_t)*(uint32_t*)(cpu->eax + 0xCu)) goto label_000678A4;
    if ((int32_t)(uint32_t)(cpu->ebp) > (int32_t)*(uint32_t*)(cpu->eax + 0x10u)) goto label_000678A4;
    if ((int32_t)(uint32_t)(cpu->ebx) < (int32_t)*(uint32_t*)(cpu->eax + 0x14u)) goto label_000678A4;
    if ((int32_t)(uint32_t)(cpu->ebx) <= (int32_t)*(uint32_t*)(cpu->eax + 0x18u)) goto label_000678C3;
    label_000678A4:
    ++cpu->edi;
    ...
    cpu->esp += 4u; cpu->eip = stop_address; return;
    label_000678C3:
    if ((int32_t)(uint32_t)(cpu->ebp) < (int32_t)*(uint32_t*)(cpu->eax + 0x1Cu)) goto label_000678F2;
    if ((int32_t)(uint32_t)(cpu->ebp) > (int32_t)*(uint32_t*)(cpu->eax + 0x20u)) goto label_000678F2;
    if ((int32_t)(uint32_t)(cpu->ebx) < (int32_t)*(uint32_t*)(cpu->eax + 0x24u)) goto label_000678F2;
    if ((int32_t)(uint32_t)(cpu->ebx) > (int32_t)*(uint32_t*)(cpu->eax + 0x28u)) goto label_000678F2;
    cpu->eax = *(uint32_t*)(((uint32_t)(cpu->edi) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_spatial_index_runtime.ui_sort_indices[0]));
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x20u);
    (void)0; /* source SEH registration eliminated */
    cpu->ecx = lift_pop32(cpu); cpu->edi = lift_pop32(cpu); cpu->esi = lift_pop32(cpu); cpu->ebp = lift_pop32(cpu); cpu->ebx = lift_pop32(cpu);
    cpu->esp += 0x18u;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00467910(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x14u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->esi + 0x34u)));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x14u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->esi + 0x38u)));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=(uint64_t)(((cpu->eax >> 8u) & 0xFFu)), r=(uint64_t)(0x41u), v=l & r; lift_flags_logic(cpu,v,8u); }
    if ((cpu->eflags & LIFT_FLAG_PF) != 0u) goto label_00067A47;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00467A70(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = 0xFFFFFFFFu;
    ...
    lift_x87_push(cpu, 1.5); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[0u] = (cpu->fpu[0u]) * ((double)(((int32_t)((*(uint32_t*)(void*)&g_sfera_main_input_state_runtime.cursor_y)))));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    if (*(uint32_t*)(cpu->esi + 4u) != (uint32_t)(1u)) goto label_00067CBF;
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->ecx;
    ...
    reinterpret_cast<CCursor*>(cpu->ecx)->getPosition(cpu);
    lift_x87_push(cpu, 0.0);
    lift_x87_compare(cpu, cpu->fpu[0u], ((double)*(float*)(cpu->esi + 0x34u)));
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))) & 0xFFFFu);
    if ((uint8_t)((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_00067C14;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x10u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->esi + 0x34u)));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x467C0Du)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x467C0Du));
    *(float*)(cpu->esi + 0x34u) = cpu->fpu[0u];
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    label_00067C14:
    lift_x87_compare(cpu, cpu->fpu[0u], ((double)*(float*)(cpu->esi + 0x38u)));
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))) & 0xFFFFu);
    if ((uint8_t)((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_00067C33;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x14u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->esi + 0x38u)));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x467C2Au)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x467C2Au));
    *(float*)(cpu->esi + 0x38u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    goto label_00067C35;
    label_00067C33:
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) - (cpu->fpu[1u]);
    cpu->fpu[0u] = (cpu->fpu[0u]) + ((double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x10u)))));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x467C5Du)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x467C5Du));
    *(float*)(cpu->esi + 0x34u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    goto label_00067C68;
    label_00067C66:
    ...
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) - (cpu->fpu[1u]);
    cpu->fpu[0u] = (cpu->fpu[0u]) + ((double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x14u)))));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x467C90u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x467C90u));
    *(float*)(cpu->esi + 0x38u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    goto label_00067C9B;
    label_00067C99:
    ...
    *(uint32_t*)(cpu->esp + 0xCu) = 0xFFFFFFFFu;
    ...
    cpu->ecx = g_sfera_interface_runtime.windows.data;
    cpu->eax = *(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->esi) * 4u));
    if ((int32_t)*(uint32_t*)(cpu->eax + 0x6E08u) >= (int32_t)(uint32_t)(0xAu)) goto label_00067E4B;
    ...
    *(uint32_t*)(cpu->eax + 0x6E08u) = (uint64_t)(*(uint32_t*)(cpu->eax + 0x6E08u)) + 1u;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00467E70(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ecx;
    ...
    label_00067E9F:
    cpu->eax = g_sfera_interface_runtime.windows.data;
    if (*(uint32_t*)(cpu->eax + ((uint32_t)(cpu->edi) * 4u)) != (uint32_t)(cpu->ebx)) goto label_00067ED3;
    label_00067EA9:
    cpu->edi = (uint32_t)(uintptr_t)&g_sfera_window_runtime.diagnostic_message[0];
    ...
    label_00067EF5:
    cpu->ecx = g_sfera_interface_runtime.window_handle_table.data;
    if (*(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->ebx) * 4u)) == (uint32_t)(0u)) goto label_00067F04;
    ++cpu->ebx;
    goto label_00067ED3;
    label_00067F04:
    ...
    label_00067F3C:
    cpu->edx = g_sfera_interface_runtime.window_handle_table.data;
    *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->ebx) * 4u)) = cpu->esi;
    cpu->edx = cpu->ebx;
    cpu->ecx = cpu->edi;
    *(uint32_t*)(cpu->esi) = 1u;
    *(uint32_t*)(cpu->esi + 4u) = cpu->edi;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00468050(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->edi + 8u) = cpu->eax;
    ...
    cpu->esp += 4u; cpu->eip = stop_address; return;
    label_00068108:
    if (*(uint8_t*)(cpu->eax + 0x138u) != (uint8_t)(0u)) goto label_00068098;
    cpu->ecx = *(uint32_t*)(cpu->eax + 4u);
    lift_push32(cpu, cpu->ecx);
    cpu->ecx = g_sfera_model_runtime.repository;
    ...
    label_00068150:
    if (*(uint8_t*)(cpu->eax + 0x138u) != (uint8_t)(0u)) goto label_000680D7;
    cpu->edx = *(uint32_t*)(cpu->eax + 4u);
    cpu->ecx = g_sfera_model_runtime.repository;
    lift_push32(cpu, cpu->edx);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_004681A0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) / (cpu->fpu[1u]);
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[0u] = (((double)*(float*)(cpu->esp + 0x90u))) / (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 1.0);
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u];
    ...
    *(uint32_t*)(cpu->esp + 0x5Cu) = cpu->edx;
    ...
    if (*(uint32_t*)(cpu->ecx) == (uint32_t)(1u)) goto label_000682FF;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00468310(LiftCpu* cpu, uint32_t stop_address) {
    ...
    label_0006833D:
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_main_ui_state_runtime.clip_planes[0][0]));
    cpu->eax = g_sfera_world_objects.object_handles.data;
    cpu->eax = *(uint32_t*)(cpu->eax + 4u);
    lift_x87_push(cpu, 0.0);
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->edx;
    ...
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_main_ui_state_runtime.clip_planes[0][1]));
    lift_x87_push(cpu, cpu->fpu[1u]);
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]); lift_x87_pop(cpu); lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=(uint64_t)(((cpu->eax >> 8u) & 0xFFu)), r=(uint64_t)(0x44u), v=l & r; lift_flags_logic(cpu,v,8u); }
    if ((cpu->eflags & LIFT_FLAG_PF) != 0u) goto label_000683AE;
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_main_ui_state_runtime.clip_planes[0][2]));
    lift_x87_push(cpu, cpu->fpu[1u]);
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]); lift_x87_pop(cpu); lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=(uint64_t)(((cpu->eax >> 8u) & 0xFFu)), r=(uint64_t)(0x44u), v=l & r; lift_flags_logic(cpu,v,8u); }
    if ((cpu->eflags & LIFT_FLAG_PF) != 0u) goto label_000683AE;
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_main_ui_state_runtime.clip_planes[0][3]));
    lift_x87_push(cpu, cpu->fpu[1u]);
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]); lift_x87_pop(cpu); lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=(uint64_t)(((cpu->eax >> 8u) & 0xFFu)), r=(uint64_t)(0x44u), v=l & r; lift_flags_logic(cpu,v,8u); }
    ...
    if (*(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->edi) * 4u)) != (uint32_t)(0u)) goto label_000683F2;
    ++cpu->edi;
    goto label_000683C1;
    label_000683F2:
    ...
    *(uint32_t*)(cpu->esi + 0x34u) = cpu->edx;
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x1Cu));
    *(uint32_t*)(cpu->eax + ((uint32_t)(cpu->ebx) * 4u)) = cpu->esi;
    ...
    *(float*)(cpu->esp + 0x78u) = cpu->fpu[0u];
    ...
    *(float*)(cpu->esp + 0xA0u) = cpu->fpu[0u];
    ...
    *(float*)(cpu->esp + 0x98u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    if (*(uint32_t*)(cpu->ebx + cpu->eax) == (uint32_t)(0u)) goto label_0006870C;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00468750(LiftCpu* cpu, uint32_t stop_address) {
    ...
    { uint64_t l=(uint64_t)(*(uint8_t*)(cpu->eax + 0x50u)), r=(uint64_t)(0u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    *(uint32_t*)(cpu->esp + 0x10u) = 7u;
    if ((cpu->eflags & LIFT_FLAG_ZF) == 0u) goto label_000687C4;
    if ((int32_t)*(uint32_t*)(cpu->eax + 0x38u) <= (int32_t)(uint32_t)(2u)) goto label_000687C4;
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = 0x1Eu;
    ...
    cpu->edx = g_sfera_light_runtime.visible_handles.data;
    cpu->esi = *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->ebp) * 4u));
    cpu->ecx = cpu->eax;
    cpu->ecx <<= 4u;
    cpu->ecx -= cpu->eax;
    ...
    *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_light_runtime.render_candidate_indices[0])) = cpu->ecx;
    *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_light_runtime.render_candidate_active[0])) = 0u;
    ++cpu->eax;
    g_sfera_client_main_scalar_runtime.counter_03 = (uint32_t)(cpu->eax);
    if ((uint32_t)(cpu->eax) == *(uint32_t*)(cpu->esp + 0x10u)) goto label_000688FE;
    goto label_000688F1;
    label_000688EC:
    cpu->eax = g_sfera_client_main_scalar_runtime.counter_03;
    label_000688F1:
    ...
    *(uint32_t*)(((uint32_t)(cpu->edi) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_light_runtime.render_candidate_active[0])) = 1u;
    ...
    label_00068945:
    cpu->edx = g_sfera_light_runtime.active_handles.data;
    if (*(uint32_t*)(cpu->edx + ((uint32_t)(cpu->esi) * 4u)) == (uint32_t)(1u)) goto label_0006899D;
    cpu->eax = *(uint32_t*)(void*)&g_sfera_main_command_state_runtime.light_update_counter;
    ++cpu->eax;
    (*(uint32_t*)(void*)&g_sfera_main_command_state_runtime.light_update_counter) = (uint32_t)(cpu->eax);
    ...
    cpu->eax = g_sfera_light_runtime.active_handles.data;
    lift_push32(cpu, 1u);
    *(uint32_t*)(cpu->eax + ((uint32_t)(cpu->esi) * 4u)) = 1u;
    cpu->ecx = g_sfera_graphics_runtime.d3d9_device;
    lift_push32(cpu, cpu->esi);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_004689E0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ecx;
    ...
    label_000689F6:
    if ((uint32_t)((*(uint32_t*)(cpu->esp + 0x10u)) & (cpu->ebx)) != 0u) goto label_00068A6D;
    ...
    label_00068A1E:
    cpu->ecx = g_sfera_light_runtime.active_handles.data;
    if (*(uint32_t*)(cpu->edi + cpu->ecx) == (uint32_t)(0u)) goto label_00068A6D;
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_main_command_state_runtime.light_update_counter) = (uint64_t)((*(uint32_t*)(void*)&g_sfera_main_command_state_runtime.light_update_counter)) - 1u;
    ...
    *(uint32_t*)(cpu->edi + cpu->edx) = 0u;
    ...
    label_00068A80:
    if ((uint32_t)((*(uint32_t*)(cpu->esp + 0x10u)) & (cpu->ebx)) == 0u) goto label_00068B01;
    ...
    label_00068AA8:
    cpu->ecx = g_sfera_light_runtime.active_handles.data;
    if (*(uint32_t*)(cpu->edi + cpu->ecx) == (uint32_t)(1u)) goto label_00068B01;
    cpu->eax = *(uint32_t*)(void*)&g_sfera_main_command_state_runtime.light_update_counter;
    ++cpu->eax;
    (*(uint32_t*)(void*)&g_sfera_main_command_state_runtime.light_update_counter) = (uint32_t)(cpu->eax);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00468B40(LiftCpu* cpu, uint32_t stop_address) {
    ...
    label_00068B72:
    cpu->eax = g_sfera_light_runtime.active_handles.data;
    if (*(uint32_t*)(cpu->edi + cpu->eax) == (uint32_t)(0u)) goto label_00068BC0;
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_main_command_state_runtime.light_update_counter) = (uint64_t)((*(uint32_t*)(void*)&g_sfera_main_command_state_runtime.light_update_counter)) - 1u;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00468D30(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = 0xFFFFFFFFu;
    ...
    if ((int32_t)(uint32_t)(cpu->ebp) >= (int32_t)*(uint32_t*)(cpu->esi + 0x20u)) goto label_00068E26;
    cpu->ebx = *(uint32_t*)(cpu->esp + 0x1Cu);
    if ((int32_t)(uint32_t)(cpu->ebx) < (int32_t)*(uint32_t*)(cpu->esi + 0x24u)) goto label_00068E26;
    if ((int32_t)(uint32_t)(cpu->ebx) >= (int32_t)*(uint32_t*)(cpu->esi + 0x28u)) goto label_00068E26;
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x34u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x468E07u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x468E07u));
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x14u);
    cpu->eax -= cpu->edi;
    cpu->eax += cpu->ebp;
    *(uint32_t*)(cpu->ecx) = cpu->eax;
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x38u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x468E19u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x468E19u));
    cpu->eax -= *(uint32_t*)(cpu->esi + 0x24u);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x30u);
    cpu->eax += cpu->ebx;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00468E50(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->esi = *(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->edx) * 4u) + 0x8Cu);
    lift_push32(cpu, cpu->edi);
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ecx;
    ...
    *(uint32_t*)(cpu->edi) = 0u;
    ...
    if ((int32_t)(uint32_t)(cpu->eax) >= (int32_t)*(uint32_t*)(cpu->ebp + 0x84u)) goto label_00068EB8;
    if ((int32_t)(uint32_t)(cpu->ecx) < 0) goto label_00068EB8;
    if ((int32_t)(uint32_t)(cpu->ecx) >= (int32_t)*(uint32_t*)(cpu->ebp + 0x88u)) goto label_00068EB8;
    cpu->eax = (uint32_t)(cpu->eax + ((uint32_t)(cpu->eax) * 4u));
    cpu->ecx = (uint32_t)(cpu->ecx + ((uint32_t)(cpu->eax) * 2u));
    cpu->eax = *(uint32_t*)(cpu->ebp + ((uint32_t)(cpu->ecx) * 4u) + 0x8Cu);
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->eax;
    ...
    cpu->edi = cpu->eax;
    label_00068F44:
    if (*(uint32_t*)(cpu->esp + 0x20u) == (uint32_t)(0u)) goto label_00069075;
    if (*(uint32_t*)(cpu->esp + 0x14u) == (uint32_t)(0u)) goto label_00069075;
    if (*(uint32_t*)(cpu->esp + 0x18u) == (uint32_t)(0u)) goto label_00069075;
    if ((uint32_t)(cpu->edi) == 0u) goto label_00069075;
    if (*(uint8_t*)(cpu->esi + 0x689Cu) != (uint8_t)(0u)) goto label_00068F99;
    ...
    label_00068FC4:
    if (*(uint8_t*)(cpu->esi + 0x689Eu) != (uint8_t)(0u)) goto label_00068FEF;
    cpu->edx = g_sfera_terrain_neighbor_runtime.cells[6];
    ...
    label_00068FEF:
    if (*(uint8_t*)(cpu->esi + 0x689Fu) != (uint8_t)(0u)) goto label_0006901B;
    ...
    cpu->edx = *(uint32_t*)((uintptr_t)&g_sfera_terrain_neighbor_runtime.cells[1]);
    cpu->ecx = cpu->esi;
    ...
    cpu->edx = *(uint32_t*)(cpu->esp + 0x10u);
    if ((int32_t)(uint32_t)(cpu->eax) >= (int32_t)*(uint32_t*)(cpu->edx + 0x84u)) goto label_00069060;
    if ((int32_t)(uint32_t)(cpu->ecx) < 0) goto label_00069060;
    if ((int32_t)(uint32_t)(cpu->ecx) >= (int32_t)*(uint32_t*)(cpu->edx + 0x88u)) goto label_00069060;
    cpu->eax = (uint32_t)(cpu->eax + ((uint32_t)(cpu->eax) * 4u));
    cpu->ecx = (uint32_t)(cpu->ecx + ((uint32_t)(cpu->eax) * 2u));
    cpu->ecx = *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->ecx) * 4u) + 0x8Cu);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_00469090(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->ebx) = cpu->eax;
    cpu->ecx = *(uint32_t*)(((uint32_t)(uintptr_t)"AutoGrass") + 4u);
    *(uint32_t*)(cpu->ebx + 4u) = cpu->ecx;
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(((uint32_t)(uintptr_t)"AutoGrass") + 8u)) & 0xFFFFu);
    cpu->esp += 0xCu;
    ...
    *(uint32_t*)(cpu->esp + 0x6Cu) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x6Cu)) + (uint64_t)(cpu->ecx) + (uint64_t)(0u);
    if ((int32_t)(uint32_t)(cpu->ecx) <= (int32_t)*(uint32_t*)(cpu->esp + 0x3Cu)) goto label_0006913A;
    *(uint32_t*)(cpu->esp + 0x3Cu) = cpu->ecx;
    label_0006913A:
    if ((int32_t)(uint32_t)(cpu->edx) <= (int32_t)*(uint32_t*)(cpu->esp + 0x28u)) goto label_00069144;
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->edx;
    label_00069144:
    ...
    *(uint32_t*)(cpu->ebx + 0x38u) = 1u;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x469164u)); sfera_sub_004EE9EC(cpu, LIFT_CODE_TOKEN_VA(0x469164u));
    *(float*)(cpu->esp + 0x48u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->eax) = cpu->ecx;
    cpu->edx = *(uint32_t*)(((uint32_t)(uintptr_t)"_u_grass") + 4u);
    *(uint32_t*)(cpu->eax + 4u) = cpu->edx;
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(((uint32_t)(uintptr_t)"_u_grass") + 8u)) & 0xFFu);
    ...
    *(float*)(cpu->edx + 0x84u) = cpu->fpu[0u];
    cpu->eax = *(uint32_t*)(cpu->ebx + 0x3Cu);
    lift_x87_push(cpu, (double)5.0f);
    *(float*)(cpu->eax + 0x90u) = cpu->fpu[0u];
    cpu->ecx = *(uint32_t*)(cpu->ebx + 0x3Cu);
    ...
    *(float*)(cpu->ecx + 0x88u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edx = *(uint32_t*)(cpu->ebx + 0x3Cu);
    lift_x87_push(cpu, 0.0);
    *(float*)(cpu->edx + 0x94u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax = *(uint32_t*)(cpu->ebx + 0x3Cu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)(cpu->eax + 0x8Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->ecx = *(uint32_t*)(cpu->ebx + 0x3Cu);
    *(float*)(cpu->ecx + 0x98u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax = *(uint32_t*)(cpu->ebx + 0x3Cu);
    cpu->edx = (uint32_t)(cpu->eax + 0x24u);
    cpu->ecx = (uint32_t)(cpu->eax + 0x84u);
    ...
    *(uint32_t*)(cpu->eax + 0xA4u) = cpu->edx;
    cpu->eax = *(uint32_t*)(cpu->ebx + 0x3Cu);
    *(float*)(cpu->eax + 0xA8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax = *(uint32_t*)(cpu->ebx + 0x3Cu);
    lift_x87_push(cpu, (double)0.5f);
    cpu->esi = (uint32_t)(cpu->eax + 0x24u);
    *(float*)(cpu->ebx + 0x1A8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x8Cu) = cpu->esi;
    ...
    ++cpu->esi;
    *(uint32_t*)(cpu->edi) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->esi) < (int32_t)*(uint32_t*)(cpu->esp + 0x5Cu)) goto label_0006937D;
    label_000693B6:
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->esp + 0x6Cu)), r=(uint64_t)(0u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(uint32_t*)(cpu->esp + 0x44u) = 0xFFFFFFEEu;
    cpu->esp = (uint32_t)(cpu->esp);
    label_000693E0:
    if (*(uint32_t*)(cpu->esp + 0x8Cu) != (uint32_t)(0u)) goto label_00069460;
    ...
    *(uint32_t*)(cpu->esp + 0xCu) = cpu->edi;
    if ((int32_t)(uint32_t)(cpu->edi) >= (int32_t)*(uint32_t*)(cpu->esp + 0x5Cu)) goto label_0006A059;
    cpu->ecx = *(uint32_t*)(cpu->esi);
    lift_push32(cpu, cpu->ecx);
    cpu->ecx = g_sfera_model_runtime.repository;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x469421u)); sfera_sub_0047F4D0(cpu, LIFT_CODE_TOKEN_VA(0x469421u));
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->eax + 0x1C8u)), r=(uint64_t)(0u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    ...
    (void)cpu;
    label_00069440:
    if (*(uint8_t*)(cpu->eax) == (uint8_t)(0u)) goto label_00069A48;
    ++cpu->ecx;
    ++cpu->eax;
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x20u)) + (uint64_t)(cpu->edx) + (uint64_t)(0u);
    goto label_00069405;
    label_00069460:
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->esp + 0x5Cu)), r=(uint64_t)(0u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(uint32_t*)(cpu->esp + 0x70u) = cpu->edi;
    if ((int32_t)*(uint32_t*)(cpu->edi + 0x30u) <= (int32_t)(uint32_t)(cpu->esi)) goto label_0006954E;
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->esi;
    label_000694A8:
    cpu->edx = *(uint32_t*)(cpu->esp + 0x14u);
    if (*(uint8_t*)(cpu->edx + cpu->esi) != (uint8_t)(0u)) goto label_0006953F;
    if ((int32_t)*(uint32_t*)(cpu->esp + 0x44u) >= (int32_t)(uint32_t)(0u)) goto label_000694C7;
    ...
    cpu->edx = *(uint32_t*)(cpu->esp + 0x44u);
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edx + cpu->eax + 2u)) & 0xFFFFu);
    cpu->ecx = *(uint32_t*)(cpu->edi + 0x34u);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x10u);
    if ((uint16_t)((cpu->edx & 0xFFFFu)) != *(uint16_t*)(cpu->ecx + cpu->eax + 2u)) goto label_0006953F;
    if ((int32_t)*(uint32_t*)(cpu->esp + 0x44u) >= (int32_t)(uint32_t)(0u)) goto label_0006950C;
    cpu->ecx = (uint32_t)(uintptr_t)&g_sfera_grass_runtime.type_records.debug_file[0];
    ...
    cpu->eax = *(uint32_t*)(cpu->esp + 0x10u);
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->eax + cpu->edx)) & 0xFFu);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x44u);
    cpu->eax = g_sfera_grass_runtime.type_records.data;
    cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)(((uint64_t)((cpu->ecx & 0xFFu)) & (uint64_t)(0x80u))) & 0xFFu);
    if (*(uint8_t*)(cpu->edx + cpu->eax) == (uint8_t)((cpu->ecx & 0xFFu))) goto label_00069576;
    label_0006953F:
    *(uint32_t*)(cpu->esp + 0x10u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x10u)) + (uint64_t)(0x12u) + (uint64_t)(0u);
    ++cpu->esi;
    if ((int32_t)(uint32_t)(cpu->esi) < (int32_t)*(uint32_t*)(cpu->edi + 0x30u)) goto label_000694A8;
    label_0006954E:
    cpu->eax = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x3Cu);
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x14u)) + (uint64_t)(cpu->ecx) + (uint64_t)(0u);
    ++cpu->eax;
    *(uint32_t*)(cpu->esp + 0xCu) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) < (int32_t)*(uint32_t*)(cpu->esp + 0x5Cu)) goto label_00069481;
    goto label_000693F5;
    label_00069576:
    cpu->edx = *(uint32_t*)(cpu->esp + 0xCu);
    ...
    cpu->eax = *(uint32_t*)(cpu->esp + 0x2Cu);
    cpu->edx += cpu->esi;
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->esp + 0x30u)), r=(uint64_t)(0u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    *(uint8_t*)(cpu->edx + cpu->eax) = 1u;
    ...
    cpu->eax += g_sfera_grass_runtime.type_records.data;
    cpu->ecx = (cpu->ecx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->esi + 6u)) & 0xFFFFu);
    *(uint16_t*)(cpu->eax + 6u) = (uint64_t)(*(uint16_t*)(cpu->eax + 6u)) + (uint64_t)((cpu->ecx & 0xFFFFu)) + (uint64_t)(0u);
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->esi + 0xAu)) & 0xFFFFu);
    ...
    *(uint32_t*)(cpu->esp + 0x58u) = cpu->ecx;
    if ((uint16_t)((cpu->edx & 0xFFFFu)) >= *(uint16_t*)(cpu->esi + 0xAu)) goto label_0006974F;
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x1Cu);
    label_0006967B:
    cpu->eax = *(uint32_t*)(cpu->ebx + 0x24u);
    lift_x87_push(cpu, (double)*(float*)(cpu->eax + cpu->ecx));
    cpu->eax += cpu->ecx;
    *(float*)(cpu->esp + 0x60u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x50u);
    lift_x87_push(cpu, (double)*(float*)(cpu->eax + 4u));
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->ecx;
    ...
    cpu->esp += 0xCu;
    cpu->edi = 0u;
    if ((uint16_t)((cpu->eax & 0xFFFFu)) >= *(uint16_t*)(cpu->esi + 0xAu)) goto label_000699B2;
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xBCu));
    cpu->eax = *(uint32_t*)(cpu->esp + 0xCu);
    ...
    cpu->fpu[1u] = (cpu->fpu[1u]) * (cpu->fpu[0u]);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(double*)(cpu->esp + 0xB0u) = cpu->fpu[0u];
    lift_x87_pop(cpu); lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCCu));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[1u]);
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x1Cu);
    *(uint32_t*)(cpu->esp + 0x34u) = cpu->eax;
    *(double*)(cpu->esp + 0x98u) = cpu->fpu[0u];
    lift_x87_pop(cpu);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x24u);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0xDCu)));
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    label_00069806:
    if ((int32_t)*(uint32_t*)(cpu->esp + 0xCu) >= (int32_t)(uint32_t)(0u)) goto label_0006981B;
    cpu->ecx = (uint32_t)(uintptr_t)&g_sfera_grass_runtime.model_handles.debug_file[0];
    ...
    cpu->ecx = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x80u)));
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edx + ((uint32_t)(cpu->ecx) * 4u))) & 0xFFFFu);
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->eax;
    ...
    cpu->edx = *(uint32_t*)(cpu->esp + 0x14u);
    *(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->eax) * 4u)) = cpu->edx;
    cpu->eax = *(uint16_t*)(cpu->esi + 8u);
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x70u);
    cpu->edx = *(uint32_t*)(cpu->ecx + 0x24u);
    cpu->eax += cpu->edi;
    ...
    *(uint32_t*)(cpu->esp + 0x60u) = cpu->edx;
    lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0xB8u)));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (*(double*)(cpu->esp + 0xB0u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xC0u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x1Cu)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[2u]; cpu->fpu[2u] = temporary; }
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    ...
    cpu->eax += cpu->edi;
    *(uint32_t*)(cpu->esp + 0xCu) = 0u;
    if ((uint16_t)((cpu->edx & 0xFFFFu)) >= *(uint16_t*)(cpu->esi + 6u)) goto label_00069A31;
    label_00069A02:
    cpu->edx = *(uint32_t*)(cpu->esp + 0x18u);
    cpu->edi = cpu->ecx;
    cpu->edi -= cpu->edx;
    ...
    *(uint32_t*)(cpu->esp + 0x60u) = 0u;
    if ((uint16_t)((cpu->eax & 0xFFFFu)) >= *(uint16_t*)(cpu->esi + 0xAu)) goto label_00069B96;
    cpu->edi = *(uint32_t*)(cpu->esp + 0x1Cu);
    label_00069B48:
    cpu->edx = *(uint32_t*)(cpu->ebx + 0x24u);
    ...
    *(uint32_t*)(cpu->esp + 0x60u) = cpu->eax;
    ...
    cpu->esp += 0xCu;
    *(uint32_t*)(cpu->esp + 0x14u) = 0u;
    if ((uint16_t)((cpu->eax & 0xFFFFu)) >= *(uint16_t*)(cpu->esi + 0xAu)) goto label_00069CBB;
    cpu->eax = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->eax = (int64_t)(int32_t)(cpu->eax) * (int64_t)(int32_t)(*(uint32_t*)(cpu->esp + 0x28u));
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x1Cu);
    *(uint32_t*)(cpu->esp + 0x34u) = cpu->eax;
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->ecx;
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->eax)) & 0xFFFFu);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x80u)));
    ...
    *(uint32_t*)(cpu->esp + 0x48u) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) < (int32_t)*(uint32_t*)(cpu->esp + 0x6Cu)) goto label_000693E0;
    label_00069D30:
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x2Cu);
    ...
    *(uint32_t*)(cpu->esp + 0x2Cu) = cpu->edx;
    ...
    cpu->edx = *(uint32_t*)(cpu->esp + 0x2Cu);
    cpu->ecx = 0xFDE8u;
    if (*(uint16_t*)(cpu->edx) >= (uint16_t)((cpu->ecx & 0xFFFFu))) goto label_00069DD3;
    ...
    cpu->ecx = (cpu->ecx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->eax + ((uint32_t)(cpu->edi) * 4u))) & 0xFFFFu);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x2Cu);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x40u);
    ...
    *(uint32_t*)(cpu->esp + 0x48u) = cpu->ecx;
    ...
    cpu->eax = *(uint32_t*)(cpu->ebx + 0x24u);
    lift_x87_push(cpu, (double)*(float*)(cpu->edi + cpu->eax));
    cpu->ecx = (uint32_t)(cpu->ecx + ((uint32_t)(cpu->ecx) * 8u));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->eax + ((uint32_t)(cpu->ecx) * 4u))));
    cpu->ecx = (uint32_t)(cpu->eax + ((uint32_t)(cpu->ecx) * 4u));
    cpu->esi = *(uint32_t*)(cpu->ebx + 0x1CCu);
    cpu->esi += cpu->edi;
    *(float*)(cpu->esp + 0x50u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->edi + cpu->eax + 4u));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->ecx + 4u)));
    *(float*)(cpu->esp + 0x54u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->edi + cpu->eax + 8u));
    ...
    *(double*)(cpu->esp + 0x80u) = cpu->fpu[0u];
    cpu->fpu[0u] = (cpu->fpu[2u]) - (cpu->fpu[0u]);
    ...
    *(double*)(cpu->esp + 0x98u) = cpu->fpu[0u];
    ...
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(double*)(cpu->esp + 0x60u) = cpu->fpu[0u];
    cpu->fpu[1u] = cpu->fpu[1u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x469ED1u)); sfera_sub_004EE9EC(cpu, LIFT_CODE_TOKEN_VA(0x469ED1u));
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    cpu->fpu[0u] = (*(double*)(cpu->esp + 0x90u)) / (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi)));
    ...
    *(float*)(cpu->esi + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 8u)));
    *(float*)(cpu->esi + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, *(double*)(cpu->esp + 0x98u));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (*(double*)(cpu->esp + 0xB0u));
    *(float*)(cpu->esp + 0xA4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x58u));
    lift_x87_push(cpu, *(double*)(cpu->esp + 0x60u));
    cpu->fpu[1u] = (cpu->fpu[1u]) - (cpu->fpu[0u]);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)(cpu->esp + 0xA8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x469F84u)); sfera_sub_004EE9EC(cpu, LIFT_CODE_TOKEN_VA(0x469F84u));
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    cpu->fpu[0u] = (*(double*)(cpu->esp + 0x90u)) / (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x28u)) + (uint64_t)(0xCu) + (uint64_t)(0u);
    cpu->edi += 0x24u;
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->esp + 0x48u)), v=l - 1u; uint32_t cf=cpu->eflags & LIFT_FLAG_CF; lift_flags_sub(cpu,l,1u,0u,v,32u); cpu->eflags=(cpu->eflags & ~LIFT_FLAG_CF) | cf; *(uint32_t*)(cpu->esp + 0x48u) = v; }
    ...
    *(uint32_t*)(cpu->ebx + 0x34u) = cpu->eax;
    ...
    lift_x87_push(cpu, 0.0);
    *(float*)(cpu->ebx + 0x1B0u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->esp += 0xCu;
    lift_x87_push(cpu, 1.0);
    cpu->edi = lift_pop32(cpu);
    ...
    *(float*)(cpu->ebx + 0x1B8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->esi = lift_pop32(cpu);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046A070(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->edi;
    goto label_0006A1BF;
    label_0006A130:
    if ((uint32_t)(cpu->ebx) != *(uint32_t*)(cpu->esp + 0x18u)) goto label_0006A140;
    if ((uint32_t)(cpu->edi) == *(uint32_t*)(cpu->esp + 0x20u)) goto label_0006A1BF;
    label_0006A140:
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->edi;
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->ebx;
    ...
    cpu->eax = *(uint32_t*)(cpu->esp + 0x1Cu);
    *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->edi) * 8u)) = cpu->eax;
    cpu->edi = g_sfera_window_runtime.landscape_grid_count;
    ...
    cpu->ecx -= *(uint32_t*)(cpu->esp + 0x1Cu);
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->esi;
    *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->edi) * 8u) + 4u) = cpu->ecx;
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_window_runtime.landscape_grid_count) = (uint64_t)(g_sfera_window_runtime.landscape_grid_count) + 1u;
    label_0006A1BF:
    ++cpu->esi;
    ...
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x1Cu);
    *(uint32_t*)(cpu->eax + ((uint32_t)(cpu->edi) * 8u)) = cpu->ecx;
    cpu->edi = g_sfera_window_runtime.landscape_grid_count;
    ...
    cpu->edx = g_sfera_scene_array_runtime.render_ranges.data;
    cpu->esi -= *(uint32_t*)(cpu->esp + 0x1Cu);
    *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->edi) * 8u) + 4u) = cpu->esi;
    *(float*)(cpu->esp + 0xF8u) = cpu->fpu[0u];
    cpu->eax = 0x5F317777u;
    ...
    *(float*)(cpu->esp + 0xDCu) = cpu->fpu[0u];
    cpu->eax = (uint32_t)(cpu->esp + 0xC0u);
    *(float*)(cpu->esp + 0xD8u) = cpu->fpu[0u];
    lift_push32(cpu, cpu->eax);
    ...
    *(float*)(cpu->esp + 0xC8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 1.0);
    lift_push32(cpu, 0x40u);
    *(float*)(cpu->esp + 0x1C8u) = cpu->fpu[0u];
    cpu->edx = (uint32_t)(cpu->esp + 0x1E0u);
    *(float*)(cpu->esp + 0x1DCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_push32(cpu, 0u); lift_push32(cpu, cpu->edx);
    lift_native_call(cpu, native_function_address32(&::memset), LIFT_CODE_TOKEN_VA(0x46A31Du));
    lift_x87_push(cpu, 1.0);
    *(float*)(cpu->esp + 0x1E8u) = cpu->fpu[0u];
    cpu->esp += 0x18u;
    *(float*)(cpu->esp + 0x1E4u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x1F8u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x20Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 0.6000000238418579);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46A34Eu)); sfera_sub_004EED54(cpu, LIFT_CODE_TOKEN_VA(0x46A34Eu));
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    ...
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46A37Fu)); sfera_sub_004EED60(cpu, LIFT_CODE_TOKEN_VA(0x46A37Fu));
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[0u]);
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46A3A4u)); sfera_sub_004EED54(cpu, LIFT_CODE_TOKEN_VA(0x46A3A4u));
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    ...
    *(float*)(cpu->esp + 0x190u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) * (0.19634956121444702);
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46A3D4u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46A3D4u));
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    cpu->ecx = g_sfera_graphics_runtime.d3d9_device;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (0.003000000026077032);
    lift_push32(cpu, 0u);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x1Cu));
    ...
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[0u] = -cpu->fpu[0u];
    *(float*)(cpu->esp + 0x1ACu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)0.5f);
    *(float*)(cpu->esp + 0x1B8u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x1BCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x34u) = 0u;
    ...
    label_0006A464:
    cpu->eax = g_sfera_scene_array_runtime.render_ranges.data;
    cpu->esi = *(uint32_t*)(cpu->eax + ((uint32_t)(cpu->edi) * 8u));
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->ebx;
    ...
    cpu->ecx = (uint32_t)(cpu->esi + ((uint32_t)(cpu->esi) * 2u));
    lift_x87_push(cpu, (double)*(float*)(cpu->edx + ((uint32_t)(cpu->ecx) * 8u) + 0x14u));
    cpu->esi = 0u;
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->esi;
    ...
    if ((int32_t)(uint32_t)(cpu->eax) >= (int32_t)*(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->edi) * 8u) + 4u)) goto label_0006AE24;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x24u);
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->eax;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (2.3561947345733643);
    *(double*)(cpu->esp + 0x28u) = cpu->fpu[0u];
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x10u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (3.9269912242889404);
    *(double*)(cpu->esp + 0x70u) = cpu->fpu[0u];
    lift_x87_push(cpu, (double)(((int32_t)(g_sfera_landscape_render_runtime.rotation_step))));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (0.19634956121444702);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    cpu->fpu[2u] = cpu->fpu[2u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->edi + cpu->ecx) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46A5C5u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46A5C5u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x20u)));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->edx + 8u)));
    *(float*)(cpu->edi + cpu->eax + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    label_0006A62B:
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x18u);
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->ecx)))));
    cpu->edx = g_sfera_scene_array_runtime.render_work_records.data;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (8.333333015441895);
    *(float*)(cpu->edi + cpu->edx + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->eax = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->eax + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)-1.0f);
    cpu->ecx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->ecx + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->edx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->edx + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->eax = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->eax + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->ecx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->ecx + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->ebx = (uint32_t)(cpu->ebx + 1u);
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ebx;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x10u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (3.9269912242889404);
    *(double*)(cpu->esp + 0x68u) = cpu->fpu[0u];
    lift_x87_push(cpu, (double)(((int32_t)(g_sfera_landscape_render_runtime.rotation_step))));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (0.19634956121444702);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    cpu->fpu[0u] = (cpu->fpu[0u]) + (*(double*)(cpu->esp + 0x28u));
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->edx;
    ...
    cpu->edi <<= 5u;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (8.333333015441895);
    *(float*)(cpu->edi + cpu->eax) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46A7A2u)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46A7A2u));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->edi + cpu->ecx + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax = g_sfera_scene_array_runtime.render_work_records.data;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (8.333333015441895);
    *(float*)(cpu->edi + cpu->eax + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->ecx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->ecx + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)-1.0f);
    cpu->edx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->edx + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->eax = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->eax + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 1.0);
    cpu->ecx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->ecx + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax = *(uint32_t*)(cpu->esp + 0x38u);
    cpu->edx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->edx + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(double*)(cpu->esp + 0x38u) = cpu->fpu[0u];
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) * (0.19634956121444702);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    cpu->fpu[0u] = (cpu->fpu[0u]) + (*(double*)(cpu->esp + 0x68u));
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->ecx;
    ...
    cpu->edi <<= 5u;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (8.333333015441895);
    *(float*)(cpu->edi + cpu->edx) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46A97Du)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46A97Du));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->edi + cpu->edx + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) + (*(double*)(cpu->esp + 0x70u));
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->edi + cpu->eax) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46AB3Fu)); sfera_sub_004EE9F8(cpu, LIFT_CODE_TOKEN_VA(0x46AB3Fu));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->eax;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x28u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (8.333333015441895);
    *(float*)(cpu->edi + cpu->ecx + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->edx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->edx + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)-1.0f);
    cpu->eax = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->eax + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->ecx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->ecx + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 0.0);
    cpu->edx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->edx + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, 1.0);
    cpu->eax = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->eax + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ++cpu->esi;
    ...
    *(uint16_t*)(cpu->edx + ((uint32_t)(cpu->edi) * 2u)) = cpu->ecx & 0xFFFFu;
    cpu->eax = *(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state;
    cpu->edi = cpu->eax;
    ++cpu->eax;
    (*(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state) = (uint32_t)(cpu->eax);
    ...
    *(uint16_t*)(cpu->eax + ((uint32_t)(cpu->edi) * 2u)) = cpu->ebx & 0xFFFFu;
    cpu->eax = *(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state;
    cpu->edi = cpu->eax;
    ++cpu->eax;
    (*(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state) = (uint32_t)(cpu->eax);
    ...
    cpu->eax = (uint32_t)(cpu->esi + 0xFFFFFFFFu);
    *(uint16_t*)(cpu->ecx + ((uint32_t)(cpu->edi) * 2u)) = cpu->eax & 0xFFFFu;
    cpu->eax = *(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state;
    cpu->edi = cpu->eax;
    ++cpu->eax;
    (*(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state) = (uint32_t)(cpu->eax);
    ...
    label_0006AD8C:
    cpu->edx = g_sfera_light_runtime.cell_light_ids.data;
    *(uint16_t*)(cpu->edx + ((uint32_t)(cpu->edi) * 2u)) = cpu->ebx & 0xFFFFu;
    cpu->eax = *(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state;
    cpu->edi = cpu->eax;
    ++cpu->eax;
    (*(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state) = (uint32_t)(cpu->eax);
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x24u)) + (uint64_t)(0x74u) + (uint64_t)(0u);
    cpu->ebx = *(uint32_t*)(cpu->esp + 0x14u);
    cpu->eax = (uint32_t)(cpu->esi + 0xFFFFFFFFu);
    *(uint16_t*)(cpu->edx + ((uint32_t)(cpu->edi) * 2u)) = cpu->eax & 0xFFFFu;
    cpu->edi = *(uint32_t*)(cpu->esp + 0x34u);
    goto label_0006A500;
    label_0006AE24:
    ...
    cpu->edx = (cpu->edx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->ecx + ((uint32_t)(cpu->eax) * 8u))) & 0xFFu);
    ...
    *(uint32_t*)(cpu->eax + 8u) = cpu->edx;
    ...
    lift_x87_push(cpu, 1.0);
    cpu->edx = g_sfera_scene_array_runtime.reflection_targets.data;
    *(float*)(cpu->esp + 0x10Cu) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x110u) = cpu->fpu[0u];
    cpu->ecx = (uint32_t)(cpu->edi + ((uint32_t)(cpu->edi) * 2u));
    *(float*)(cpu->esp + 0x114u) = cpu->fpu[0u];
    cpu->esp += 0xCu;
    lift_x87_push(cpu, (double)*(float*)(cpu->edx + ((uint32_t)(cpu->ecx) * 8u) + 8u));
    cpu->eax = (uint32_t)(cpu->esp + 0x100u);
    cpu->ecx = g_sfera_graphics_runtime.d3d9_device;
    *(float*)(cpu->esp + 0x10Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 0.0);
    lift_push32(cpu, cpu->eax);
    *(float*)(cpu->esp + 0x124u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x128u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x12Cu) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x144u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 0x114u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x118u) = cpu->fpu[0u];
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->edi;
    label_0006B064:
    if ((int32_t)*(uint32_t*)(cpu->esp + 0x34u) >= (int32_t)(uint32_t)(0u)) goto label_0006B075;
    cpu->ecx = (uint32_t)(uintptr_t)&g_sfera_scene_array_runtime.render_ranges.debug_file[0];
    ...
    cpu->edx = *(uint32_t*)(cpu->esp + 0x1Cu);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x34u);
    if ((int32_t)(uint32_t)(cpu->edx) >= (int32_t)*(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->eax) * 8u) + 4u)) goto label_0006B2B1;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x24u);
    cpu->ebx = *(uint32_t*)(cpu->eax);
    cpu->ebx += 0x2710u;
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    *(float*)(cpu->edi + cpu->eax + 0x38u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x38u));
    cpu->ecx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->ecx + 0x3Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x18u));
    cpu->edx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->edx + 0x58u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x38u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x38u));
    *(float*)(cpu->edi + cpu->ecx + 0x5Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->edx = g_sfera_scene_array_runtime.render_work_records.data;
    *(float*)(cpu->edi + cpu->edx + 0x78u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax = g_sfera_scene_array_runtime.render_work_records.data;
    *(uint32_t*)(cpu->esp + 0x1Cu) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x1Cu)) + 1u;
    *(float*)(cpu->edi + cpu->eax + 0x7Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->ebx = *(uint32_t*)(cpu->esp + 0x14u);
    ++cpu->esi;
    cpu->edi -= 0xFFFFFF80u;
    *(uint32_t*)(cpu->esp + 0x24u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x24u)) + (uint64_t)(0x74u) + (uint64_t)(0u);
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->eax;
    ...
    cpu->edx = g_sfera_scene_array_runtime.reflection_targets.data;
    cpu->ecx = (uint32_t)(cpu->edi + ((uint32_t)(cpu->edi) * 2u));
    if ((uint32_t)(cpu->eax) == *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->ecx) * 8u) + 4u)) goto label_0006B3AB;
    cpu->edi = *(uint32_t*)(cpu->ebx + 0x10u);
    ...
    cpu->ecx = g_sfera_scene_array_runtime.reflection_targets.data;
    cpu->eax = (uint32_t)(cpu->edi + ((uint32_t)(cpu->edi) * 2u));
    cpu->edx = (cpu->edx & 0xFFFFFF00u) | ((uint32_t)(*(uint8_t*)(cpu->ecx + ((uint32_t)(cpu->eax) * 8u) + 4u)) & 0xFFu);
    cpu->eax = g_sfera_landscape_render_runtime.rotation_step;
    cpu->edx = (cpu->edx & 0xFFFFFF00u) | ((uint32_t)(((uint64_t)((cpu->edx & 0xFFu)) + (uint64_t)(0x30u) + (uint64_t)(0u))) & 0xFFu);
    *(uint8_t*)(cpu->esp + 0x216u) = cpu->edx & 0xFFu;
    cpu->edx = ((int32_t)cpu->eax < 0) ? 0xFFFFFFFFu : 0u;
    ...
    *(uint8_t*)(cpu->esp + 0x219u) = cpu->edx & 0xFFu;
    ...
    lift_x87_push(cpu, 1.0);
    cpu->ecx = g_sfera_scene_array_runtime.reflection_targets.data;
    *(float*)(cpu->esp + 0x154u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x158u) = cpu->fpu[0u];
    cpu->eax = (uint32_t)(cpu->edi + ((uint32_t)(cpu->edi) * 2u));
    *(float*)(cpu->esp + 0x15Cu) = cpu->fpu[0u];
    cpu->esp += 0xCu;
    lift_x87_push(cpu, (double)*(float*)(cpu->ecx + ((uint32_t)(cpu->eax) * 8u) + 0xCu));
    cpu->edx = (uint32_t)(cpu->esp + 0x148u);
    cpu->ecx = g_sfera_graphics_runtime.d3d9_device;
    *(float*)(cpu->esp + 0x154u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 0.0);
    lift_push32(cpu, cpu->edx);
    *(float*)(cpu->esp + 0x16Cu) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x170u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x174u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x18Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 0x15Cu) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x160u) = cpu->fpu[0u];
    ...
    *(uint32_t*)(cpu->eax + 8u) = cpu->edx;
    ...
    lift_x87_push(cpu, 1.0);
    cpu->ecx = g_sfera_scene_array_runtime.reflection_targets.data;
    *(float*)(cpu->esp + 0x84u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x88u) = cpu->fpu[0u];
    cpu->eax = (uint32_t)(cpu->edi + ((uint32_t)(cpu->edi) * 2u));
    *(float*)(cpu->esp + 0x8Cu) = cpu->fpu[0u];
    cpu->esp += 0xCu;
    lift_x87_push(cpu, (double)*(float*)(cpu->ecx + ((uint32_t)(cpu->eax) * 8u) + 0x10u));
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046B7D0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    label_0006B804:
    cpu->eax = g_sfera_world_objects.object_handles.data;
    if (*(uint32_t*)(cpu->eax + ((uint32_t)(cpu->edi) * 4u)) == (uint32_t)(0u)) goto label_0006B998;
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x14Cu));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x418u)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x158u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x414u)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[3u]; cpu->fpu[3u] = temporary; }
    cpu->fpu[1u] = cpu->fpu[0u] - cpu->fpu[1u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x410u)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x164u)));
    cpu->fpu[2u] = cpu->fpu[2u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)((uint32_t)(uintptr_t)&g_sfera_scene_vector_runtime.object_position_delta.x.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x150u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[2u]);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x15Cu));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[4u]);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[2u]);
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_scene_vector_runtime.object_position_delta.y.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x154u));
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x160u));
    cpu->fpu[3u] = cpu->fpu[3u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esi + 0x16Cu)));
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_scene_vector_runtime.object_position_delta.z.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_scene_vector_runtime.object_position_delta.x.f32));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->esi + 8u)));
    *(float*)(cpu->esi + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0xCu));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)g_sfera_scene_vector_runtime.object_position_delta.y.f32));
    *(float*)(cpu->esi + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x10u));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)g_sfera_scene_vector_runtime.object_position_delta.z.f32));
    *(float*)(cpu->esi + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 8u));
    *(float*)((uint32_t)(uintptr_t)&g_sfera_scene_control_runtime.camera_x.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0xCu));
    *(float*)((uint32_t)(uintptr_t)&g_sfera_scene_control_runtime.camera_y.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esi + 0x10u));
    *(float*)((uint32_t)(uintptr_t)&g_sfera_main_input_state_runtime.motion_accumulator) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_scene_control_runtime.camera_x.f32));
    lift_x87_push(cpu, 333.0);
    cpu->fpu[1u] = (cpu->fpu[1u]) + (cpu->fpu[0u]);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)((uint32_t)(uintptr_t)&g_sfera_scene_control_runtime.camera_x.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_scene_control_runtime.camera_y.f32));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[1u]);
    *(float*)((uint32_t)(uintptr_t)&g_sfera_scene_control_runtime.camera_y.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)((uint32_t)(uintptr_t)&g_sfera_main_input_state_runtime.motion_accumulator) = cpu->fpu[0u]; lift_x87_pop(cpu);
    goto label_0006B9C0;
    label_0006B94C:
    if (*(uint8_t*)(cpu->esi + 0x138u) != (uint8_t)(0u)) goto label_0006B838;
    cpu->edx = *(uint32_t*)(cpu->esi + 4u);
    cpu->ecx = g_sfera_model_runtime.repository;
    lift_push32(cpu, cpu->edx);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046B9E0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x2Cu) = 0u;
    ...
    cpu->edx = *(uint32_t*)(cpu->esp + 0x20u);
    cpu->esi = *(uint32_t*)(cpu->edx + 0x1F0u);
    cpu->ecx = 0x18u;
    ...
    *(float*)(cpu->esp) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[2u]; cpu->fpu[2u] = temporary; }
    label_0006BBC7:
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_view_geometry_runtime.reference_points[3].y));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    ...
    *(float*)(cpu->esp + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    label_0006BBF5:
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_view_geometry_runtime.reference_points[3].z));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    ...
    *(float*)(cpu->esp + 8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[1u] = (cpu->fpu[1u]) * (cpu->fpu[0u]);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46BCCEu)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46BCCEu));
    cpu->fpu[3u] = (cpu->fpu[3u]) * (cpu->fpu[0u]);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[3u]; cpu->fpu[3u] = temporary; }
    g_sfera_view_geometry_runtime.projected_bounds.min_x = (uint32_t)(cpu->eax);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46BCDCu)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46BCDCu));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[3u]);
    g_sfera_view_geometry_runtime.projected_bounds.max_x = (uint32_t)(cpu->eax);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46BCECu)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46BCECu));
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[2u]);
    g_sfera_view_geometry_runtime.projected_bounds.min_y = (uint32_t)(cpu->eax);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46BCFAu)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46BCFAu));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[2u]);
    g_sfera_view_geometry_runtime.projected_bounds.max_y = (uint32_t)(cpu->eax);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46BD0Au)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46BD0Au));
    cpu->fpu[1u] = cpu->fpu[1u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    g_sfera_view_geometry_runtime.projected_bounds.min_z = (uint32_t)(cpu->eax);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46BD16u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46BD16u));
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046BD40(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(float*)(cpu->esp + 0x2Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->ebp = cpu->edx;
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_view_spatial_runtime.scale.y));
    lift_push32(cpu, cpu->edi);
    ...
    *(float*)(cpu->esp + 0xD8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x14Cu)))));
    cpu->esp -= 0xCu;
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x15Cu)))));
    *(float*)(cpu->esp + 0x24u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x20u));
    cpu->fpu[0u] = (cpu->fpu[0u]) / (((double)*(float*)(cpu->esp + 0x24u)));
    *(float*)(cpu->esp + 0x28u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x1Cu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46BE76u)); sfera_sub_004EED54(cpu, LIFT_CODE_TOKEN_VA(0x46BE76u));
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x1Cu));
    cpu->fpu[0u] = (cpu->fpu[0u]) / (((double)*(float*)(cpu->esp + 0x28u)));
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x1Cu));
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46BE8Fu)); sfera_sub_004EED60(cpu, LIFT_CODE_TOKEN_VA(0x46BE8Fu));
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x1Cu));
    lift_push32(cpu, cpu->ecx);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[0u]);
    ...
    *(float*)(cpu->esp + 0x124u) = cpu->fpu[0u];
    lift_push32(cpu, 0x100u);
    *(float*)(cpu->esp + 0x120u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x11Cu) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x118u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x114u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x10Cu) = cpu->fpu[0u];
    ...
    *(float*)(cpu->esp + 0x100u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 1.0);
    *(float*)(cpu->esp + 0x138u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x124u) = cpu->fpu[0u];
    *(float*)(cpu->esp + 0x110u) = cpu->fpu[0u];
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046C0B0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ebp;
    if ((int32_t)(uint32_t)(cpu->ebp) > (int32_t)*(uint32_t*)(cpu->esp + 0x44u)) goto label_0006C25E;
    cpu->ecx = (uint32_t)(cpu->ecx);
    label_0006C130:
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x20u)) + 1u;
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)g_sfera_view_spatial_runtime.world_anchor.x.f32));
    ++cpu->edx;
    cpu->edi += 0x20u;
    cpu->esi += 0x1Cu;
    *(float*)(cpu->esp + 0x30u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax += 0x28u;
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)g_sfera_view_spatial_runtime.world_anchor.y.f32));
    *(float*)(cpu->esp + 0x34u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->eax + 0xFFFFFFD8u)));
    ...
    *(float*)(cpu->edi + 0xFFFFFFF8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->eax + 0xFFFFFFECu));
    *(float*)(cpu->edi + 0xFFFFFFFCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esi + 0xFFFFFFF4u) = 0x323232u;
    if ((int32_t)(uint32_t)(cpu->edx) < (int32_t)*(uint32_t*)(cpu->ecx)) goto label_0006C1B0;
    cpu->ebx = *(uint32_t*)(cpu->esp + 0x10u);
    label_0006C24B:
    ++cpu->ebx;
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ebx;
    if ((int32_t)(uint32_t)(cpu->ebx) <= (int32_t)*(uint32_t*)(cpu->esp + 0x44u)) goto label_0006C130;
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ebp;
    if ((int32_t)(uint32_t)(cpu->ebp) > (int32_t)*(uint32_t*)(cpu->esp + 0x44u)) goto label_0006C5F6;
    label_0006C2E1:
    ...
    label_0006C307:
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->esp + 0x2Cu)), r=(uint64_t)(1u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    cpu->ecx = g_sfera_light_runtime.cell_indices.data;
    cpu->edx = *(uint32_t*)(cpu->esp + 0x10u);
    cpu->ebp = *(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->edx) * 4u));
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->eax;
    ...
    label_0006C352:
    cpu->eax = *(uint32_t*)(cpu->esp + 0x20u);
    if (*(uint16_t*)(cpu->ebp + 0x10u) == (uint16_t)((cpu->eax & 0xFFFFu))) goto label_0006C43A;
    ...
    cpu->ecx = (uint32_t)(cpu->eax + ((uint32_t)(cpu->eax) * 2u));
    cpu->edi = *(uint32_t*)(((uint32_t)(cpu->ecx) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_scene_control_runtime.microtextures[0].name));
    cpu->ecx = cpu->edi;
    ...
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_client_config_runtime.state_08) = (uint64_t)((*(uint32_t*)(void*)&g_sfera_client_config_runtime.state_08)) + (uint64_t)(cpu->esi) + (uint64_t)(0u);
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->eax;
    if ((int32_t)*(uint32_t*)(cpu->ebp + 8u) <= (int32_t)(uint32_t)(cpu->eax)) goto label_0006C50E;
    label_0006C461:
    ...
    label_0006C483:
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edi)) & 0xFFFFu);
    cpu->ecx = g_sfera_light_runtime.cell_light_ids.data;
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(((uint64_t)((cpu->eax & 0xFFFFu)) + (uint64_t)((cpu->ebx & 0xFFFFu)) + (uint64_t)(0u))) & 0xFFFFu);
    { uint64_t l=(uint64_t)(cpu->esi), v=l + 1u; uint32_t cf=cpu->eflags & LIFT_FLAG_CF; lift_flags_add(cpu,l,1u,0u,v,32u); cpu->eflags=(cpu->eflags & ~LIFT_FLAG_CF) | cf; cpu->esi = v; }
    *(uint16_t*)(cpu->ecx + ((uint32_t)(cpu->esi) * 2u) + 0xFFFFFFFEu) = cpu->eax & 0xFFFFu;
    ...
    label_0006C4B5:
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edi + 2u)) & 0xFFFFu);
    cpu->eax = g_sfera_light_runtime.cell_light_ids.data;
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(((uint64_t)((cpu->edx & 0xFFFFu)) + (uint64_t)((cpu->ebx & 0xFFFFu)) + (uint64_t)(0u))) & 0xFFFFu);
    { uint64_t l=(uint64_t)(cpu->esi), v=l + 1u; uint32_t cf=cpu->eflags & LIFT_FLAG_CF; lift_flags_add(cpu,l,1u,0u,v,32u); cpu->eflags=(cpu->eflags & ~LIFT_FLAG_CF) | cf; cpu->esi = v; }
    *(uint16_t*)(cpu->eax + ((uint32_t)(cpu->esi) * 2u) + 0xFFFFFFFEu) = cpu->edx & 0xFFFFu;
    ...
    label_0006C4E7:
    cpu->ecx = (cpu->ecx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edi + 4u)) & 0xFFFFu);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x1Cu);
    cpu->edx = g_sfera_light_runtime.cell_light_ids.data;
    cpu->ecx = (cpu->ecx & 0xFFFF0000u) | ((uint32_t)(((uint64_t)((cpu->ecx & 0xFFFFu)) + (uint64_t)((cpu->ebx & 0xFFFFu)) + (uint64_t)(0u))) & 0xFFFFu);
    *(uint16_t*)(cpu->edx + ((uint32_t)(cpu->esi) * 2u)) = cpu->ecx & 0xFFFFu;
    ++cpu->eax;
    ++cpu->esi;
    cpu->edi += 6u;
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) < (int32_t)*(uint32_t*)(cpu->ebp + 8u)) goto label_0006C461;
    label_0006C50E:
    cpu->eax = *(uint32_t*)(cpu->esp + 0x30u);
    cpu->ebx += *(uint32_t*)(cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x10u);
    ++cpu->eax;
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) <= (int32_t)*(uint32_t*)(cpu->esp + 0x44u)) goto label_0006C2E1;
    ...
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_client_config_runtime.state_08) = (uint64_t)((*(uint32_t*)(void*)&g_sfera_client_config_runtime.state_08)) + (uint64_t)(cpu->esi) + (uint64_t)(0u);
    ...
    cpu->eax = *(uint32_t*)(cpu->esp + 0x24u);
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) > (int32_t)*(uint32_t*)(cpu->esp + 0x44u)) goto label_0006C758;
    ...
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->eax + ((uint32_t)(cpu->ecx) * 4u) + 0x10u)), r=(uint64_t)(0x40000000u), v=l & r; lift_flags_logic(cpu,v,32u); }
    cpu->edi = (uint32_t)(cpu->eax + ((uint32_t)(cpu->ecx) * 4u));
    if ((cpu->eflags & LIFT_FLAG_ZF) == 0u) goto label_0006C745;
    cpu->ebx = 0u;
    if ((int32_t)*(uint32_t*)(cpu->esi + 0x14u) <= (int32_t)(uint32_t)(cpu->ebx)) goto label_0006C745;
    cpu->ebx = (uint32_t)(cpu->ebx);
    label_0006C6A0:
    cpu->edx = cpu->ebx;
    cpu->ecx = cpu->esi;
    ...
    if ((int32_t)(uint32_t)(cpu->ebx) < (int32_t)*(uint32_t*)(cpu->esi + 0x14u)) goto label_0006C6A0;
    label_0006C745:
    cpu->eax = *(uint32_t*)(cpu->esp + 0x10u);
    ++cpu->eax;
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) <= (int32_t)*(uint32_t*)(cpu->esp + 0x44u)) goto label_0006C637;
    label_0006C758:
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_view_spatial_runtime.basis[1].x));
    ...
    *(uint64_t*)(cpu->esp + 0x30u) = lift_x87_round(cpu, cpu->fpu[0u], 0u);
    ...
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_view_spatial_runtime.basis[1].y));
    *(uint16_t*)(cpu->esp + 0x10u) = cpu->fpu_control;
    cpu->eax = *(uint16_t*)(cpu->esp + 0x10u);
    cpu->eax |= 0xC00u;
    *(uint32_t*)(cpu->esp + 0x30u) = cpu->eax;
    ...
    *(uint64_t*)(cpu->esp + 0x30u) = lift_x87_round(cpu, cpu->fpu[0u], 0u);
    ...
    cpu->ecx <<= 8u;
    cpu->fpu_control = *(uint16_t*)(cpu->esp + 0x10u);
    lift_x87_push(cpu, (double)*(float*)((uint32_t)(uintptr_t)&g_sfera_view_spatial_runtime.basis[1].z));
    *(uint16_t*)(cpu->esp + 0x10u) = cpu->fpu_control;
    cpu->eax = *(uint16_t*)(cpu->esp + 0x10u);
    cpu->eax |= 0xC00u;
    *(uint32_t*)(cpu->esp + 0x30u) = cpu->eax;
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ebx;
    cpu->ebp = cpu->eax;
    { uint64_t l=(uint64_t)(cpu->eax), r=(uint64_t)(*(uint32_t*)(cpu->esp + 0x44u)), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->eax;
    ...
    cpu->ecx = g_sfera_light_runtime.cell_indices.data;
    cpu->edx = *(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->ebp) * 4u));
    cpu->eax = *(uint32_t*)(cpu->edx + 4u);
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->edi;
    ...
    cpu->eax &= 0x3FFFFFFFu;
    if ((uint32_t)(cpu->ebp) != *(uint32_t*)(cpu->esp + 0x24u)) goto label_0006C8F4;
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    ...
    goto label_0006C9D1;
    label_0006C8F4:
    if ((uint32_t)(cpu->eax) == *(uint32_t*)(cpu->esp + 0x10u)) goto label_0006C9D5;
    cpu->edx = *(uint32_t*)(cpu->esp + 0x2Cu);
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x10u);
    ...
    *(uint32_t*)(cpu->esp + 0x2Cu) = cpu->ecx;
    ...
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x30u);
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->ecx + 8u)), r=(uint64_t)(0u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    *(uint32_t*)(cpu->esp + 0x1Cu) = 0u;
    ...
    label_0006CA22:
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edi)) & 0xFFFFu);
    cpu->eax = g_sfera_light_runtime.cell_light_ids.data;
    cpu->edx = (cpu->edx & 0xFFFF0000u) | ((uint32_t)(((uint64_t)((cpu->edx & 0xFFFFu)) + (uint64_t)((cpu->ebx & 0xFFFFu)) + (uint64_t)(0u))) & 0xFFFFu);
    { uint64_t l=(uint64_t)(cpu->esi), v=l + 1u; uint32_t cf=cpu->eflags & LIFT_FLAG_CF; lift_flags_add(cpu,l,1u,0u,v,32u); cpu->eflags=(cpu->eflags & ~LIFT_FLAG_CF) | cf; cpu->esi = v; }
    *(uint16_t*)(cpu->eax + ((uint32_t)(cpu->esi) * 2u) + 0xFFFFFFFEu) = cpu->edx & 0xFFFFu;
    ...
    label_0006CA53:
    cpu->ecx = (cpu->ecx & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edi + 2u)) & 0xFFFFu);
    cpu->edx = g_sfera_light_runtime.cell_light_ids.data;
    cpu->ecx = (cpu->ecx & 0xFFFF0000u) | ((uint32_t)(((uint64_t)((cpu->ecx & 0xFFFFu)) + (uint64_t)((cpu->ebx & 0xFFFFu)) + (uint64_t)(0u))) & 0xFFFFu);
    { uint64_t l=(uint64_t)(cpu->esi), v=l + 1u; uint32_t cf=cpu->eflags & LIFT_FLAG_CF; lift_flags_add(cpu,l,1u,0u,v,32u); cpu->eflags=(cpu->eflags & ~LIFT_FLAG_CF) | cf; cpu->esi = v; }
    *(uint16_t*)(cpu->edx + ((uint32_t)(cpu->esi) * 2u) + 0xFFFFFFFEu) = cpu->ecx & 0xFFFFu;
    ...
    label_0006CA86:
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(*(uint16_t*)(cpu->edi + 4u)) & 0xFFFFu);
    cpu->ecx = g_sfera_light_runtime.cell_light_ids.data;
    cpu->edx = *(uint32_t*)(cpu->esp + 0x30u);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(((uint64_t)((cpu->eax & 0xFFFFu)) + (uint64_t)((cpu->ebx & 0xFFFFu)) + (uint64_t)(0u))) & 0xFFFFu);
    *(uint16_t*)(cpu->ecx + ((uint32_t)(cpu->esi) * 2u)) = cpu->eax & 0xFFFFu;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x1Cu);
    ++cpu->eax;
    ++cpu->esi;
    cpu->edi += 6u;
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->eax;
    if ((int32_t)(uint32_t)(cpu->eax) < (int32_t)*(uint32_t*)(cpu->edx + 8u)) goto label_0006CA00;
    label_0006CAB1:
    cpu->eax = *(uint32_t*)(cpu->esp + 0x28u);
    cpu->ebx += *(uint32_t*)(cpu->eax);
    *(uint32_t*)(cpu->esp + 0x20u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x20u)) + (uint64_t)(0x60u) + (uint64_t)(0u);
    ++cpu->ebp;
    if ((int32_t)(uint32_t)(cpu->ebp) <= (int32_t)*(uint32_t*)(cpu->esp + 0x44u)) goto label_0006C850;
    label_0006CAC7:
    cpu->edx = *(uint32_t*)(cpu->esp + 0x2Cu);
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x10u);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046CBA0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint8_t*)(cpu->edx + cpu->eax) = cpu->ecx & 0xFFu;
    ...
    cpu->edx = *(uint32_t*)(((uint32_t)(uintptr_t)"_00.lnd") + 4u);
    *(uint32_t*)(cpu->eax) = cpu->ecx;
    *(uint32_t*)(cpu->eax + 4u) = cpu->edx;
    cpu->eax = (uint32_t)(cpu->esp + 0x50u);
    cpu->edx = (uint32_t)(cpu->eax + 1u);
    ...
    *(uint32_t*)(cpu->esp + 0x40u) = cpu->eax;
    *(uint32_t*)(cpu->esi + ((uint32_t)(cpu->eax) * 4u) + 0x8Cu) = cpu->ebp;
    ...
    *(uint32_t*)(cpu->edx + cpu->eax + 4u) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->eax + cpu->edx) = cpu->fpu[0u];
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(uint32_t*)(cpu->edx + cpu->eax + 0xCu) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->edx + cpu->eax + 8u) = cpu->fpu[0u];
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(uint32_t*)(cpu->edx + cpu->eax + 0x14u) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->edx + cpu->eax + 0x10u) = cpu->fpu[0u];
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(uint32_t*)(cpu->edx + cpu->eax + 0x1Cu) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->eax + cpu->edx + 0x18u) = cpu->fpu[0u];
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(uint32_t*)(cpu->edx + cpu->eax + 0x24u) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->edx + cpu->eax + 0x20u) = cpu->fpu[0u];
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(uint32_t*)(cpu->edx + cpu->eax + 0x2Cu) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->edx + cpu->eax + 0x28u) = cpu->fpu[0u];
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(uint32_t*)(cpu->edx + cpu->eax + 0x34u) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->edx + cpu->eax + 0x30u) = cpu->fpu[0u];
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(uint32_t*)(cpu->edx + cpu->eax + 0x3Cu) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->edx + cpu->eax + 0x38u) = cpu->fpu[0u];
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(uint32_t*)(cpu->edx + cpu->eax + 0x44u) = cpu->ecx;
    cpu->edx = *(uint32_t*)(cpu->ebp + 0x1B1Cu);
    *(float*)(cpu->edx + cpu->eax + 0x40u) = cpu->fpu[0u];
    cpu->eax += 0x48u;
    ...
    *(uint32_t*)(cpu->esi + 0xFFFFFFFCu) = cpu->eax;
    ...
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->eax + ((uint32_t)(cpu->edx) * 8u) + 4u)), r=(uint64_t)(0u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(float*)(cpu->edi + 0xCu) = cpu->fpu[0u];
    *(float*)(cpu->edi + 0x30u) = cpu->fpu[0u];
    *(float*)(cpu->edi + 0x3Cu) = cpu->fpu[0u];
    cpu->fpu[0u] = (cpu->fpu[0u]) * (1024.0);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46CFADu)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46CFADu));
    ...
    *(uint16_t*)(cpu->esi) = cpu->eax & 0xFFFFu;
    label_0006CFE4:
    cpu->edx = 0u;
    if ((int32_t)*(uint32_t*)(cpu->esi + 4u) <= (int32_t)(uint32_t)(cpu->edx)) goto label_0006D017;
    cpu->eax = (uint32_t)(cpu->esi + 8u);
    cpu->edi = cpu->edi;
    label_0006CFF0:
    cpu->ecx = *(uint16_t*)(cpu->eax);
    cpu->edi = g_sfera_client_main_scalar_runtime.state_02;
    cpu->ecx = *(uint16_t*)(cpu->edi + ((uint32_t)(cpu->ecx) * 2u));
    cpu->edi = 0xFFFFu;
    ...
    *(uint16_t*)(cpu->eax) = cpu->ecx & 0xFFFFu;
    ++cpu->edx;
    cpu->eax += 2u;
    if ((int32_t)(uint32_t)(cpu->edx) < (int32_t)*(uint32_t*)(cpu->esi + 4u)) goto label_0006CFF0;
    label_0006D017:
    cpu->eax = (int8_t)(*(uint8_t*)(cpu->ebx));
    { uint64_t l=(uint64_t)(cpu->eax), r=(uint64_t)(*(uint32_t*)(cpu->esi + 4u)), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(uint32_t*)(cpu->esp + cpu->eax + 0x61u) = 0x736464u;
    ...
    cpu->edx = 0u;
    cpu->ecx = (uint32_t)(cpu->esp + 0x64u);
    *(uint32_t*)(cpu->ebp + ((uint32_t)(cpu->ebx) * 4u) + 0x3ACu) = cpu->eax;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D173u)); sfera_sub_0042EBF0(cpu, LIFT_CODE_TOKEN_VA(0x46D173u));
    cpu->edx = *(uint32_t*)(cpu->ebp + ((uint32_t)(cpu->ebx) * 4u) + 0x3ACu);
    cpu->edi = cpu->eax;
    lift_push32(cpu, cpu->esi);
    cpu->ecx = cpu->edi;
    ...
    *(uint8_t*)(cpu->esp + cpu->eax + 0x4Cu) = cpu->edx & 0xFFu;
    ...
    cpu->edi = lift_pop32(cpu);
    *(uint32_t*)(cpu->ebp + ((uint32_t)(cpu->ebx) * 4u) + 0x21Cu) = cpu->eax;
    *(uint32_t*)((uint32_t)(uintptr_t)&g_sfera_recovered_static_runtime.client_state_03) = (uint64_t)(g_sfera_recovered_static_runtime.client_state_03) + 1u;
    ...
    label_0006D201:
    cpu->eax = *(uint16_t*)(cpu->esi + ((uint32_t)(cpu->edx) * 2u) + 8u);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x10u);
    cpu->ecx = cpu->eax;
    cpu->ecx >>= 8u;
    lift_push32(cpu, cpu->ecx);
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046D240(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->edi);
    cpu->edi = (uint32_t)(cpu->eax + ((uint32_t)(cpu->ecx) * 2u));
    if (*(uint32_t*)(cpu->esi + ((uint32_t)(cpu->edi) * 4u) + 0x8Cu) != (uint32_t)(0u)) goto label_0006D260;
    lift_push32(cpu, cpu->eax);
    cpu->ecx = cpu->esi;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046D270(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->esi;
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) / (cpu->fpu[2u]);
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[1u]);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D2AAu)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D2AAu));
    *(uint32_t*)(((uint32_t)(cpu->esi) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_color_expansion_runtime.five_bit_to_eight_bit[0])) = cpu->eax;
    ++cpu->esi;
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->esi;
    ...
    *(uint32_t*)(cpu->esi) = 0u;
    ...
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[2u]; cpu->fpu[2u] = temporary; }
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D2F0u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D2F0u));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (((double)*(float*)(cpu->esp + 0x24u)));
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ebp;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D31Au)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D31Au));
    cpu->ecx = (uint32_t)(cpu->eax + 0x4E20u);
    cpu->eax = 0x2AAAAAABu;
    lift_multiply_accumulator(cpu, cpu->ecx, 32u, 1u);
    cpu->edx = (uint32_t)((int32_t)(cpu->edx) >> 1u);
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->edx;
    ...
    cpu->edx <<= 4u;
    cpu->eax += cpu->edx;
    cpu->ecx = *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_landscape_patch_lookup_runtime.patch_records[0]));
    ...
    { uint64_t l=(uint64_t)(*(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->ebp) * 4u) + 0x8Cu)), r=(uint64_t)(0u), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->ecx;
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->ebp;
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->eax;
    *(uint32_t*)(cpu->ecx + ((uint32_t)(cpu->ebp) * 4u) + 0x53Cu) = 0x3E8u;
    ...
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[3u] = (cpu->fpu[3u]) + (cpu->fpu[0u]);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[3u]; cpu->fpu[3u] = temporary; }
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D3D8u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D3D8u));
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x24u));
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->eax;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x14u);
    cpu->eax = (int64_t)(int32_t)(cpu->eax) * (int64_t)(int32_t)(0x64u);
    ...
    *(float*)(cpu->esp + 0x24u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[1u] = cpu->fpu[1u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[1u] = cpu->fpu[1u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D402u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D402u));
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = 5u;
    ...
    { uint64_t l=(uint64_t)(cpu->eax), r=(uint64_t)(cpu->edx), c=(uint64_t)(0u), v=l + r + c; lift_flags_add(cpu,l,r,c,v,32u); cpu->eax = v; }
    cpu->edx = *(uint32_t*)(cpu->esp + 0x28u);
    cpu->edx = *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->ebp) * 4u) + 0x3ACu);
    cpu->eax = *(uint16_t*)(cpu->edx + ((uint32_t)(cpu->eax) * 2u) + 0x20u);
    cpu->edx = cpu->eax;
    cpu->edx >>= 11u;
    ...
    *(uint32_t*)(cpu->esi) = cpu->eax;
    ...
    cpu->edx = *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_color_expansion_runtime.five_bit_to_eight_bit[0]));
    *(uint32_t*)(cpu->ebx) = cpu->edx;
    cpu->eax = *(uint32_t*)(cpu->edi);
    cpu->edx = *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_color_expansion_runtime.five_bit_to_eight_bit[0]));
    *(uint32_t*)(cpu->edi) = cpu->edx;
    ...
    *(uint32_t*)(cpu->esi) = cpu->edx;
    ...
    { uint64_t l=(uint64_t)(cpu->eax), r=(uint64_t)(cpu->edx), c=(uint64_t)(0u), v=l + r + c; lift_flags_add(cpu,l,r,c,v,32u); cpu->eax = v; }
    cpu->edx = *(uint32_t*)(cpu->esp + 0x28u);
    cpu->ebp = *(uint32_t*)(cpu->edx + ((uint32_t)(cpu->ebp) * 4u) + 0x3ACu);
    cpu->eax = *(uint16_t*)(cpu->ebp + ((uint32_t)(cpu->eax) * 2u) + 0x20u);
    cpu->ebp = cpu->eax;
    cpu->ebp = (uint32_t)((uint32_t)(cpu->ebp) >> 11u);
    ...
    *(uint32_t*)(cpu->esi) = cpu->eax;
    cpu->eax = *(uint32_t*)(cpu->ebx);
    cpu->eax = *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_color_expansion_runtime.five_bit_to_eight_bit[0]));
    *(uint32_t*)(cpu->ebx) = cpu->eax;
    cpu->eax = *(uint32_t*)(cpu->edi);
    cpu->eax = *(uint32_t*)(((uint32_t)(cpu->eax) * 4u) + ((uint32_t)(uintptr_t)&g_sfera_color_expansion_runtime.five_bit_to_eight_bit[0]));
    *(uint32_t*)(cpu->edi) = cpu->eax;
...
LIFT_ENTRY void LIFT_CDECL sfera_sub_0046D6A0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) + (1000.0);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D6E2u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D6E2u));
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) / (100.0);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (1000.0);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D71Fu)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D71Fu));
    ...
    *(uint32_t*)(cpu->esp + 0x2Cu) = cpu->esi;
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) / (100.0);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (1000.0);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D760u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D760u));
    ...
    *(uint32_t*)(cpu->esp + 0x28u) = cpu->ebx;
    ...
    cpu->fpu[0u] = (cpu->fpu[0u]) / (100.0);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (1000.0);
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x46D7A0u)); sfera_sub_004EE940(cpu, LIFT_CODE_TOKEN_VA(0x46D7A0u));
    cpu->eax -= 0x3E8u;
    cpu->ebp = cpu->edi;
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->eax;
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->ebp;
    ...
    *(float*)((uint32_t)(uintptr_t)&g_sfera_view_spatial_runtime.world_anchor.z) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    if (*(uint32_t*)(cpu->esi + ((uint32_t)(cpu->ebx) * 4u) + 0x8Cu) != (uint32_t)(0u)) goto label_0006D84F;
    lift_push32(cpu, cpu->eax);
    cpu->ecx = cpu->esi;
