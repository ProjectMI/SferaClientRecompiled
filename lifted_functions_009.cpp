...
__declspec(noinline) void sfera_sub_00457E80(LiftCpu* cpu, uint32_t stop_address) {
    ...
    g_sfera_recovered_static_runtime.ui_cell_width = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    label_00057F01:
    g_sfera_main_ui_state_runtime.scene_factor = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)(((int32_t)(g_sfera_graphics_runtime.display_width))));
    ...
    g_sfera_static_render_lookup_runtime.projection_scale = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)(((int32_t)(g_sfera_graphics_runtime.display_height))));
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[1u]);
    g_sfera_main_view_state_runtime.projection_scale = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 0.10000000149011612);
    lift_x87_push(cpu, 0.0);
    if (cpu->eax != 0u) goto label_00058919;
    ...
    *(float*)(cpu->esp + 0x20u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_geometry_runtime.reference_points[0].x)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)(cpu->esp + 0xF8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x1Cu));
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_geometry_runtime.reference_points[0].y)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)(cpu->esp + 0xFCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x20u));
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_geometry_runtime.reference_points[0].z)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)(cpu->esp + 0x100u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xF8u));
    ...
    *(float*)(cpu->esp + 0x24u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[4].f32));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[1u]);
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[4].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x12Cu));
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->esp + 0x120u)));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (((double)*(float*)(cpu->esp + 0x24u)));
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[3].f32));
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[1u]);
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[3].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)g_sfera_main_input_state_runtime.camera_step);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[2u]);
    g_sfera_main_input_state_runtime.camera_step = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)g_sfera_recovered_static_runtime.cursor_accumulator);
    cpu->fpu[0u] = (cpu->fpu[0u]) + (cpu->fpu[1u]);
    g_sfera_recovered_static_runtime.cursor_accumulator = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)(((int32_t)(g_sfera_graphics_runtime.display_width))));
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, cpu->fpu[1u]);
    ...
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x10u)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[3u] = cpu->fpu[3u] / cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[2].f32));
    cpu->fpu[3u] = cpu->fpu[3u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[2u]; cpu->fpu[2u] = temporary; }
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[2].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, cpu->fpu[2u]);
    cpu->fpu[1u] = cpu->fpu[1u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[1].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x3Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[0].f32));
    ...
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->fpu[5u] = cpu->fpu[5u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[4u]; cpu->fpu[4u] = temporary; }
    g_sfera_static_render_lookup_runtime.view_phase = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_render_sample_runtime.phase.f32));
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[3u]; cpu->fpu[3u] = temporary; }
    cpu->fpu[2u] = cpu->fpu[2u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[3u] = cpu->fpu[3u] * cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[2u] = cpu->fpu[2u] + cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[0u] = (cpu->fpu[0u]) - (((double)*(float*)(cpu->esp + 0x10u)));
    *(float*)((uintptr_t)&g_sfera_render_sample_runtime.phase.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[0].f32));
    ...
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[0].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 0.0);
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[4].f32));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    lift_x87_push(cpu, (double)g_sfera_recovered_static_runtime.ui_cell_width);
    ...
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[4].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[2u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (1u)) == 0u) goto label_000585F1;
    cpu->fpu[2u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00058610:
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[3].f32));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[3u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    lift_x87_push(cpu, (double)g_sfera_main_ui_state_runtime.scene_factor);
    { uint64_t l=((cpu->eax >> 8u) & 0xFFu), r=5u, v=l & r; lift_flags_logic(cpu,v,8u); }
    ...
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[3].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[2u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (1u)) == 0u) goto label_00058651;
    cpu->fpu[2u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00058670:
    ...
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[2].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (1u)) == 0u) goto label_000586AF;
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_000586CC:
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[1].f32));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[4u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    ...
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[1].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[2u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (1u)) == 0u) goto label_00058713;
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00058732:
    lift_x87_push(cpu, (double)g_sfera_static_render_lookup_runtime.view_phase);
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (((((cpu->eax >> 8u) & 0xFFu)) & (1u)) == 0u) goto label_0005876D;
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_0005878E:
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_render_sample_runtime.phase.f32));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[6u]);
    ...
    *(float*)((uintptr_t)&g_sfera_render_sample_runtime.phase.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (((((cpu->eax >> 8u) & 0xFFu)) & (1u)) == 0u) goto label_000587BF;
    label_000587DA:
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[0].f32));
    ...
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[0].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (1u)) == 0u) goto label_0005881B;
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_00058838:
    ...
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[1].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x5887Eu), LIFT_CODE_TOKEN_RVA(0x5887Cu))) { return; }
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x10u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) / (32767.0);
    g_sfera_static_render_lookup_runtime.view_phase = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x58894u), LIFT_CODE_TOKEN_RVA(0x58892u))) { return; }
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x10u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) / (32767.0);
    *(float*)((uintptr_t)&g_sfera_render_sample_runtime.phase.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x588AAu), LIFT_CODE_TOKEN_RVA(0x588A8u))) { return; }
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    lift_x87_push(cpu, (double)(((int32_t)(*(uint32_t*)(cpu->esp + 0x10u)))));
    cpu->fpu[0u] = (cpu->fpu[0u]) / (32767.0);
    *(float*)((uintptr_t)&g_sfera_view_motion_runtime.motion_terms[0].f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->ebx;
    ...
    { uint64_t l=cpu->esi, r=(uint64_t)(sfera_screen_vertex_address(g_sfera_sky_screen_vertices, 0u, &SferaScreenVertex::rhw)), c=0u, v=l + r + c; lift_flags_add(cpu,l,r,c,v,32u); cpu->esi = v; }
    lift_x87_push(cpu, cpu->fpu[0u]);
    ...
    *(uint32_t*)(cpu->eax + 8u) = cpu->edx;
    ...
    lift_x87_push(cpu, (double)g_sfera_main_ui_state_runtime.scene_scale);
    cpu->eax = g_sfera_recovered_static_runtime.render_state_09;
    *(float*)((cpu->edi * 4u) + ((uintptr_t)&g_sfera_main_view_state_runtime.projection_samples[0])) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)g_sfera_main_command_state_runtime.sky_blend_factor);
    *(uint32_t*)(cpu->esi + 8u) = cpu->eax;
    cpu->eax = g_sfera_render_lookup_runtime.alpha_component;
    *(float*)((cpu->edi * 4u) + ((uintptr_t)&g_sfera_static_render_lookup_runtime.command_samples[0])) = cpu->fpu[0u];
    ...
    *(uint32_t*)(cpu->esi + 4u) = cpu->eax;
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_00058D19;
    cpu->eax = 1u;
    goto label_00058D1B;
    label_00058D19:
    cpu->eax = 0u;
    label_00058D1B:
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_scene_control_runtime.environment_parameter.f32));
    ++cpu->ebx;
    *(float*)((cpu->edi * 4u) + ((uintptr_t)&g_sfera_render_sample_runtime.samples[0])) = cpu->fpu[0u]; lift_x87_pop(cpu);
...
__declspec(noinline) void sfera_sub_00458E80(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->edx + (cpu->ebp * 4u)) = 0u;
    ...
    cpu->ecx = 7u;
    cpu->esi = (uintptr_t)"delete_window: wrong handle";
    lift_movs32(cpu, 1u);
...
__declspec(noinline) void sfera_sub_00459150(LiftCpu* cpu, uint32_t stop_address) {
    lift_push32(cpu, cpu->ebx);
    cpu->ebx = cpu->ecx;
    lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->edi);
    ...
    *(uint32_t*)(cpu->ecx + (cpu->ebx * 4u)) = 0u;
    ...
    cpu->ecx = 6u;
    cpu->esi = (uintptr_t)"DeleteObject: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs16(cpu, 0u);
    lift_movs8(cpu, 0u);
    cpu->edi = lift_pop32(cpu); cpu->esi = lift_pop32(cpu); cpu->ebx = lift_pop32(cpu);
...
__declspec(noinline) void sfera_sub_00459420(LiftCpu* cpu, uint32_t stop_address) {
...
__declspec(noinline) void sfera_sub_004595F0(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x90u;
    lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->edi);
    cpu->edi = 0u;
    ...
    lift_push32(cpu, cpu->edi);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59619u), LIFT_CODE_TOKEN_RVA(0x59617u))) { return; }
    lift_push32(cpu, 1u);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x5961Du), LIFT_CODE_TOKEN_RVA(0x5961Bu))) { return; }
    if ((int32_t)cpu->eax >= 0) goto label_00059629;
    label_00059621:
    lift_push32(cpu, 1u);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59625u), LIFT_CODE_TOKEN_RVA(0x59623u))) { return; }
    ...
    lift_push32(cpu, cpu->ebx);
    if (!lift_call_indirect(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x59882u), LIFT_CODE_TOKEN_RVA(0x59880u))) { return; }
    label_00059882:
    ...
    *(uint32_t*)(cpu->esp + 0xCu) = cpu->ecx;
    ...
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x598FCu), LIFT_CODE_TOKEN_RVA(0x598FAu))) { return; }
    lift_push32(cpu, cpu->edi);
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x598FFu), LIFT_CODE_TOKEN_RVA(0x598FDu))) { return; }
    lift_push32(cpu, cpu->edi);
    ...
    *(uint32_t*)(cpu->esi) = 1u;
    ...
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x59955u), LIFT_CODE_TOKEN_RVA(0x59953u))) { return; }
    lift_push32(cpu, cpu->edi);
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x59958u), LIFT_CODE_TOKEN_RVA(0x59956u))) { return; }
    lift_push32(cpu, cpu->edi);
    ...
    *(uint32_t*)(cpu->esi) = 1u;
    ...
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x5997Fu), LIFT_CODE_TOKEN_RVA(0x5997Du))) { return; }
    lift_push32(cpu, cpu->edi);
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x59982u), LIFT_CODE_TOKEN_RVA(0x59980u))) { return; }
    lift_push32(cpu, cpu->edi);
    ...
    *(uint32_t*)(cpu->esi) = 1u;
    ...
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x599B7u), LIFT_CODE_TOKEN_RVA(0x599B5u))) { return; }
    lift_push32(cpu, cpu->edi);
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x599BAu), LIFT_CODE_TOKEN_RVA(0x599B8u))) { return; }
    lift_push32(cpu, cpu->edi);
    ...
    *(uint32_t*)(cpu->esi) = 1u;
    ...
    lift_push32(cpu, cpu->edi); lift_push32(cpu, (uintptr_t)"\n\n");
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x599E1u), LIFT_CODE_TOKEN_RVA(0x599DFu))) { return; }
    lift_push32(cpu, cpu->edi);
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x599E4u), LIFT_CODE_TOKEN_RVA(0x599E2u))) { return; }
    lift_push32(cpu, cpu->edi);
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ecx;
    ...
    cpu->ebp = lift_pop32(cpu);
    label_00059A6F:
    { uint64_t l=((uint8_t)g_sfera_process_runtime.executable_path[0]), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    cpu->ebx = lift_pop32(cpu);
    ...
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59AA9u), LIFT_CODE_TOKEN_RVA(0x59AA7u))) { return; }
    lift_push32(cpu, (uintptr_t)&g_sfera_window_runtime.timing_critical_section[0]);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59AB0u), LIFT_CODE_TOKEN_RVA(0x59AAEu))) { return; }
    lift_push32(cpu, (uintptr_t)&g_sfera_recovered_static_runtime.scene_lock[0]);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59AB7u), LIFT_CODE_TOKEN_RVA(0x59AB5u))) { return; }
...
__declspec(noinline) void sfera_sub_00459B10(LiftCpu* cpu, uint32_t stop_address) {
    (void)stop_address;
    { uint64_t l=(uint64_t)(g_sfera_view_motion_runtime.initialized), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    lift_push32(cpu, cpu->esi);
    cpu->esi = cpu->ecx;
    if ((cpu->eflags & LIFT_FLAG_ZF) != 0u) goto label_00059B58;
    cpu->esi = native_function_address32(&::ShowCursor);
    lift_push32(cpu, 0u);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59B26u), LIFT_CODE_TOKEN_RVA(0x59B24u))) { return; }
    lift_push32(cpu, 1u);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59B2Au), LIFT_CODE_TOKEN_RVA(0x59B28u))) { return; }
    if ((int32_t)cpu->eax >= 0) goto label_00059B38;
    label_00059B30:
    lift_push32(cpu, 1u);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59B34u), LIFT_CODE_TOKEN_RVA(0x59B32u))) { return; }
    ...
    *(uint16_t*)(cpu->edi) = cpu->edx & 0xFFFFu;
    ...
    if (!lift_call_indirect(cpu, cpu->edi, LIFT_CODE_TOKEN_RVA(0x59C23u), LIFT_CODE_TOKEN_RVA(0x59C21u))) { return; }
    lift_push32(cpu, cpu->esi);
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x59C26u), LIFT_CODE_TOKEN_RVA(0x59C24u))) { return; }
    lift_push32(cpu, cpu->esi);
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x59C29u), LIFT_CODE_TOKEN_RVA(0x59C27u))) { return; }
    cpu->esp += 0x10u;
    ...
    if (!lift_call_indirect(cpu, cpu->edi, LIFT_CODE_TOKEN_RVA(0x59C4Bu), LIFT_CODE_TOKEN_RVA(0x59C49u))) { return; }
    lift_push32(cpu, cpu->esi);
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x59C4Eu), LIFT_CODE_TOKEN_RVA(0x59C4Cu))) { return; }
    lift_push32(cpu, cpu->esi);
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x59C51u), LIFT_CODE_TOKEN_RVA(0x59C4Fu))) { return; }
    cpu->esp += 0x10u;
    g_sfera_log_runtime.files[0].has_written = 1u;
    label_00059C5E:
    cpu->esi = native_function_address32(&::ShowCursor);
    lift_push32(cpu, 0u);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59C68u), LIFT_CODE_TOKEN_RVA(0x59C66u))) { return; }
    lift_push32(cpu, 1u);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59C6Cu), LIFT_CODE_TOKEN_RVA(0x59C6Au))) { return; }
    cpu->edi = lift_pop32(cpu); cpu->ebp = lift_pop32(cpu); cpu->ebx = lift_pop32(cpu);
    if ((int32_t)cpu->eax >= 0) goto label_00059C7B;
    label_00059C73:
    lift_push32(cpu, 1u);
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59C77u), LIFT_CODE_TOKEN_RVA(0x59C75u))) { return; }
...
__declspec(noinline) void sfera_sub_00459E40(LiftCpu* cpu, uint32_t stop_address) {
    ...
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59E5Cu), LIFT_CODE_TOKEN_RVA(0x59E5Au))) { return; }
    lift_push32(cpu, 1u);
    g_sfera_scene_control_runtime.timing_anchor = cpu->eax;
    if (!lift_call_indirect(cpu, cpu->esi, LIFT_CODE_TOKEN_RVA(0x59E65u), LIFT_CODE_TOKEN_RVA(0x59E63u))) { return; }
...
__declspec(noinline) void sfera_sub_00459FA0(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0xB4u;
    ...
    *(uint8_t*)(cpu->esi) = cpu->edx & 0xFFu;
    ++cpu->esi;
    { uint64_t l=(cpu->ecx & 0xFFu), v=l - 1u; uint32_t cf=cpu->eflags & LIFT_FLAG_CF; lift_flags_sub(cpu,l,1u,0u,v,8u); cpu->eflags=(cpu->eflags & ~LIFT_FLAG_CF) | cf; cpu->ecx = (cpu->ecx & 0xFFFFFF00u) | ((uint32_t)((v)) & 0xFFu); }
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->esi;
    ...
    label_0005A229:
    if (*(uint8_t*)(cpu->ecx) == 0x23u) goto label_0005A235;
    label_0005A22E:
    ++cpu->eax;
    if (*(uint8_t*)(cpu->eax + cpu->ebp) != 0x23u) goto label_0005A22E;
    label_0005A235:
    { uint64_t l=*(uint8_t*)(cpu->eax + cpu->ebp + 0xFFFFFFFFu), r=0x20u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    if (*(uint8_t*)(cpu->ecx + cpu->ebp) == 0x20u) goto label_0005A23F;
    label_0005A24C:
    ...
    cpu->edi -= 0x30u;
    cpu->ebx -= 0x41u;
    { uint64_t l=*(uint8_t*)(cpu->eax + cpu->ebp), r=0x20u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    *(uint32_t*)(cpu->esp + 0x50u) = cpu->eax;
    ...
    if ((cpu->ecx & 0xFFu) == 0x20u) goto label_0005A28E;
    label_0005A2A4:
    { uint64_t l=*(uint8_t*)(cpu->eax + cpu->ebp), r=0x27u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    *(uint8_t*)(cpu->esi) = cpu->ecx & 0xFFu;
    if (*(uint8_t*)(cpu->eax) == 0u) goto label_0005A3D9;
    cpu->esi = 0u;
    if ((int32_t)cpu->ebx < 0) goto label_0005A3D9;
    label_0005A38F:
    cpu->eax = 0u;
    label_0005A391:
    if (cpu->ebx == 1u) goto label_0005A3BA;
    cpu->ecx = cpu->ebx;
    cpu->ecx = 0u - (uint64_t)(cpu->ecx);
    if (cpu->eax != cpu->ecx) goto label_0005A3A2;
    if (cpu->esi == cpu->ecx) goto label_0005A3C4;
    label_0005A3A2:
    if (cpu->eax != cpu->ebx) goto label_0005A3AA;
    if (cpu->esi == cpu->ebx) goto label_0005A3C4;
    label_0005A3AA:
    if (cpu->eax != cpu->ecx) goto label_0005A3B2;
    if (cpu->esi == cpu->ebx) goto label_0005A3C4;
    label_0005A3B2:
    if (cpu->eax != cpu->ebx) goto label_0005A3BA;
    if (cpu->esi == cpu->ecx) goto label_0005A3C4;
    label_0005A3BA:
    ...
    *(uint8_t*)(cpu->ecx + cpu->edi + 3u) = 1u;
    label_0005A3C4:
    ++cpu->eax;
    if ((int32_t)cpu->eax <= (int32_t)cpu->ebx) goto label_0005A391;
    ++cpu->esi;
    cpu->edx += 0x20u;
    if ((int32_t)cpu->esi <= (int32_t)cpu->ebx) goto label_0005A38F;
    ...
    ++cpu->eax;
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->eax;
    if ((int32_t)cpu->ebp < (int32_t)0x1Au) goto label_0005A37C;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x64u);
    cpu->edx += 0x20u;
    cpu->eax += 0x118u;
    *(uint32_t*)(cpu->esp + 0x68u) = cpu->edx;
    *(uint32_t*)(cpu->esp + 0x64u) = cpu->eax;
    if ((int32_t)cpu->edx < (int32_t)0x3A0u) goto label_0005A36C;
    ...
    cpu->ecx += cpu->eax;
    *(uint32_t*)((cpu->ecx * 4u) + ((uintptr_t)&g_sfera_static_render_lookup_runtime.glyph_metrics[0][0])) = cpu->edx;
    label_0005A44B:
    ...
    ++cpu->edx;
    cpu->esi += 0x118u;
    if ((int32_t)cpu->edx < (int32_t)0x1Au) goto label_0005A451;
    goto label_0005A490;
    label_0005A46F:
    cpu->eax = *(uint32_t*)(cpu->esp + 0x20u);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x14u);
    ...
    *(uint32_t*)((cpu->ecx * 4u) + ((uintptr_t)&g_sfera_static_render_lookup_runtime.glyph_metrics[0][0])) = cpu->esi;
    goto label_0005A44B;
    label_0005A486:
    if ((int32_t)cpu->edx >= (int32_t)*(uint32_t*)(cpu->esp + 0x44u)) goto label_0005A490;
    *(uint32_t*)(cpu->esp + 0x44u) = cpu->edx;
    label_0005A490:
    cpu->eax = *(uint32_t*)(cpu->esp + 0x7Cu);
    cpu->esi = 0x19u;
    ...
    goto label_0005A4CD;
    label_0005A4C3:
    if ((int32_t)cpu->esi <= (int32_t)*(uint32_t*)(cpu->esp + 0x3Cu)) goto label_0005A4CD;
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = 8u;
    label_0005A504:
    { uint64_t l=*(uint8_t*)(cpu->ebp + 0xFFFFFFFDu), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    cpu->edx = 0u;
    cpu->esi = 0u;
    { uint64_t l=*(uint8_t*)(cpu->ebx + 0xFFFFFFFFu), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    label_0005A52A:
    cpu->eax <<= 4u;
    { uint64_t l=cpu->eax, r=cpu->esi, v=l | r; lift_flags_logic(cpu,v,32u); cpu->eax = v; }
    cpu->eax <<= 4u;
    ...
    *(uint16_t*)(cpu->edi + 0xFFFFFFFEu) = cpu->eax & 0xFFFFu;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x58u);
    { uint64_t l=*(uint8_t*)(cpu->eax + cpu->ebx), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    cpu->edx = 0u;
    cpu->esi = 0u;
    { uint64_t l=*(uint8_t*)(cpu->ebx), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    *(uint16_t*)(cpu->edi) = cpu->eax & 0xFFFFu;
    { uint64_t l=*(uint8_t*)(cpu->ebp + 0xFFFFFFFFu), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    cpu->edx = 0u;
    cpu->esi = 0u;
    { uint64_t l=*(uint8_t*)(cpu->ebx + 1u), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    *(uint16_t*)(cpu->edi + 2u) = cpu->eax & 0xFFFFu;
    { uint64_t l=*(uint8_t*)(cpu->ebp), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    cpu->edx = 0u;
    cpu->esi = 0u;
    { uint64_t l=*(uint8_t*)(cpu->ebx + 2u), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = (uint64_t)(*(uint32_t*)(cpu->esp + 0x10u)) + (uint64_t)(0x200u) + (uint64_t)(0u);
    ...
    cpu->ecx -= cpu->edx;
    { uint64_t l=cpu->ecx, r=3u, c=0u, v=l + r + c; lift_flags_add(cpu,l,r,c,v,32u); cpu->ecx = v; }
    ...
    *(uint32_t*)(cpu->esp + 0x30u) = cpu->ecx;
    ++cpu->esi;
    *(float*)(cpu->eax + ((uintptr_t)&g_sfera_font_runtime.glyphs[0].u)) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x40u) = cpu->esi;
    cpu->fpu[0u] = (cpu->fpu[0u]) * (cpu->fpu[1u]);
    *(float*)(cpu->eax + ((uintptr_t)&g_sfera_font_runtime.glyphs[0].v)) = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (cpu->esi != 8u) goto label_0005A746;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x34u);
    ++cpu->eax;
    cpu->esi = 0u;
    *(uint32_t*)(cpu->esp + 0x40u) = cpu->esi;
    *(uint32_t*)(cpu->esp + 0x34u) = cpu->eax;
    if (cpu->eax != 8u) goto label_0005A746;
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x14u);
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x54u) = cpu->ebx;
    ...
    if (!lift_call_indirect(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x5A6E1u), LIFT_CODE_TOKEN_RVA(0x5A6DFu))) { return; }
    ...
    if (!lift_call_indirect(cpu, cpu->ecx, LIFT_CODE_TOKEN_RVA(0x5A734u), LIFT_CODE_TOKEN_RVA(0x5A732u))) { return; }
    lift_x87_push(cpu, 0.00390625);
    ...
    *(uint32_t*)(cpu->esp + 0x50u) = cpu->esi;
    ...
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x4Cu);
    if (!lift_call_indirect(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x5A7BFu), LIFT_CODE_TOKEN_RVA(0x5A7BDu))) { return; }
    { uint64_t l=g_sfera_font_atlas_staging_runtime.height, r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    cpu->esi = *(uint32_t*)(cpu->esp + 0x70u);
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->ecx;
    ...
    if (!lift_call_indirect(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x5A820u), LIFT_CODE_TOKEN_RVA(0x5A81Eu))) { return; }
    ++cpu->edi;
    label_0005A821:
...
__declspec(noinline) void sfera_sub_0045A8E0(LiftCpu* cpu, uint32_t stop_address) {
    lift_push32(cpu, cpu->ecx);
...
__declspec(noinline) void sfera_sub_0045A9C0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->edi);
    cpu->esi = cpu->eax;
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x5AA0Eu), LIFT_CODE_TOKEN_RVA(0x5AA0Cu))) { return; }
    ...
    lift_push32(cpu, cpu->esi);
    cpu->edi = cpu->eax;
    if (!lift_call_indirect(cpu, cpu->ebx, LIFT_CODE_TOKEN_RVA(0x5AA31u), LIFT_CODE_TOKEN_RVA(0x5AA2Fu))) { return; }
...
__declspec(noinline) void sfera_sub_0045AA50(LiftCpu* cpu, uint32_t stop_address) {
    ...
    if (!lift_call_indirect(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x5AAA1u), LIFT_CODE_TOKEN_RVA(0x5AA9Fu))) { return; }
    ...
    if (!lift_call_indirect(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x5AAC8u), LIFT_CODE_TOKEN_RVA(0x5AAC6u))) { return; }
    ...
    if (!lift_call_indirect(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x5AAECu), LIFT_CODE_TOKEN_RVA(0x5AAEAu))) { return; }
    ...
    lift_push32(cpu, 6u); lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x34u);
    if (!lift_call_indirect(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x5AB10u), LIFT_CODE_TOKEN_RVA(0x5AB0Eu))) { return; }
    ...
    if (!lift_call_indirect(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x5AB30u), LIFT_CODE_TOKEN_RVA(0x5AB2Eu))) { return; }
    ...
    if (!lift_call_indirect(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x5AB50u), LIFT_CODE_TOKEN_RVA(0x5AB4Eu))) { return; }
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = 8u;
    ...
    if (!lift_call_indirect(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x5AB99u), LIFT_CODE_TOKEN_RVA(0x5AB97u))) { return; }
    ...
    lift_push32(cpu, cpu->eax);
    if (!lift_call_indirect(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x5ABB4u), LIFT_CODE_TOKEN_RVA(0x5ABB2u))) { return; }
    cpu->eax = g_sfera_direct_input_runtime.mouse_device;
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = *(uint32_t*)(cpu->ecx + 0x1Cu);
    lift_push32(cpu, cpu->eax);
    if (!lift_call_indirect(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x5ABC1u), LIFT_CODE_TOKEN_RVA(0x5ABBFu))) { return; }
    cpu->esp += 0x18u;
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0045ACF0(LiftCpu* cpu, uint32_t stop_address) {
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->edi);
    cpu->ebx = cpu->edx;
    cpu->edi = cpu->ecx;
    cpu->esi = 0u;
...
__declspec(noinline) void sfera_sub_0045AE50(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x4B8u;
    lift_push32(cpu, cpu->ebx);
...
__declspec(noinline) void sfera_sub_0045AFB0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->edx;
    ...
    cpu->ecx -= cpu->ebx;
    cpu->edi += cpu->ecx;
    { uint64_t l=cpu->edi, r=0x2710u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
...
__declspec(noinline) void sfera_sub_0045B370(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ebx;
    ...
    cpu->edi = 0u;
    label_0005B540:
    { uint64_t l=cpu->esi, r=g_sfera_recovered_static_runtime.font_renderer_state, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
...
__declspec(noinline) void sfera_sub_0045B620(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x60u) = 4u;
    ...
    lift_push32(cpu, cpu->ecx);
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x5B6EDu), LIFT_CODE_TOKEN_RVA(0x5B6EBu))) { return; }
    cpu->esp += 0xCu;
    ...
    *(uint32_t*)(cpu->esp + 0x98u) = 1u;
    ...
    lift_push32(cpu, cpu->eax);
    if (!lift_call_indirect(cpu, cpu->ebp, LIFT_CODE_TOKEN_RVA(0x5B7ABu), LIFT_CODE_TOKEN_RVA(0x5B7A9u))) { return; }
    cpu->esp += 0xCu;
    ...
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) == 0u) goto label_0005BAED;
...
__declspec(noinline) void sfera_sub_0045BC60(LiftCpu* cpu, uint32_t stop_address) {
    lift_push32(cpu, 0xFFFFFFFFu); lift_push32(cpu, 0u);
    cpu->eax = 0u;
    ...
    g_sfera_main_view_state_runtime.view_coefficients[5] = cpu->fpu[0u];
    cpu->ecx = *(uint32_t*)(((uintptr_t)"cursor1") + 4u);
    g_sfera_main_view_state_runtime.view_coefficients[4] = cpu->fpu[0u];
    g_sfera_main_view_state_runtime.view_coefficients[3] = cpu->fpu[0u];
    cpu->edi |= 0xFFFFFFFFu;
    g_sfera_main_view_state_runtime.view_coefficients[2] = cpu->fpu[0u];
    (*(uint32_t*)(void*)&g_sfera_main_command_state_runtime.default_cursor_token[0]) = cpu->eax;
    g_sfera_main_view_state_runtime.view_coefficients[1] = cpu->fpu[0u];
    g_sfera_world_objects.controlled_object_handle = cpu->edi;
    g_sfera_main_view_state_runtime.view_coefficients[0] = cpu->fpu[0u];
    g_sfera_recovered_static_runtime.interaction_enabled = cpu->esi;
    *(float*)((uintptr_t)&g_sfera_landscape_patch_lookup_runtime.primary_vector.z.f32) = cpu->fpu[0u];
    (*(uint32_t*)(void*)&g_sfera_main_command_state_runtime.render_channel_mask) = 0xFFu;
    *(float*)((uintptr_t)&g_sfera_landscape_patch_lookup_runtime.primary_vector.y.f32) = cpu->fpu[0u];
    g_sfera_main_command_state_runtime.default_cursor_token[1] = cpu->ecx;
    *(float*)((uintptr_t)&g_sfera_landscape_patch_lookup_runtime.primary_vector.x.f32) = cpu->fpu[0u];
    g_sfera_window_runtime.active_window_index = cpu->edi;
    *(float*)((uintptr_t)&g_sfera_scene_vector_runtime.render_scale.x.f32) = cpu->fpu[0u];
    g_sfera_texture_cache_runtime.render_gate = cpu->esi;
    lift_x87_push(cpu, 1.0);
    (*(uint32_t*)(void*)&g_sfera_main_ui_state_runtime.ui_state_02) = cpu->esi;
    *(float*)((uintptr_t)&g_sfera_scene_vector_runtime.render_scale.y.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->eax = (uintptr_t)&g_sfera_texture_cache_runtime.entries[0].use_count;
    *(float*)((uintptr_t)&g_sfera_scene_vector_runtime.render_scale.z.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)0.05999999865889549f);
    g_sfera_graphics_runtime.base_render_factor = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)9.999999747378752e-05f);
    *(float*)((uintptr_t)((uint8_t *)&g_sfera_static_render_lookup_runtime.atlas_resources[0][0] + 0xF4u)) = cpu->fpu[0u]; lift_x87_pop(cpu);
    label_0005BD96:
...
__declspec(noinline) void sfera_sub_0045BE50(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x2Cu) = cpu->ebx;
    ...
    cpu->ecx += 0x10u;
    ++cpu->edx;
    { uint64_t l=cpu->ecx, r=((uintptr_t)&g_sfera_texture_cache_runtime.entries[kTextureCacheEntryCount] + offsetof(SferaTextureCacheEntry, kind)), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    cpu->ecx += 0x10u;
    ++cpu->esi;
    { uint64_t l=cpu->ecx, r=0x320u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->eax;
    ...
    { uint64_t l=cpu->eax, r=cpu->eax, c=0u, v=l + r + c; lift_flags_add(cpu,l,r,c,v,32u); cpu->eax = v; }
    cpu->esi <<= 8u;
    cpu->eax += cpu->eax;
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->ecx;
    ...
    if (!lift_call_indirect(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x5C184u), LIFT_CODE_TOKEN_RVA(0x5C182u))) { return; }
    cpu->eax = *(uint32_t*)(cpu->ebp + ((uintptr_t)&g_sfera_texture_cache_runtime.entries[0].resource));
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = cpu->esp + 0x3Cu;
    lift_push32(cpu, cpu->edx); lift_push32(cpu, 0u); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x44u);
    if (!lift_call_indirect(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x5C199u), LIFT_CODE_TOKEN_RVA(0x5C197u))) { return; }
    cpu->edx = *(uint32_t*)(cpu->esp + 0x38u);
    ...
    if (!lift_call_indirect(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x5C1F7u), LIFT_CODE_TOKEN_RVA(0x5C1F5u))) { return; }
...
__declspec(noinline) void sfera_sub_0045C230(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0xB8u;
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_0005C277;
    ...
    *(float*)(cpu->esp + 0xB4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_geometry_runtime.reference_points[2].y)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)(cpu->esp + 0xB8u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_view_geometry_runtime.reference_points[2].z)); lift_x87_push(cpu, cpu->fpu[0u]);
    cpu->fpu[2u] = cpu->fpu[2u] - cpu->fpu[0u]; lift_x87_pop(cpu);
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    ...
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    *(float*)((uintptr_t)&g_sfera_scene_render_runtime.textured_quad[1].x) = cpu->fpu[0u];
    { double temporary = cpu->fpu[0u]; cpu->fpu[0u] = cpu->fpu[1u]; cpu->fpu[1u] = temporary; }
    *(float*)((uintptr_t)&g_sfera_scene_render_runtime.textured_quad[1].y) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, 1.0);
    ...
    *(float*)(cpu->esp + 0xCu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0xCu));
    *(float*)((uintptr_t)&g_sfera_scene_render_runtime.textured_quad[2].y) = cpu->fpu[0u];
    ...
    *(float*)((uintptr_t)&g_sfera_scene_render_runtime.textured_quad[3].u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)((uintptr_t)&g_sfera_scene_render_runtime.textured_quad[0].x));
    *(float*)(cpu->esp + 0x28u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x28u));
    *(float*)(cpu->esp + 0x38u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esi + 4u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_0005C74D;
    ...
    *(float*)(cpu->esp + 0x28u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_0005C777;
    *(float*)(cpu->esp + 0x24u) = cpu->fpu[0u];
    label_0005C777:
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x20u));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]); lift_x87_pop(cpu); lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    ...
    *(float*)(cpu->esi + 0xFFFFFFECu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_push(cpu, (double)(((int32_t)(g_sfera_graphics_runtime.display_width))));
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]); lift_x87_pop(cpu); lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_0005CB13;
...
__declspec(noinline) void sfera_sub_0045CC30(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->ecx = 6u;
    cpu->esi = (uintptr_t)"GetProcess: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs8(cpu, 0u);
...
__declspec(noinline) void sfera_sub_0045CD70(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->ecx = 7u;
    cpu->esi = (uintptr_t)"GetSubAnimLen: wrong handle";
    lift_movs32(cpu, 1u);
    label_0005CED9:
...
__declspec(noinline) void sfera_sub_0045CF00(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->ecx = 6u;
    cpu->esi = (uintptr_t)"GetAnimation: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs16(cpu, 0u);
    lift_movs8(cpu, 0u);
...
__declspec(noinline) void sfera_sub_0045D020(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->ecx = 5u;
    cpu->esi = (uintptr_t)"GetFrame: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs16(cpu, 0u);
    lift_movs8(cpu, 0u);
...
__declspec(noinline) void sfera_sub_0045D3C0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->ecx = 7u;
    cpu->esi = (uintptr_t)"GetAnimation2: wrong handle";
    lift_movs32(cpu, 1u);
...
__declspec(noinline) void sfera_sub_0045D4E0(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x418u;
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = 0u;
    ...
    cpu->ecx = 8u;
    cpu->esi = (uintptr_t)"CalcCharacterNeck: wrong animation";
    lift_movs32(cpu, 1u);
    lift_movs16(cpu, 0u);
    lift_movs8(cpu, 0u);
    ...
    *(float*)((uintptr_t)&g_sfera_sky_runtime.horizon_scale.f32) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->ebp;
    ...
    cpu->ecx = 9u;
    cpu->esi = (uintptr_t)"CalcCharacterNeck: wrong animation 2";
    lift_movs32(cpu, 1u);
    lift_movs8(cpu, 0u);
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->ebp;
    ...
    cpu->ecx = 8u;
    cpu->esi = (uintptr_t)"CalcCharacterNeck: wrong frame 2";
    lift_movs32(cpu, 1u);
    lift_movs8(cpu, 0u);
...
__declspec(noinline) void sfera_sub_0045D840(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x38u;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->esi);
    cpu->esi = cpu->ecx;
    ...
    *(float*)(cpu->esp + 0x18u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) == 0u) goto label_0005DA36;
...
__declspec(noinline) void sfera_sub_0045DA60(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x14u;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->esi);
    cpu->esi = cpu->ecx;
    ...
    cpu->eax = g_sfera_world_objects.object_handles.data;
    cpu->esi = *(uint32_t*)(cpu->eax + (cpu->esi * 4u));
    { uint64_t l=*(uint8_t*)(cpu->esi + 0x138u), r=1u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
...
__declspec(noinline) void sfera_sub_0045DCD0(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0xC8u;
    lift_push32(cpu, cpu->esi);
    cpu->esi = cpu->ecx;
    lift_push32(cpu, cpu->edi);
    ...
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->edi;
    ...
    label_0005E180:
    { uint64_t l=*(uint32_t*)(cpu->ebp + (cpu->edi * 4u) + 0x44u), r=0xFFFFFFFFu, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_0005E398;
    ...
    *(float*)(cpu->esp) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    goto label_0005E4AB;
    label_0005E40B:
    { uint64_t l=*(uint32_t*)(cpu->ebx + 0x2Cu), r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(float*)(cpu->esp) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->edi += 4u;
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    { uint64_t l=cpu->eax, r=*(uint32_t*)(cpu->ebx + 0x2Cu), v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(uint32_t*)(cpu->esp + 0x58u) = cpu->eax;
    ...
    cpu->ecx = 6u;
    cpu->esi = (uintptr_t)"draw_window: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs16(cpu, 0u);
...
__declspec(noinline) void sfera_sub_0045E660(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x54u;
    lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->edi);
    cpu->edi = cpu->ecx;
...
__declspec(noinline) void sfera_sub_0045EBE0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->ebx;
    ...
    label_0005EC41:
    { uint64_t l=*(uint32_t*)(cpu->edi + (cpu->ebx * 4u) + 0x44u), r=0xFFFFFFFFu, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    ...
    *(uint32_t*)(cpu->edi + 0x30u) = cpu->eax;
    ...
    cpu->ecx = 0xAu;
    cpu->esi = (uintptr_t)"recalc_virtual_window_size: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs8(cpu, 0u);
    cpu->edi = lift_pop32(cpu); cpu->esi = lift_pop32(cpu); cpu->ebx = lift_pop32(cpu);
    cpu->esp += 8u;
...
__declspec(noinline) void sfera_sub_0045ED20(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x14u;
    lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->edi);
    cpu->edi = cpu->ecx;
...
__declspec(noinline) void sfera_sub_0045F060(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x64u;
    { uint64_t l=g_sfera_client_config_runtime.state_15, r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->ebp); lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->edi);
    cpu->esi = cpu->ecx;
...
__declspec(noinline) void sfera_sub_0045FCA0(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x404u;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->esi);
    cpu->esi = cpu->ecx;
    lift_push32(cpu, cpu->edi);
    ...
    cpu->ecx = 7u;
    cpu->esi = (uintptr_t)"GetHandOrientL: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs8(cpu, 0u);
...
__declspec(noinline) void sfera_sub_0045FE00(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x404u;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->esi);
    cpu->esi = cpu->ecx;
    lift_push32(cpu, cpu->edi);
    ...
    cpu->ecx = 7u;
    cpu->esi = (uintptr_t)"GetHandOrientR: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs8(cpu, 0u);
...
__declspec(noinline) void sfera_sub_0045FF60(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x404u;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->esi);
    cpu->esi = cpu->ecx;
    lift_push32(cpu, cpu->edi);
    ...
    cpu->ecx = 7u;
    cpu->esi = (uintptr_t)"GetSwordOrient: wrong handle";
    lift_movs32(cpu, 1u);
    lift_movs8(cpu, 0u);
...
__declspec(noinline) void sfera_sub_00460D50(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0xA8u;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->ebp); lift_push32(cpu, cpu->esi);
    cpu->edx = 1u;
    lift_push32(cpu, cpu->edi);
...
__declspec(noinline) void sfera_sub_00461170(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->ebx = cpu->ecx;
    cpu->ecx = 7u;
    cpu->esi = (uintptr_t)"wrong format of planting.txt\n";
...
__declspec(noinline) void sfera_sub_00461220(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint16_t*)(cpu->esp + 0x28u) = 0x3030u;
    ...
    cpu->esi += 0x1Cu;
    ++cpu->ebx;
    { uint64_t l=cpu->esi, r=0x460u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
...
__declspec(noinline) void sfera_sub_004617A0(LiftCpu* cpu, uint32_t stop_address) {
    lift_push32(cpu, 0xFFFFFFFFu); lift_push32(cpu, 0u);
    cpu->eax = 0u;
...
__declspec(noinline) void sfera_sub_00461DD0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    if (!lift_call_indirect(cpu, cpu->edi, LIFT_CODE_TOKEN_RVA(0x61EFAu), LIFT_CODE_TOKEN_RVA(0x61EF8u))) { return; }
    cpu->eax = g_sfera_world_objects.controlled_object_handle;
    cpu->esp += 0xCu;
    cpu->esi = cpu->eax;
    ...
    lift_push32(cpu, (uintptr_t)"Try to get extended from superstatic: %s, %s:%d"); lift_push32(cpu, cpu->edx);
    if (!lift_call_indirect(cpu, cpu->edi, LIFT_CODE_TOKEN_RVA(0x61F97u), LIFT_CODE_TOKEN_RVA(0x61F95u))) { return; }
    cpu->esp += 0x14u;
    cpu->ecx = cpu->esp + 0x2Cu;
...
__declspec(noinline) void sfera_sub_00461FD0(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x34u;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x40u);
    lift_push32(cpu, cpu->ebp);
    cpu->ebp = g_sfera_shadow_runtime.manager;
    { uint64_t l=*(uint8_t*)(cpu->ebp + 0xA0u), r=4u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    lift_push32(cpu, cpu->edi);
    *(uint32_t*)(cpu->esp + 0x10u) = cpu->ecx;
    cpu->edi = cpu->edx;
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->eax;
    ...
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_00062103;
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x28u);
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x2Cu);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x30u);
    ...
    *(uint32_t*)(cpu->esp + 0x3Cu) = cpu->eax;
    ...
    { uint64_t l=g_sfera_view_spatial_runtime.alternate_projection, r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,8u); }
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u)); lift_x87_push(cpu, cpu->fpu[0u]);
    lift_x87_push(cpu, 1.0);
    cpu->fpu[1u] = cpu->fpu[0u] / cpu->fpu[1u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 0x10u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (((((cpu->eax >> 8u) & 0xFFu)) & (1u)) != 0u) goto label_000621AB;
    lift_x87_compare(cpu, cpu->fpu[0u], 0.8299999833106995);
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    { uint64_t l=((cpu->eax >> 8u) & 0xFFu), r=0x41u, v=l & r; lift_flags_logic(cpu,v,8u); }
    if ((cpu->eflags & LIFT_FLAG_PF) != 0u) goto label_000621AD;
    lift_x87_push(cpu, (double)*(float*)(cpu->esp + 0x14u));
    lift_x87_push(cpu, (double)g_sfera_graphics_runtime.view_scale);
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_000621AB;
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    goto label_000621AD;
    label_000621AB:
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    lift_x87_compare(cpu, cpu->fpu[0u], cpu->fpu[1u]);
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_000622A0;
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    goto label_000622B7;
    label_000622A0:
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    cpu->fpu[1u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_000622B5;
    *(float*)(cpu->esp + 0x14u) = cpu->fpu[0u]; lift_x87_pop(cpu);
    goto label_000622B7;
    label_000622B5:
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_000622CD;
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
    cpu->esi = 2u;
    goto label_000622DF;
    label_000622CD:
    ...
    lift_x87_pop(cpu); (cpu->eax = (cpu->eax & 0xFFFF0000u) | ((uint32_t)(uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u)) & 0xFFFFu));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_000622DF;
    cpu->esi = 1u;
    label_000622DF:
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x18u);
    ...
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    cpu->eax = (cpu->eax & 0xFFFF0000u) | (((uint16_t)(cpu->fpu_status | ((cpu->fpu_top & 7u) << 11u))));
    if (((((cpu->eax >> 8u) & 0xFFu)) & (0x41u)) != 0u) goto label_0006232F;
    *(float*)(cpu->esp + 0x1Cu) = cpu->fpu[0u]; lift_x87_pop(cpu);
    goto label_00062331;
    label_0006232F:
    cpu->fpu[0u] = cpu->fpu[0u]; lift_x87_pop(cpu);
...
__declspec(noinline) void sfera_sub_00462400(LiftCpu* cpu, uint32_t stop_address) {
    lift_push32(cpu, 0xFFFFFFFFu); lift_push32(cpu, 0u);
    cpu->eax = 0u;
    lift_push32(cpu, cpu->eax);
    cpu->esp -= 4u;
    ...
    cpu->eax = cpu->ecx;
    { uint64_t l=cpu->eax, r=0x10u, c=0u, v=l - r - c; lift_flags_sub(cpu,l,r,c,v,32u); cpu->eax = v; }
    if ((cpu->eflags & LIFT_FLAG_ZF) != 0u) goto label_000624C2;
    { uint64_t l=cpu->eax, v=l - 1u; uint32_t cf=cpu->eflags & LIFT_FLAG_CF; lift_flags_sub(cpu,l,1u,0u,v,32u); cpu->eflags=(cpu->eflags & ~LIFT_FLAG_CF) | cf; cpu->eax = v; }
    if ((cpu->eflags & LIFT_FLAG_ZF) != 0u) goto label_000624A1;
    { uint64_t l=cpu->eax, r=0xBu, c=0u, v=l - r - c; lift_flags_sub(cpu,l,r,c,v,32u); cpu->eax = v; }
    ...
    lift_x87_push(cpu, 0.0);
    g_sfera_client_config_runtime.scalar_01 = cpu->fpu[0u]; lift_x87_pop(cpu);
    ...
    *(uint32_t*)(cpu->esp + 0xCu) = 0xFFFFFFFFu;
    ...
    label_0006254E:
    cpu->eax = cpu->ecx;
    { uint64_t l=cpu->eax, r=0x100u, c=0u, v=l - r - c; lift_flags_sub(cpu,l,r,c,v,32u); cpu->eax = v; }
    if ((cpu->eflags & LIFT_FLAG_ZF) != 0u) goto label_00062619;
    { uint64_t l=cpu->eax, r=2u, c=0u, v=l - r - c; lift_flags_sub(cpu,l,r,c,v,32u); cpu->eax = v; }
    ...
    cpu->eax = cpu->ecx;
    cpu->eax &= 0xFFF0u;
    { uint64_t l=cpu->eax, r=0xF090u, c=0u, v=l - r - c; lift_flags_sub(cpu,l,r,c,v,32u); cpu->eax = v; }
    if ((cpu->eflags & LIFT_FLAG_ZF) != 0u) goto label_00062678;
    { uint64_t l=cpu->eax, r=0x70u, c=0u, v=l - r - c; lift_flags_sub(cpu,l,r,c,v,32u); cpu->eax = v; }
    if ((cpu->eflags & LIFT_FLAG_ZF) != 0u) goto label_00062678;
    cpu->edx = *(uint32_t*)(cpu->esp + 0x20u);
    cpu->eax = *(uint32_t*)(cpu->esp + 0x14u);
    ...
    *(uint32_t*)((cpu->eax * 4u) + ((uintptr_t)&g_sfera_pending_key_runtime.key_codes[0])) = cpu->ecx;
    ...
    cpu->esp += 0x14u; cpu->eip = stop_address; return;
    label_00062619:
    { uint64_t l=g_sfera_client_process_runtime.ui_bridge, r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
    cpu->eax = *(uint32_t*)(cpu->esp + 0x1Cu);
    ...
    cpu->esp += 0x14u; cpu->eip = stop_address; return;
    label_0006263F:
    { uint64_t l=g_sfera_texture_cache_runtime.render_gate, r=0u, v=l-r; lift_flags_sub(cpu,l,r,0u,v,32u); }
...
__declspec(noinline) void sfera_sub_00462740(LiftCpu* cpu, uint32_t stop_address) {
    cpu->esp -= 0x50u;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->ebp); lift_push32(cpu, cpu->esi);
    cpu->esi = cpu->ecx;
    lift_push32(cpu, cpu->edi);
