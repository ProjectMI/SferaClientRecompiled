...
struct SferaTreeDesc32 { SferaCtData32* dynamic_tree; std::int32_t max_code; SferaZlibTreeKind kind; };
struct SferaDeflateState32 {
    ...
    std::int32_t noheader = 0;
    std::uint8_t data_type = 0;
    std::uint8_t method = 8;
    std::int32_t last_flush = 0;
    ...
    std::int32_t block_start = 0;
    std::uint32_t match_length = 0;
    std::uint32_t prev_match = 0;
    std::int32_t match_available = 0;
    ...
    std::int32_t heap_length = 0;
    std::int32_t heap_max = 0;
