...
__declspec(noinline) void sfera_sub_004189B0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    label_000189F1:
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::Sleep)))(*(uint32_t*)(cpu->esp)); cpu->esp += 0x4u;
...
__declspec(noinline) void sfera_sub_00419220(LiftCpu* cpu, uint32_t stop_address) { bool sub_pred[1];
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->eax;
    ...
    lift_push32(cpu, (uintptr_t)&g_sfera_network_send_runtime.critical_section[0]);
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->eax;
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::EnterCriticalSection)))(*(uint32_t*)(cpu->esp)); cpu->esp += 0x4u;
...
__declspec(noinline) void sfera_sub_00419730(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->eax;
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::EnterCriticalSection)))((uintptr_t)&g_sfera_recovered_static_runtime.scene_lock[0]);
    cpu->edx = 0xEA60u;
    cpu->edx -= cpu->edi;
    lift_push32(cpu, cpu->edx);
...
__declspec(noinline) void sfera_sub_00419BB0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x19BDCu));
    cpu->ecx = *(uint32_t*)(cpu->esi + 0xCu);
...
__declspec(noinline) void sfera_sub_00419BF0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = 0u;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x19C8Fu));
    cpu->eax = *(uint32_t*)(cpu->esi);
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x19CA3u));
    ...
    cpu->eax = reinterpret_cast<uint32_t (__stdcall*)(uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::GetDIBits)))(*(uint32_t*)(cpu->esp), *(uint32_t*)(cpu->esp + 0x4u), *(uint32_t*)(cpu->esp + 0x8u), *(uint32_t*)(cpu->esp + 0xCu), *(uint32_t*)(cpu->esp + 0x10u), *(uint32_t*)(cpu->esp + 0x14u), *(uint32_t*)(cpu->esp + 0x18u)); cpu->esp += 0x1Cu;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x19CFBu));
    cpu->edi = lift_pop32(cpu); cpu->esi = lift_pop32(cpu);
    cpu->esp += 0x54u;
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0041A080(LiftCpu* cpu, uint32_t stop_address) {
    auto* listener = reinterpret_cast<NatureRainListener*>(static_cast<std::uintptr_t>(cpu->ecx)); auto* effect = reinterpret_cast<IEffect*>(static_cast<std::uintptr_t>(*(uint32_t*)(cpu->esp + 8u))); auto* item = reinterpret_cast<SferaActiveEffect*>(static_cast<std::uintptr_t>(*(uint32_t*)(cpu->esp + 0xCu))); if (listener != nullptr && effect != nullptr && item != nullptr) listener->onEffectChanged(*(uint32_t*)(cpu->esp + 4u), *effect, *item); cpu->esp += 0x10u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0041ACF0(LiftCpu* cpu, uint32_t stop_address) { double x87_v0;
    ...
    *(float*)(cpu->esi + 0x1284Cu) = x87_v0; 
    cpu->edx = cpu->esi;
    cpu->ecx = 0x136u;
    auto* listener = reinterpret_cast<BloodEffListener*>(static_cast<uintptr_t>(cpu->esi));
    std::construct_at(listener);
    listener->change_tick = 0x40u;
