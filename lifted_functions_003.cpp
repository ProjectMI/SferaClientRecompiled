...
__declspec(noinline) void sfera_sub_00421A10(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->eax = *(uint32_t*)(cpu->ecx);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21A26u));
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21A3Cu));
    label_00021A3E:
    cpu->eax = 0u;
    cpu->esp += 0xCu; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_00421A90(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->eax = *(uint32_t*)(cpu->ecx);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21AB4u));
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21AC9u));
    cpu->ecx = *(uint32_t*)(cpu->esp + 0x10u);
    cpu->edx = *(uint32_t*)(cpu->esp + 4u);
    ...
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x21AFBu));
    label_00021AFD:
    cpu->esi = lift_pop32(cpu);
    cpu->esp += 8u;
    cpu->esp += 8u; cpu->eip = stop_address; return;
...
__declspec(noinline) void sfera_sub_00421C00(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, address32(&__uuidof(IWebBrowser2))); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21C20u));
    ...
    *(uint16_t*)(cpu->esp + 0x2Cu) = cpu->edx & 0xFFFFu;
    cpu->eax = reinterpret_cast<uint32_t (__stdcall*)(uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::MultiByteToWideChar)))(*(uint32_t*)(cpu->esp), *(uint32_t*)(cpu->esp + 0x4u), *(uint32_t*)(cpu->esp + 0x8u), *(uint32_t*)(cpu->esp + 0xCu), *(uint32_t*)(cpu->esp + 0x10u), *(uint32_t*)(cpu->esp + 0x14u)); cpu->esp += 0x18u;
    cpu->edi = cpu->eax;
    ...
    cpu->eax = reinterpret_cast<uint32_t (__stdcall*)(uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::MultiByteToWideChar)))(0u, 0u, cpu->ebx, 0xFFFFFFFFu, cpu->esi, cpu->edi);
    lift_push32(cpu, cpu->esi);
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = cpu->eax;
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x21C97u));
    cpu->edi = lift_pop32(cpu); cpu->esi = lift_pop32(cpu); cpu->ebp = lift_pop32(cpu);
    cpu->eax = 0xFFFFFFFAu;
    cpu->ebx = lift_pop32(cpu);
    cpu->esp += 0x14u;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21CC0u));
    cpu->ecx = cpu->esp + 0x14u;
    lift_push32(cpu, cpu->ecx);
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21CD7u));
    cpu->edi = lift_pop32(cpu); cpu->esi = lift_pop32(cpu); cpu->ebp = lift_pop32(cpu);
    cpu->eax = 0u;
    cpu->ebx = lift_pop32(cpu);
    cpu->esp += 0x14u;
...
__declspec(noinline) void sfera_sub_00421CF0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, address32(&__uuidof(IWebBrowser2))); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21D0Eu));
    if (cpu->eax != 0u) goto label_00021D3E;
    cpu->eax = *(uint32_t*)(cpu->esp + 4u);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = *(uint32_t*)(cpu->ecx + 0x68u);
    lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x21D1Fu));
    cpu->eax = *(uint32_t*)(cpu->esp + 4u);
    cpu->edx = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x70u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21D30u));
    cpu->eax = *(uint32_t*)(cpu->esp + 4u);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x21D3Cu));
    label_00021D3E:
...
__declspec(noinline) void sfera_sub_00421D50(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->ebx) = cpu->ecx;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21DF0u));
    cpu->ecx = cpu->esp + 0x14u;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21E2Au));
    if (cpu->eax != 0u) goto label_00021EA7;
    cpu->eax = *(uint32_t*)(cpu->esp + 0x10u);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, address32(&__uuidof(IWebBrowser2))); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21E43u));
    if (cpu->eax != 0u) goto label_00021EA7;
    cpu->eax = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = *(uint32_t*)(cpu->ecx + 0x58u);
    lift_push32(cpu, 0u); lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x21E55u));
    cpu->eax = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = *(uint32_t*)(cpu->ecx + 0x60u);
    lift_push32(cpu, 0u); lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x21E63u));
    cpu->eax = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x1Cu);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x68u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21E74u));
    cpu->eax = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->edx = *(uint32_t*)(cpu->esp + 0x20u);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x70u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21E85u));
    cpu->eax = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0x21E91u));
    ...
    lift_native_call(cpu, cpu->ecx, LIFT_CODE_TOKEN_RVA(0x21EC0u));
    cpu->edx = *(uint32_t*)(cpu->esi);
    cpu->eax = *(uint32_t*)(cpu->edx + 8u);
    lift_push32(cpu, cpu->esi);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21EC8u));
    lift_push32(cpu, cpu->edi);
...
__declspec(noinline) void sfera_sub_00421F10(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 8u) = cpu->ecx;
    ...
    cpu->ecx = *(uint32_t*)(cpu->eax + 0x18u);
    lift_push32(cpu, 1u); lift_push32(cpu, cpu->esi);
    lift_native_call(cpu, cpu->ecx, LIFT_CODE_TOKEN_RVA(0x21F65u));
    cpu->edx = *(uint32_t*)(cpu->esi);
    cpu->eax = *(uint32_t*)(cpu->edx + 8u);
    lift_push32(cpu, cpu->esi);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0x21F6Du));
    lift_push32(cpu, cpu->edi);
...
__declspec(noinline) void sfera_sub_00422A20(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint8_t*)(cpu->esp + 0x33u) = 1u;
    ...
    lift_push32(cpu, cpu->ecx); lift_push32(cpu, cpu->ebx);
    cpu->eax = reinterpret_cast<uint32_t (__stdcall*)(uint32_t, uint32_t, uint32_t, uint32_t, uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::ReadFile)))(*(uint32_t*)(cpu->esp), *(uint32_t*)(cpu->esp + 0x4u), *(uint32_t*)(cpu->esp + 0x8u), *(uint32_t*)(cpu->esp + 0xCu), *(uint32_t*)(cpu->esp + 0x10u)); cpu->esp += 0x14u;
...
__declspec(noinline) void sfera_sub_00422CB0(LiftCpu* cpu, uint32_t stop_address) { double value_0, value_1;
...
label_00022D50:
    ...
    *(float*)(cpu->esp + 0x14u) = (double)*(float*)(cpu->esp + 0x1Cu);
    x87_p0 = (double)*(float*)(cpu->esp + 0x14u);
     value_0 = x87_p0; if (!(((double)*(float*)(cpu->esp + 0x10u))<(value_0))) goto label_00022DBA;
...
__declspec(noinline) void sfera_sub_004243C0(LiftCpu* cpu, uint32_t stop_address) {
 bool sub_pred[17]; double x87_v0, x87_v1, x87_v2, x87_v3, x87_v4; double x87_p0, x87_p1, x87_p2, x87_p3, x87_p4;
    cpu->esp -= 0xCu;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->ebp); lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->edi);
    cpu->edi = cpu->ecx;
...
label_0002442F:
    ...
    *(float*)(cpu->esp + 0x10u) = ((((double)*(float*)(cpu->esi + 4u))) - (((double)*(float*)(cpu->ebx + 8u))));
    ...
    x87_v2 = x87_v2 * x87_v4; 
    x87_v2 = x87_v2 + x87_v3; 
    if (!((x87_v2)>(2600.0))) goto label_00024528;
label_00024468:
...
__declspec(noinline) void sfera_sub_00424A40(LiftCpu* cpu, uint32_t stop_address) {
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::EnterCriticalSection)))(cpu->ebx);
    if (*(uint32_t*)(cpu->esi + 0x1594u) != 1u) goto label_00024AA5;
    cpu->edx = cpu->esi + 4u;

    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::EnterCriticalSection)))(cpu->edx);
    cpu->esi += 0x1Cu;

    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::EnterCriticalSection)))(cpu->esi);
    lift_push32(cpu, cpu->ebx);
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::EnterCriticalSection)))(cpu->eax);
    cpu->esi += 4u;
...
__declspec(noinline) void sfera_sub_00424AD0(LiftCpu* cpu, uint32_t stop_address) { bool sub_pred[5];
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = 0u;
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::EnterCriticalSection)))(cpu->ebp);
    *(uint32_t*)(cpu->ebx + 0x1594u)^=1u;
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::LeaveCriticalSection)))(cpu->ebp);
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->eax;
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::EnterCriticalSection)))(cpu->edi);
    *(uint32_t*)(cpu->ebx + 0x1594u)^=1u;
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::LeaveCriticalSection)))(cpu->edi);
...
__declspec(noinline) void sfera_sub_004253F0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esi + 0x6Cu) = cpu->edx;
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::InitializeCriticalSection)))(*(uint32_t*)(cpu->esp)); cpu->esp += 0x4u;
    cpu->ecx = cpu->esi + 0x1Cu;

    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::InitializeCriticalSection)))(cpu->ecx);
    cpu->edx = cpu->esi + 0x34u;

    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::InitializeCriticalSection)))(cpu->edx);
    cpu->eax = cpu->esi + 0x4Cu;

    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::InitializeCriticalSection)))(cpu->eax);
    cpu->edi = lift_pop32(cpu);
    cpu->eax = cpu->esi;
    cpu->esi = lift_pop32(cpu); cpu->esp += 0x10u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_004255D0(LiftCpu* cpu, uint32_t stop_address) { double value_0, value_1, value_2, value_3;
...
label_000254C9:
    ...
    *(float*)(cpu->esp + 4u) = x87_p0; 
    ...
    x87_p1 = (double)*(float*)(cpu->esp + 4u);
     value_1 = x87_p1; value_2 = x87_p0; if (!((value_1)>(value_2))) goto label_00025520;
    *(float*)(cpu->esp + 4u) = value_2; 
    value_3 = (double)*(float*)(cpu->esp + 4u);
     value_0 = value_3; goto label_00025522;
label_00025520:
      value_0 = value_1;
label_00025522:
    x87_p0 = value_0;
...
label_000255D0:
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::LeaveCriticalSection)))(cpu->eax);
    cpu->ecx = cpu->esi + 0x1Cu;

    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::LeaveCriticalSection)))(cpu->ecx);
    cpu->edi = lift_pop32(cpu);
    cpu->ecx = cpu->esi;
    cpu->esi = lift_pop32(cpu);
    goto label_00025490;
...
__declspec(noinline) void sfera_sub_004258F0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::DeleteCriticalSection)))(cpu->eax);
    cpu->ecx = cpu->esi + 0x1Cu;

    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::DeleteCriticalSection)))(cpu->ecx);
    cpu->edx = cpu->esi + 0x34u;

    reinterpret_cast<void (__stdcall*)(uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::DeleteCriticalSection)))(cpu->edx);
    cpu->eax = cpu->esi + 0x4Cu;
...
__declspec(noinline) void sfera_sub_00425A50(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->eax = reinterpret_cast<uint32_t (__cdecl*)(uint32_t, uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::_stricmp)))(cpu->esi, cpu->edi);
...
__declspec(noinline) double sfera_sub_00425B20(LiftCpu* cpu, uint32_t stop_address) {
    const SferaEffectVec3F viewer = g_sfera_world_objects.referencePosition();
    g_sfera_effect_manager.viewer_position = {viewer.x, viewer.y, viewer.z};
    const auto* position = reinterpret_cast<const SferaEffectVec3F*>(static_cast<uintptr_t>(cpu->ecx));
    float result = 0.0f;
    if (position != nullptr) result = g_sfera_effect_manager.viewerDistance(*position);
    else result = g_sfera_effect_manager.viewerDistance(cpu->edx);
    cpu->esp += 4u; cpu->eip = stop_address; return result;
}
__declspec(noinline) void sfera_sub_00425BD0(LiftCpu* cpu, uint32_t stop_address) {
    IEffect* effect = g_sfera_effect_manager.findDefinition(cpu->ecx);
    cpu->eax = static_cast<uint32_t>(reinterpret_cast<uintptr_t>(effect));
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_00425C00(LiftCpu* cpu, uint32_t stop_address) {
    const uint32_t item_address = *(uint32_t*)(cpu->esp + 4u);
    auto& list = *reinterpret_cast<SferaIntrusiveListHeader*>(static_cast<uintptr_t>(cpu->ecx));
    auto& item = *sfera_active_effect(item_address);
    sfera_effect_list_append(list, item);
    cpu->eax = item_address;
    cpu->esp += 8u; cpu->eip = stop_address; return;
}

__declspec(noinline) void sfera_sub_00425C30(LiftCpu* cpu, uint32_t stop_address) {
    const uint32_t item_address = *(uint32_t*)(cpu->esp + 4u);
    if (item_address != 0u && cpu->ecx != 0u) { auto& list = *reinterpret_cast<SferaIntrusiveListHeader*>(static_cast<uintptr_t>(cpu->ecx)); sfera_effect_list_remove(list, *sfera_active_effect(item_address)); }
    cpu->esp += 8u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_00425D80(LiftCpu* cpu, uint32_t stop_address) {
    g_sfera_effect_manager.destroyDefinitions(); cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00425E30(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<IEffect*>(static_cast<uintptr_t>(cpu->ecx));
    std::construct_at(effect);
    effect->initializeBaseState(0u);
    cpu->eax = cpu->ecx;
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00425E70(LiftCpu* cpu, uint32_t stop_address) { bool sub_pred[1];
    ...
    std::construct_at(reinterpret_cast<IEffect*>(cpu->esi));
...
__declspec(noinline) void sfera_sub_00425F60(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<IEffect*>(static_cast<uintptr_t>(cpu->ecx));
    if (effect != nullptr) { effect->releaseEffect(); }
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_00425FA0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    auto* effect = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(address));
    std::construct_at(effect);
...
__declspec(noinline) void sfera_sub_00426080(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx)); const char* name = reinterpret_cast<const char*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 4u)));
    cpu->eax = static_cast<uint32_t>(effect != nullptr ? effect->findEffectMeshDefinitionIndex(name) : -1); cpu->esp += 8u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_004260F0(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx)); const char* name = reinterpret_cast<const char*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 4u)));
    cpu->eax = static_cast<uint32_t>(effect != nullptr ? effect->findParticleSystemDefinitionIndex(name) : -1); cpu->esp += 8u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_004261C0(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx));
    effect->resetRuntimeState();
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00426440(LiftCpu* cpu, uint32_t stop_address) {
    reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx))->buildLinkedParticleSystems();
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00426640(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx));
    SferaEffectUpdateContext context{reinterpret_cast<void*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 4u))), std::bit_cast<float>(*(uint32_t*)(cpu->esp + 8u))};
    effect->updateEffect(context);
    cpu->esp += 0xCu; cpu->eip = stop_address; return;
}
