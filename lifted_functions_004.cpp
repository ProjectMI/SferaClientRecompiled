...
__declspec(noinline) void sfera_sub_004266D0(LiftCpu* cpu, uint32_t stop_address) {
    reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx))->renderEffect();
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00426710(LiftCpu* cpu, uint32_t stop_address) {
    SferaLightDefinition* light = reinterpret_cast<SferaLightDefinition*>(static_cast<uintptr_t>(cpu->ecx));
    light->initializeDefaults();
    cpu->eax = cpu->ecx;
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00426780(LiftCpu* cpu, uint32_t stop_address) {
    auto* light = reinterpret_cast<SferaLightDefinition*>(static_cast<uintptr_t>(cpu->ecx));
    auto* parser = reinterpret_cast<SferaSimpleParser*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 8u)));
    auto* range = reinterpret_cast<const SferaParserRange*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 0xCu)));
    cpu->eax = light != nullptr && parser != nullptr && range != nullptr && light->load(*parser, *range) ? 1u : 0u;
...
__declspec(noinline) void sfera_sub_004277C0(LiftCpu* cpu, uint32_t stop_address) {
    auto* definition = reinterpret_cast<SferaLightDefinition*>(static_cast<uintptr_t>(cpu->ecx));
    definition->release();
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_004278E0(LiftCpu* cpu, uint32_t stop_address) {
    auto* definition = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx));
...
__declspec(noinline) void sfera_sub_00427F10(LiftCpu* cpu, uint32_t stop_address) {
    auto* scripted = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx));
    const char* filename = reinterpret_cast<const char*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 4u)));
    cpu->eax = scripted != nullptr && scripted->loadScript(filename) ? 1u : 0u;
    cpu->esp += 8u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00428A10(LiftCpu* cpu, uint32_t stop_address) {
    auto* definition = reinterpret_cast<SferaLightDefinition*>(static_cast<uintptr_t>(cpu->ecx));
    const auto* base = reinterpret_cast<const SferaEffectVec3F*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 4u)));
    if (base != nullptr) definition->update(*base, std::bit_cast<float>(*(uint32_t*)(cpu->esp + 8u)), *(uint32_t*)(cpu->esp + 0xCu));
    cpu->esp += 0x10u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00428BF0(LiftCpu* cpu, uint32_t stop_address) {
    g_sfera_effect_manager.loadDefinitions();
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00429000(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx));
    effect->destroyEffect(false);
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00429280(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx));
    SferaEffectQueryContext context{reinterpret_cast<void*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 4u))), std::bit_cast<float>(*(uint32_t*)(cpu->esp + 8u))};
    effect->queryEffectState(context);
    cpu->esp += 0xCu; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_00429990(LiftCpu* cpu, uint32_t stop_address) {
    auto* listener = reinterpret_cast<IEffectListener*>(static_cast<uintptr_t>(cpu->ecx)); if (listener != nullptr) g_sfera_effect_manager.unregisterListener(*listener);
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_00429A10(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CScriptedEffect*>(static_cast<uintptr_t>(cpu->ecx));
    const bool free_storage = (*(uint8_t*)(cpu->esp + 4u) & 1u) != 0u;
    effect->destroyEffect(free_storage);
...
__declspec(noinline) void sfera_sub_00429F30(LiftCpu* cpu, uint32_t stop_address) {
    auto* item = sfera_active_effect(cpu->ecx); if (item != nullptr && cpu->ecx != 0xFFFFFFFFu) g_sfera_effect_manager.updateActiveEffect(*item, static_cast<std::uint16_t>(cpu->edx), std::bit_cast<float>(*(uint32_t*)(cpu->esp + 4u)));
    cpu->eax = 0u; cpu->esp += 8u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042AA90(LiftCpu* cpu, uint32_t stop_address) {
    auto* listener = reinterpret_cast<IEffectListener*>(static_cast<uintptr_t>(cpu->edx)); if (listener != nullptr) g_sfera_effect_manager.registerListener(cpu->ecx, *listener);
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042AFC0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    auto* effect = reinterpret_cast<CSpiralEffect*>(static_cast<uintptr_t>(address));
    std::construct_at(effect);
    effect->initializePreset();
    lift_push32(cpu, (uintptr_t)"spiral.effect0"); cpu->ecx = address; lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x42B009u)); sfera_sub_00425EB0(cpu, LIFT_CODE_TOKEN_VA(0x42B009u));
    cpu->eax = address;
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042B0B0(LiftCpu* cpu, uint32_t stop_address) {
    auto* definition = reinterpret_cast<CSpiralEffect*>(static_cast<uintptr_t>(cpu->ecx));
    cpu->eax = static_cast<uint32_t>(reinterpret_cast<uintptr_t>(definition->createEffectResources()));
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042B150(LiftCpu* cpu, uint32_t stop_address) {
    const uint32_t address = cpu->ecx;
    auto* effect = reinterpret_cast<CMolEffect*>(static_cast<uintptr_t>(address));
    std::construct_at(effect);
    effect->initializePreset();
    lift_push32(cpu, (uintptr_t)"molniya.effect110"); cpu->ecx = address; lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x42B198u)); sfera_sub_00425EB0(cpu, LIFT_CODE_TOKEN_VA(0x42B198u));
    cpu->eax = address;
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_0042B200(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CMolEffect*>(static_cast<uintptr_t>(cpu->ecx));
...
__declspec(noinline) void sfera_sub_0042B260(LiftCpu* cpu, uint32_t stop_address) {
    auto* definition = reinterpret_cast<CMolEffect*>(static_cast<uintptr_t>(cpu->ecx));
    cpu->eax = static_cast<uint32_t>(reinterpret_cast<uintptr_t>(definition->createEffectResources()));
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042B320(LiftCpu* cpu, uint32_t stop_address) {
    const uint32_t address = cpu->ecx;
    auto* effect = reinterpret_cast<CBladeEffect*>(static_cast<uintptr_t>(address));
    std::construct_at(effect);
    effect->initializePreset();
    lift_push32(cpu, (uintptr_t)"blade"); cpu->ecx = address; lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x42B369u)); sfera_sub_00425EB0(cpu, LIFT_CODE_TOKEN_VA(0x42B369u));
    cpu->eax = address;
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042B3E0(LiftCpu* cpu, uint32_t stop_address) {
    auto* definition = reinterpret_cast<CBladeEffect*>(static_cast<uintptr_t>(cpu->ecx));
    cpu->eax = static_cast<uint32_t>(reinterpret_cast<uintptr_t>(definition->createEffectResources()));
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042B4A0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = 0u;
    ...
    reinterpret_cast<IEffect*>(static_cast<uintptr_t>(cpu->ecx))->destroyEffect(true);
    label_0002B503:
    cpu->esi += 0x14u;
...
__declspec(noinline) void sfera_sub_0042B530(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CGazerLakeEffect*>(static_cast<uintptr_t>(cpu->ecx));
    SferaEffectInitializeContext context{reinterpret_cast<void*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 4u))), *(uint32_t*)(cpu->esp + 8u), std::bit_cast<float>(*(uint32_t*)(cpu->esp + 0xCu)), *(uint32_t*)(cpu->esp + 0x10u) != 0u, reinterpret_cast<void*>(static_cast<uintptr_t>(*(uint32_t*)(cpu->esp + 0x14u)))};
    effect->initializeEffect(context);
    cpu->esp += 0x18u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042B720(LiftCpu* cpu, uint32_t stop_address) {
    const uint32_t address = cpu->ecx;
    auto* effect = reinterpret_cast<CRainEffect*>(static_cast<uintptr_t>(address));
    std::construct_at(effect);
    effect->initializePreset();
    lift_push32(cpu, (uintptr_t)"rain"); cpu->ecx = address; lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x42B78Fu)); sfera_sub_00425EB0(cpu, LIFT_CODE_TOKEN_VA(0x42B78Fu));
    cpu->eax = address;
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042B7E0(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CSpiralEffect*>(static_cast<uintptr_t>(cpu->ecx));
    const uint32_t address = cpu->ecx;
...
__declspec(noinline) void sfera_sub_0042C020(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CBladeEffect*>(static_cast<uintptr_t>(cpu->ecx));
    const uint32_t address = cpu->ecx;
    effect->destroyEffect( (*(uint8_t*)(cpu->esp + 4u) & 1u) != 0u);
    cpu->eax = address;
    cpu->esp += 8u; cpu->eip = stop_address; return;
...
__declspec(noinline) void sfera_sub_0042C570(LiftCpu* cpu, uint32_t stop_address) {
    const uint32_t address = cpu->ecx;
    const uint32_t id = *(uint32_t*)(cpu->esp + 4u);
    const float radius = std::bit_cast<float>(*(uint32_t*)(cpu->esp + 8u));
    const uint32_t count = *(uint32_t*)(cpu->esp + 0xCu);
    auto* effect = reinterpret_cast<CGazerLakeEffect*>(static_cast<uintptr_t>(address));
    std::construct_at(effect);
    effect->initializePreset(id, radius, count);
    lift_push32(cpu, (uintptr_t)"gazer.lake"); cpu->ecx = address; lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x42C5CEu)); sfera_sub_00425EB0(cpu, LIFT_CODE_TOKEN_VA(0x42C5CEu));
    cpu->eax = address;
    cpu->esp += 0x10u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_0042C6B0(LiftCpu* cpu, uint32_t stop_address) {
    auto* definition = reinterpret_cast<CGazerLakeEffect*>(static_cast<uintptr_t>(cpu->ecx));
    cpu->eax = static_cast<uint32_t>(reinterpret_cast<uintptr_t>(definition->createEffectResources()));
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_0042C770(LiftCpu* cpu, uint32_t stop_address) {
    auto* effect = reinterpret_cast<CRainEffect*>(static_cast<uintptr_t>(cpu->ecx));
    const uint32_t address = cpu->ecx;
    effect->destroyEffect( (*(uint8_t*)(cpu->esp + 4u) & 1u) != 0u);
    cpu->eax = address;
    cpu->esp += 8u; cpu->eip = stop_address; return;
...
__declspec(noinline) void sfera_sub_0042CFC0(LiftCpu* cpu, uint32_t stop_address) {
    auto* definition = reinterpret_cast<CRainEffect*>(static_cast<uintptr_t>(cpu->ecx));
    cpu->eax = static_cast<uint32_t>(reinterpret_cast<uintptr_t>(definition->createEffectResources()));
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
