...
SferaInterpreterScratchRuntime g_sfera_interpreter_scratch_runtime = {};
SferaGraphicsRuntime g_sfera_graphics_runtime = {};
SferaSceneRenderRuntime g_sfera_scene_render_runtime = {};
SferaMatrix4x4F g_sfera_model_coordinate_matrix = {};
SferaMatrix4x4F g_sfera_character_frame_matrix = {};
SferaBoundsCornersRuntime g_sfera_client_bounds_corners = {};
SferaMatrix4x4F g_sfera_character_rotation_matrix = {};
...
SferaDirectInputRuntime g_sfera_direct_input_runtime = {};
SferaShadowRuntime g_sfera_shadow_runtime = {};
SferaWorldRenderRuntime g_sfera_world_render_runtime = {};
SferaWorldLoadRuntime g_sfera_world_load_runtime = {};
SferaWorldBoundsRuntime g_sfera_world_bounds_runtime = {};
SferaRenderLookupRuntime g_sfera_render_lookup_runtime = {};
SferaLandscapeRenderRuntime g_sfera_landscape_render_runtime = {};
SferaProcessRuntime g_sfera_process_runtime = {};
SferaClientProcessRuntime g_sfera_client_process_runtime = {};
SferaMainRenderRuntime g_sfera_main_render_runtime = {};
SferaSceneControlRuntime g_sfera_scene_control_runtime = {};
SferaMainAuxRuntime g_sfera_main_aux_runtime = {};
SferaLandscapeMapRuntime g_sfera_landscape_map_runtime = {};
SferaSkyRuntime g_sfera_sky_runtime = {};
SferaTextureCacheRuntime g_sfera_texture_cache_runtime = {};
SferaFontAtlasLayoutRuntime g_sfera_font_atlas_layout_runtime = {};
SferaFontAtlasStagingRuntime g_sfera_font_atlas_staging_runtime = {};
SferaPartitionSortRuntime g_sfera_partition_sort_runtime = {};
SferaErrorMessageScratchRuntime g_sfera_error_message_scratch_runtime = {};
SferaMaterialFilterRuntime g_sfera_material_filter_runtime = {};
SferaGrassMapRuntime g_sfera_grass_map_runtime = {};
SferaFontFactoryRuntime g_sfera_font_factory_runtime = {};
SferaPhysicsRuntime g_sfera_physics_runtime = {};
SferaViewGeometryRuntime g_sfera_view_geometry_runtime = {};
SferaViewProjectionScratchRuntime g_sfera_view_projection_scratch_runtime = {};
SferaMatrix4x4F g_sfera_model_transform_scratch_matrix = {};
SferaBoundsCornersRuntime g_sfera_model_bounds_corners = {};
SferaSkyInterpolationRuntime g_sfera_sky_interpolation_runtime = {};
SferaColorExpansionRuntime g_sfera_color_expansion_runtime = {};
SFERA_STORAGE_ALIGN SferaSpatialStateRuntime g_sfera_spatial_states[SFERA_SPATIAL_STATE_COUNT] = {};
SferaUiParseScratchRuntime g_sfera_ui_parse_scratch_runtime = {};
SferaCriticalDiagnosticsRuntime g_sfera_critical_diagnostics_runtime = {};
SferaTerrainNeighborRuntime g_sfera_terrain_neighbor_runtime = {};
SferaLandscapePatchLookupRuntime g_sfera_landscape_patch_lookup_runtime = {};
SferaDebugWindowRuntime g_sfera_debug_window_runtime = {};
SferaLandscapeProbeRuntime g_sfera_landscape_probe_runtime = {};
SferaViewMotionRuntime g_sfera_view_motion_runtime = {};
SferaRenderSampleRuntime g_sfera_render_sample_runtime = {};
SferaSceneVectorRuntime g_sfera_scene_vector_runtime = {};
SferaVec3Word g_sfera_flare_projection = {};
SferaTerrainDiagnosticRuntime g_sfera_terrain_diagnostic_runtime = {};
SferaWorldSlotTableRuntime g_sfera_world_slot_table_runtime = {};
...
SferaRecoveredStaticRuntime g_sfera_recovered_static_runtime = {};
SferaPendingKeyRuntime g_sfera_pending_key_runtime = {};
SferaRelaunchRuntime g_sfera_relaunch_runtime = {};
SferaWorldRenderQueueRuntime g_sfera_world_render_queue_runtime = {};
SferaViewSpatialRuntime g_sfera_view_spatial_runtime = {};
SferaSpatialBoundsRuntime g_sfera_spatial_bounds_runtime = {};
...
SferaLandscapeInterpolationRuntime g_sfera_landscape_interpolation_runtime = {};
SferaCollisionRuntime g_sfera_collision_runtime = {};
SferaSceneArrayRuntime g_sfera_scene_array_runtime = {};
SferaSceneBuildRuntime g_sfera_scene_build_runtime = {};
SferaWeatherRuntime g_sfera_weather_runtime = {};
SferaModelRuntime g_sfera_model_runtime = {};
SferaModelRegistryRuntime g_sfera_model_registry_runtime = {};
SferaModelMaterialLookupRuntime g_sfera_model_material_lookup_runtime = {};
uint16_t g_sfera_dynamic_index_scratch[SFERA_DYNAMIC_INDEX_SCRATCH_COUNT] = {};
SferaNatureRuntime g_sfera_nature_runtime = {};
...
SferaFrameRuntime g_sfera_frame_runtime = {};
SferaHighResolutionClockRuntime g_sfera_high_resolution_clock_runtime = {};
SferaProfilerRuntime g_sfera_profiler_runtime = {};
SferaCrc32Runtime g_sfera_crc32_runtime = {};
SferaUiLoadScratchRuntime g_sfera_ui_load_scratch_runtime = {};
SferaHyperTextScratchRuntime g_sfera_hypertext_scratch_runtime = {};
SferaStringLookupRuntime g_sfera_string_lookup_runtime = {};
SferaAsciiLowerRuntime g_sfera_ascii_lower_runtime = {};
SferaModelLoadScratchRuntime g_sfera_model_load_scratch_runtime = {};
SferaStringUtilityRuntime g_sfera_string_utility_runtime = {};
SferaNetworkProbeRuntime g_sfera_network_probe_runtime = {};
SferaConfigParseScratchRuntime g_sfera_config_parse_scratch_runtime = {};
SferaMusicRuntime g_sfera_music_runtime = {};
SferaContainerDiagnosticsRuntime g_sfera_container_diagnostics_runtime = {};
SferaOleHostAbi g_sfera_ole_host_abi = {};
uint32_t g_sfera_graphics_display_depth_bits = 32u;
SferaMainCommandStateRuntime g_sfera_main_command_state_runtime = {};
SferaMainInputStateRuntime g_sfera_main_input_state_runtime = {};
SferaMainViewStateRuntime g_sfera_main_view_state_runtime = {};
SferaMainUiStateRuntime g_sfera_main_ui_state_runtime = {};
uint16_t g_sfera_screen_quad_indices[SFERA_SCREEN_QUAD_INDEX_COUNT] = {};
SferaClientConfigRuntime g_sfera_client_config_runtime = {};
SferaGrassPlacementRuntime g_sfera_grass_placement_runtime = {};
SFERA_STORAGE_ALIGN SferaInterfaceCoreRuntime g_sfera_interface_core_runtime = {};
SferaClientMainScalarRuntime g_sfera_client_main_scalar_runtime = {};
SferaInterScalarRuntime g_sfera_inter_scalar_runtime = {};
SferaTextureSetScalarRuntime g_sfera_texture_set_scalar_runtime = {};
SferaTextureRegistryRuntime g_sfera_texture_registry_runtime = {};
...
SferaMemorySourceHashRuntime g_sfera_memory_source_hash_runtime = {};
SferaAllocationHashRuntime g_sfera_allocation_hash_runtime = {};
SferaDiagnosticLogObjectRuntime g_sfera_log_memory_object = {};
SferaDiagnosticLogObjectRuntime g_sfera_log_warnings_object = {};
SferaDiagnosticLogObjectRuntime g_sfera_log_errors_object = {};
uint8_t g_sfera_diagnostic_log_byte = 0u;
SferaWin32DialogRegistryRuntime g_sfera_win32_dialog_registry = {};
SferaControlReferenceRegistryRuntime g_sfera_control_reference_registry = {};
SferaCursorTextureRegistryRuntime g_sfera_cursor_texture_registry = {};
uint32_t g_sfera_cursor_texture_registry_guard = 0u;
SferaD3D9SemanticStateRuntime g_sfera_d3d9_semantic_state = {};
SferaBrowserWindowRuntime g_sfera_browser_window_runtime = {};
SferaMinimapTextureRuntime g_sfera_minimap_texture_runtime = {};
uint32_t g_sfera_control_reference_registry_guard = 0u;
SferaCrtStartupRuntime g_sfera_crt_startup_runtime = {};
SferaCrashReportRuntime g_sfera_crash_report_runtime = {};
...
static void sfera_initialize_network_defaults(void) {
    ...
    memset(&g_sfera_directplay_runtime, 0, sizeof(g_sfera_directplay_runtime));
    memset(&g_sfera_network_connection_checker, 0, sizeof(g_sfera_network_connection_checker));
    memset(&g_sfera_font_runtime, 0, sizeof(g_sfera_font_runtime));
    memset(&g_sfera_cursor_manager_runtime, 0, sizeof(g_sfera_cursor_manager_runtime));
    memset(&g_sfera_pop_slice_fallback, 0, sizeof(g_sfera_pop_slice_fallback));
    memset(&g_sfera_pop_sliceup_fallback, 0, sizeof(g_sfera_pop_sliceup_fallback));
    memset(&g_sfera_interpreter_scratch_runtime, 0, sizeof(g_sfera_interpreter_scratch_runtime));
...
static void sfera_initialize_graphics_defaults(void) {
    ...
    memset(&g_sfera_graphics_runtime, 0, sizeof(g_sfera_graphics_runtime));
...
static void sfera_initialize_interface_defaults(void) {
    memset(&g_sfera_interface_runtime, 0, sizeof(g_sfera_interface_runtime));
...
static void sfera_initialize_object_runtime(void) {
    memset(&g_sfera_effect_items, 0, sizeof(g_sfera_effect_items));
    g_sfera_effect_items.growth_count = UINT32_C(6000);
    memset(&g_sfera_server_wall, 0, sizeof(g_sfera_server_wall));
    g_sfera_server_wall.effect_handle = UINT32_MAX;
    memset(&g_sfera_sound_effect_items, 0, sizeof(g_sfera_sound_effect_items));
    g_sfera_sound_effect_items.growth_count = UINT32_C(128);
}

static void sfera_initialize_runtime_sentinels(void) {
    memset(&g_sfera_world_objects, 0, sizeof(g_sfera_world_objects));
    g_sfera_world_objects.max_occupied_object_handle = UINT32_MAX;
    g_sfera_world_objects.controlled_object_handle = UINT32_MAX;
    g_sfera_world_objects.contour_mode = UINT32_MAX;
    memset(&g_sfera_grass_runtime, 0, sizeof(g_sfera_grass_runtime));
    memset(&g_sfera_light_runtime, 0, sizeof(g_sfera_light_runtime));
    memset(&g_sfera_landscape_runtime, 0, sizeof(g_sfera_landscape_runtime));
    memset(&g_sfera_landscape_interpolation_runtime, 0, sizeof(g_sfera_landscape_interpolation_runtime));
    memset(&g_sfera_collision_runtime, 0, sizeof(g_sfera_collision_runtime));
    memset(&g_sfera_scene_array_runtime, 0, sizeof(g_sfera_scene_array_runtime));
    memset(&g_sfera_scene_build_runtime, 0, sizeof(g_sfera_scene_build_runtime));
    memset(&g_sfera_weather_runtime, 0, sizeof(g_sfera_weather_runtime));
    memset(&g_sfera_browser_window_runtime, 0, sizeof(g_sfera_browser_window_runtime));
    memset(&g_sfera_minimap_texture_runtime, 0, sizeof(g_sfera_minimap_texture_runtime));
    memset(&g_sfera_model_runtime, 0, sizeof(g_sfera_model_runtime));
    memset(&g_sfera_model_registry_runtime, 0, sizeof(g_sfera_model_registry_runtime));
    memset(&g_sfera_model_material_lookup_runtime, 0, sizeof(g_sfera_model_material_lookup_runtime));
    memset(g_sfera_dynamic_index_scratch, 0, sizeof(g_sfera_dynamic_index_scratch));
    memset(&g_sfera_nature_runtime, 0, sizeof(g_sfera_nature_runtime));
    memset(&g_sfera_sound_runtime, 0, sizeof(g_sfera_sound_runtime));
    memset(&g_sfera_warning_log_runtime, 0, sizeof(g_sfera_warning_log_runtime));
    memset(&g_sfera_scene_render_runtime, 0, sizeof(g_sfera_scene_render_runtime));
    memset(&g_sfera_model_coordinate_matrix, 0, sizeof(g_sfera_model_coordinate_matrix));
    ...
    memset(&g_sfera_character_index_map, 0, sizeof(g_sfera_character_index_map));
    memset(&g_sfera_mesh_partition_indices, 0, sizeof(g_sfera_mesh_partition_indices));
    memset(&g_sfera_graphics_options_runtime, 0, sizeof(g_sfera_graphics_options_runtime));
    memset(&g_sfera_sphere_options_runtime, 0, sizeof(g_sfera_sphere_options_runtime));
    memset(&g_sfera_options_dialog_runtime, 0, sizeof(g_sfera_options_dialog_runtime));
    memset(&g_sfera_window_runtime, 0, sizeof(g_sfera_window_runtime));
    memset(&g_sfera_input_device_runtime, 0, sizeof(g_sfera_input_device_runtime));
    memset(&g_sfera_screen_clip_runtime, 0, sizeof(g_sfera_screen_clip_runtime));
    memset(&g_sfera_direct_input_runtime, 0, sizeof(g_sfera_direct_input_runtime));
    memset(&g_sfera_shadow_runtime, 0, sizeof(g_sfera_shadow_runtime));
    memset(&g_sfera_world_render_runtime, 0, sizeof(g_sfera_world_render_runtime));
    memset(&g_sfera_world_load_runtime, 0, sizeof(g_sfera_world_load_runtime));
    memset(&g_sfera_world_bounds_runtime, 0, sizeof(g_sfera_world_bounds_runtime));
    memset(&g_sfera_render_lookup_runtime, 0, sizeof(g_sfera_render_lookup_runtime));
    memset(&g_sfera_landscape_render_runtime, 0, sizeof(g_sfera_landscape_render_runtime));
    memset(&g_sfera_process_runtime, 0, sizeof(g_sfera_process_runtime));
    memset(&g_sfera_client_process_runtime, 0, sizeof(g_sfera_client_process_runtime));
    memset(&g_sfera_main_render_runtime, 0, sizeof(g_sfera_main_render_runtime));
    memset(&g_sfera_scene_control_runtime, 0, sizeof(g_sfera_scene_control_runtime));
    memset(&g_sfera_main_aux_runtime, 0, sizeof(g_sfera_main_aux_runtime));
    memset(&g_sfera_landscape_map_runtime, 0, sizeof(g_sfera_landscape_map_runtime));
    memset(&g_sfera_sky_runtime, 0, sizeof(g_sfera_sky_runtime));
    memset(&g_sfera_texture_cache_runtime, 0, sizeof(g_sfera_texture_cache_runtime));
    memset(&g_sfera_font_atlas_layout_runtime, 0, sizeof(g_sfera_font_atlas_layout_runtime));
    memset(&g_sfera_font_atlas_staging_runtime, 0, sizeof(g_sfera_font_atlas_staging_runtime));
    memset(&g_sfera_partition_sort_runtime, 0, sizeof(g_sfera_partition_sort_runtime));
    memset(&g_sfera_error_message_scratch_runtime, 0, sizeof(g_sfera_error_message_scratch_runtime));
    memset(&g_sfera_material_filter_runtime, 0, sizeof(g_sfera_material_filter_runtime));
    memset(&g_sfera_grass_map_runtime, 0, sizeof(g_sfera_grass_map_runtime));
    memset(&g_sfera_font_factory_runtime, 0, sizeof(g_sfera_font_factory_runtime));
    memset(&g_sfera_physics_runtime, 0, sizeof(g_sfera_physics_runtime));
    memset(&g_sfera_view_geometry_runtime, 0, sizeof(g_sfera_view_geometry_runtime));
    memset(&g_sfera_view_projection_scratch_runtime, 0, sizeof(g_sfera_view_projection_scratch_runtime));
    memset(&g_sfera_model_transform_scratch_matrix, 0, sizeof(g_sfera_model_transform_scratch_matrix));
    memset(&g_sfera_model_bounds_corners, 0, sizeof(g_sfera_model_bounds_corners));
    memset(&g_sfera_sky_interpolation_runtime, 0, sizeof(g_sfera_sky_interpolation_runtime));
    memset(&g_sfera_color_expansion_runtime, 0, sizeof(g_sfera_color_expansion_runtime));
    memset(g_sfera_spatial_states, 0, sizeof(g_sfera_spatial_states));
    memset(&g_sfera_ui_parse_scratch_runtime, 0, sizeof(g_sfera_ui_parse_scratch_runtime));
    memset(&g_sfera_critical_diagnostics_runtime, 0, sizeof(g_sfera_critical_diagnostics_runtime));
    memset(&g_sfera_terrain_neighbor_runtime, 0, sizeof(g_sfera_terrain_neighbor_runtime));
    memset(&g_sfera_landscape_patch_lookup_runtime, 0, sizeof(g_sfera_landscape_patch_lookup_runtime));
    memset(&g_sfera_debug_window_runtime, 0, sizeof(g_sfera_debug_window_runtime));
    memset(&g_sfera_landscape_probe_runtime, 0, sizeof(g_sfera_landscape_probe_runtime));
    memset(&g_sfera_view_motion_runtime, 0, sizeof(g_sfera_view_motion_runtime));
    memset(&g_sfera_render_sample_runtime, 0, sizeof(g_sfera_render_sample_runtime));
    memset(&g_sfera_scene_vector_runtime, 0, sizeof(g_sfera_scene_vector_runtime));
    memset(&g_sfera_flare_projection, 0, sizeof(g_sfera_flare_projection));
    memset(&g_sfera_terrain_diagnostic_runtime, 0, sizeof(g_sfera_terrain_diagnostic_runtime));
    memset(&g_sfera_world_slot_table_runtime, 0, sizeof(g_sfera_world_slot_table_runtime));
    ...
    memset(&g_sfera_recovered_static_runtime, 0, sizeof(g_sfera_recovered_static_runtime));
    memset(&g_sfera_pending_key_runtime, 0, sizeof(g_sfera_pending_key_runtime));
    memset(&g_sfera_relaunch_runtime, 0, sizeof(g_sfera_relaunch_runtime));
    memset(&g_sfera_world_render_queue_runtime, 0, sizeof(g_sfera_world_render_queue_runtime));
    memset(&g_sfera_view_spatial_runtime, 0, sizeof(g_sfera_view_spatial_runtime));
    memset(&g_sfera_spatial_bounds_runtime, 0, sizeof(g_sfera_spatial_bounds_runtime));
    memset(&g_sfera_control_options, 0, sizeof(g_sfera_control_options));
    g_sfera_control_options.active_slot = UINT32_MAX;
    memset(&g_sfera_sprite_runtime, 0, sizeof(g_sfera_sprite_runtime));
    g_sfera_sprite_runtime.render_mode = UINT32_MAX;
    memset(&g_sfera_crash_runtime, 0, sizeof(g_sfera_crash_runtime));
    g_sfera_crash_runtime.report_pending = UINT8_C(1);
    memset(&g_sfera_contours_runtime, 0, sizeof(g_sfera_contours_runtime));
    memset(&g_sfera_dyn_green_runtime, 0, sizeof(g_sfera_dyn_green_runtime));
    memset(&g_sfera_execution_monitor_runtime, 0, sizeof(g_sfera_execution_monitor_runtime));
    memset(&g_sfera_error_log_runtime, 0, sizeof(g_sfera_error_log_runtime));
    memset(&g_sfera_log_runtime, 0, sizeof(g_sfera_log_runtime));
    memset(&g_sfera_log_memory_object, 0, sizeof(g_sfera_log_memory_object));
    memset(&g_sfera_log_warnings_object, 0, sizeof(g_sfera_log_warnings_object));
    memset(&g_sfera_log_errors_object, 0, sizeof(g_sfera_log_errors_object));
    g_sfera_diagnostic_log_byte = 0u;
    memset(&g_sfera_win32_dialog_registry, 0, sizeof(g_sfera_win32_dialog_registry));
    memset(&g_sfera_control_reference_registry, 0, sizeof(g_sfera_control_reference_registry));
    memset(&g_sfera_cursor_texture_registry, 0, sizeof(g_sfera_cursor_texture_registry));
    g_sfera_cursor_texture_registry_guard = 0u;
    memset(&g_sfera_d3d9_semantic_state, 0, sizeof(g_sfera_d3d9_semantic_state));
    g_sfera_control_reference_registry_guard = 0u;
    memset(&g_sfera_crt_startup_runtime, 0, sizeof(g_sfera_crt_startup_runtime));
    memset(&g_sfera_crash_report_runtime, 0, sizeof(g_sfera_crash_report_runtime));
    memset(&g_sfera_packet_codec_runtime, 0, sizeof(g_sfera_packet_codec_runtime));
    memset(&g_sfera_frame_runtime, 0, sizeof(g_sfera_frame_runtime));
    memset(&g_sfera_high_resolution_clock_runtime, 0, sizeof(g_sfera_high_resolution_clock_runtime));
    memset(&g_sfera_profiler_runtime, 0, sizeof(g_sfera_profiler_runtime));
    memset(&g_sfera_crc32_runtime, 0, sizeof(g_sfera_crc32_runtime));
    memset(&g_sfera_ui_load_scratch_runtime, 0, sizeof(g_sfera_ui_load_scratch_runtime));
    memset(&g_sfera_hypertext_scratch_runtime, 0, sizeof(g_sfera_hypertext_scratch_runtime));
    memset(&g_sfera_string_lookup_runtime, 0, sizeof(g_sfera_string_lookup_runtime));
    memset(&g_sfera_ascii_lower_runtime, 0, sizeof(g_sfera_ascii_lower_runtime));
    memset(&g_sfera_model_load_scratch_runtime, 0, sizeof(g_sfera_model_load_scratch_runtime));
    memset(&g_sfera_string_utility_runtime, 0, sizeof(g_sfera_string_utility_runtime));
    memset(&g_sfera_network_probe_runtime, 0, sizeof(g_sfera_network_probe_runtime));
    memset(&g_sfera_config_parse_scratch_runtime, 0, sizeof(g_sfera_config_parse_scratch_runtime));
    memset(&g_sfera_music_runtime, 0, sizeof(g_sfera_music_runtime));
    memset(&g_sfera_container_diagnostics_runtime, 0, sizeof(g_sfera_container_diagnostics_runtime));
    memset(&g_sfera_ole_host_abi, 0, sizeof(g_sfera_ole_host_abi));
    memset(&g_sfera_render_buffer_capacities, 0, sizeof(g_sfera_render_buffer_capacities));
    g_sfera_render_buffer_capacities.vertex32 = 30000u;
    g_sfera_render_buffer_capacities.vertex28 = 30000u;
    g_sfera_render_buffer_capacities.index_primary = 5000u;
    g_sfera_render_buffer_capacities.index_secondary = 5000u;
...
static void sfera_initialize_memory_runtime(void) {
    memset(&g_sfera_memory_runtime, 0, sizeof(g_sfera_memory_runtime));
    memset(&g_sfera_memory_source_hash_runtime, 0, sizeof(g_sfera_memory_source_hash_runtime));
    memset(&g_sfera_allocation_hash_runtime, 0, sizeof(g_sfera_allocation_hash_runtime));
...
extern "C" void sfera_initialize_data_storage(uint8_t* storage) {
    ...
    memset(&g_sfera_server_parser_whitespace, 0, sizeof(g_sfera_server_parser_whitespace));
    memset(&g_sfera_server_parser_path_separators, 0, sizeof(g_sfera_server_parser_path_separators));
    memset(&g_sfera_menu_parser_whitespace, 0, sizeof(g_sfera_menu_parser_whitespace));
    memset(&g_sfera_menu_parser_path_separators, 0, sizeof(g_sfera_menu_parser_path_separators));
    ...
    memset(&g_sfera_main_ui_state_runtime, 0, sizeof(g_sfera_main_ui_state_runtime));
    memset(g_sfera_screen_quad_indices, 0, sizeof(g_sfera_screen_quad_indices));
    memset(&g_sfera_client_config_runtime, 0, sizeof(g_sfera_client_config_runtime));
    memset(&g_sfera_grass_placement_runtime, 0, sizeof(g_sfera_grass_placement_runtime));
    memset(&g_sfera_interface_core_runtime, 0, sizeof(g_sfera_interface_core_runtime));
    memset(&g_sfera_client_main_scalar_runtime, 0, sizeof(g_sfera_client_main_scalar_runtime));
    memset(&g_sfera_inter_scalar_runtime, 0, sizeof(g_sfera_inter_scalar_runtime));
    memset(&g_sfera_texture_set_scalar_runtime, 0, sizeof(g_sfera_texture_set_scalar_runtime));
    memset(&g_sfera_texture_registry_runtime, 0, sizeof(g_sfera_texture_registry_runtime));
    memset(&g_sfera_file_runtime, 0, sizeof(g_sfera_file_runtime));
    memset(&g_sfera_config_parser_runtime, 0, sizeof(g_sfera_config_parser_runtime));
    memset(&g_sfera_effect_manager, 0, sizeof(g_sfera_effect_manager));
