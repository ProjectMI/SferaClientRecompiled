...
__declspec(noinline) void sfera_sub_004D6720(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->esi = cpu->ecx;
    cpu->eax = static_cast<uint32_t>(reinterpret_cast<uintptr_t>(::SetUnhandledExceptionFilter(&sfera_unhandled_exception_filter)));
    ...
    cpu->eax = reinterpret_cast<uint32_t (__stdcall*)(uint32_t, uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::lstrcpyA)))((uintptr_t)&g_sfera_crash_report_runtime.error_log_path[0], (uintptr_t)"Unknown");
    label_000D675C:
    ...
    cpu->eax = reinterpret_cast<uint32_t (__stdcall*)(uint32_t, uint32_t)>(static_cast<uintptr_t>(native_function_address32(&::lstrcpyA)))(cpu->eax, (uintptr_t)"ERRORLOG.TXT");
...
__declspec(noinline) void sfera_sub_004D72A0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4D72CFu)); sfera_memory_deallocate(cpu, LIFT_CODE_TOKEN_VA(0x4D72CFu));
    cpu->esp += 4u;
    label_000D72D2:
    ...
    *(uint8_t*)(cpu->esi + 0xCu) = cpu->ebx & 0xFFu;
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4D72E5u)); sfera_memory_deallocate(cpu, LIFT_CODE_TOKEN_VA(0x4D72E5u));
    cpu->esp += 4u;
    cpu->esi = cpu->edi;
...
__declspec(noinline) void sfera_sub_004D79F0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4D7A2Au)); sfera_memory_allocate_zeroed(cpu, LIFT_CODE_TOKEN_VA(0x4D7A2Au));
    cpu->esp += 4u;
    ...
    *(uint32_t*)(cpu->esi) = cpu->eax;
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4D7A68u)); sfera_memory_allocate_zeroed(cpu, LIFT_CODE_TOKEN_VA(0x4D7A68u));
    cpu->esp += 4u;
    *(uint32_t*)(cpu->esp + 8u) = cpu->eax;
...
__declspec(noinline) void sfera_sub_004D7AF0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esi + 8u) = cpu->ecx;
    lift_push32(cpu, cpu->edi);
    reinterpret_cast<CCursor*>(cpu->ecx)->copyStateFrom(SferaAbi::pointer<CCursor>(*(uint32_t*)(cpu->esp))); cpu->esp += 4u;
    if (cpu->edi == 0u) goto label_000D7B27;
    cpu->ecx = cpu->edi;
    reinterpret_cast<CCursor*>(cpu->edi)->deactivate();
    label_000D7B27:
    cpu->ecx = *(uint32_t*)(cpu->esi + 8u);
    reinterpret_cast<CCursor*>(cpu->ecx)->activate();
    label_000D7B31:
...
__declspec(noinline) void sfera_sub_004D7BF0(LiftCpu* cpu, uint32_t stop_address) {
    auto* self = reinterpret_cast<CHardwareCursor*>(cpu->ecx);
    std::construct_at(self);
    cpu->eax = SferaAbi::address(self);
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_004D7F70(LiftCpu* cpu, uint32_t stop_address) {
    auto* self = reinterpret_cast<CSoftwareCursor*>(cpu->ecx);
    std::construct_at(self);
    cpu->eax = SferaAbi::address(self);
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_004D8370(LiftCpu* cpu, uint32_t stop_address) { bool sub_pred[1];
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = 0x1Eu;
    ...
    label_000D83E6:
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD83E6u));
    ...
    *(uint32_t*)(cpu->ebx) = 0x15u;
    ...
    cpu->eax = *(uint32_t*)(cpu->edx + 0x24u);
    label_000D842F:
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD842Fu));
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->eax;
...
__declspec(noinline) void sfera_sub_004D84A0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->ebp) = 0x47u;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8516u));
...
__declspec(noinline) void sfera_sub_004D8560(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD859Bu));
    cpu->ebx = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->ebx;
    ...
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x114u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD85DBu));
    cpu->ebx = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->ebx;
    ...
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x114u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD861Bu));
    cpu->ebx = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->ebx;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD8656u));
    cpu->ebx = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->ebx;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD8691u));
    cpu->ebx = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->ebx;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD86CCu));
    cpu->ebx = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->ebx;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD8707u));
    cpu->ebx = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->ebx;
...
__declspec(noinline) void sfera_sub_004D8740(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD875Au));
    cpu->esi = cpu->eax;
...
__declspec(noinline) void sfera_sub_004D8790(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x114u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD87AFu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D87E0(LiftCpu* cpu, uint32_t stop_address) { double x87_v0;
    ...
    *(float*)(cpu->esp) = x87_v0; 
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8811u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8840(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD8850u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8880(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD88A1u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D88E0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD88FCu));
    cpu->ebx = cpu->eax;
...
__declspec(noinline) void sfera_sub_004D8970(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8981u));
...
__declspec(noinline) void sfera_sub_004D89E0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8A02u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8A40(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x2Cu);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8A62u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8AA0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD8AAEu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8AE0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 0x30u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD8AEEu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8B20(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8B35u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8B70(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8B85u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8BC0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8BD5u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8C10(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8C2Au));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8C60(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8C7Au));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8CE0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8CFAu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8D30(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8D4Au));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8D80(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8D95u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8DD0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8DE5u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8E20(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8E35u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8F40(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8F5Au));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8F90(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD8FAFu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D8FE0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD9018u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D9050(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD9074u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D90B0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD90C9u));
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->eax;
...
__declspec(noinline) void sfera_sub_004D90F0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD910Au));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D9140(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD915Au));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
...
__declspec(noinline) void sfera_sub_004D9190(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD91A3u));
    cpu->edx = *(uint32_t*)(cpu->esp + 8u);
    cpu->eax = *(uint32_t*)(cpu->esi + 4u);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    lift_push32(cpu, cpu->edx); lift_push32(cpu, 0x13u); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0xE4u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD91B8u));
    cpu->edx = *(uint32_t*)(cpu->esp + 0xCu);
    cpu->esi = *(uint32_t*)(cpu->esi + 4u);
    cpu->ecx = *(uint32_t*)(cpu->esi);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0xE4u);
    lift_push32(cpu, cpu->edx); lift_push32(cpu, 0x14u); lift_push32(cpu, cpu->esi);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD91CDu));
    cpu->esi = lift_pop32(cpu); cpu->esp += 0xCu; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_004D91E0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD91F0u));
    cpu->esp += 4u; cpu->eip = stop_address; return;
}
...
__declspec(noinline) void sfera_sub_004D9250(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x10Cu);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD926Cu));
    cpu->edx = *(uint32_t*)(cpu->esp + 0x14u);
    cpu->eax = *(uint32_t*)(cpu->esi + 4u);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    lift_push32(cpu, cpu->edx); lift_push32(cpu, 5u); lift_push32(cpu, cpu->edi); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x10Cu);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD9282u));
    cpu->edx = *(uint32_t*)(cpu->esp + 0x18u);
    cpu->esi = *(uint32_t*)(cpu->esi + 4u);
    cpu->ecx = *(uint32_t*)(cpu->esi);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x10Cu);
    lift_push32(cpu, cpu->edx); lift_push32(cpu, 6u); lift_push32(cpu, cpu->edi); lift_push32(cpu, cpu->esi);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD9298u));
    cpu->edi = lift_pop32(cpu); cpu->esi = lift_pop32(cpu); cpu->esp += 0x14u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_004D92A0(LiftCpu* cpu, uint32_t stop_address) { bool sub_pred[1];
    ...
    *(uint32_t*)(cpu->esp + 4u) = cpu->eax;
    ...
    cpu->eax = *(uint32_t*)(cpu->ecx + 0xE4u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD92EAu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->ebx + 0x40u) = cpu->esi;
    ...
    cpu->eax = *(uint32_t*)(cpu->ecx + 0xE4u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD932Eu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->ebx + 0x40u) = cpu->esi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD936Fu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->ebx + 0x40u) = cpu->esi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD93A5u));
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x164u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD93BFu));
    ...
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD9411u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD9489u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->ebx + 0x40u) = cpu->esi;
    ...
    lift_push32(cpu, cpu->ebp); lift_push32(cpu, 0u); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x190u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD94E9u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
    ...
    lift_native_call(cpu, cpu->ecx, LIFT_CODE_TOKEN_RVA(0xD9535u));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->ebx + 0x40u) = cpu->esi;
    if ((int32_t)cpu->esi >= 0) goto label_000D955F;
    lift_push32(cpu, cpu->esi);
...
__declspec(noinline) void sfera_sub_004D9580(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, 0x89u); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0xE4u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD95B5u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->ebx + 0x40u) = cpu->edi;
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, 0x16u); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0xE4u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xD9604u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->ebx + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD964Cu));
    cpu->esi = cpu->eax;
    *(uint32_t*)(cpu->edi + 0x40u) = cpu->esi;
    ...
    lift_native_call(cpu, cpu->ecx, LIFT_CODE_TOKEN_RVA(0xD96B1u));
    cpu->esi = cpu->eax;
...
__declspec(noinline) void sfera_sub_004D98D0(LiftCpu* cpu, uint32_t stop_address) {
    auto* vector = reinterpret_cast<UnmanagedResourceVector*>(cpu->ecx);
    std::uint32_t requested = *(uint32_t*)(cpu->esp + 4u);
    if (requested < vector->size) requested = vector->size;
    if (vector->invalidation_target != nullptr) *vector->invalidation_target = 0u;
    if (requested == 0u) { if (vector->allocator != nullptr) vector->allocator->deallocate(vector->resources); vector->resources = nullptr; vector->capacity = 0u; cpu->esp += 8u; cpu->eip = stop_address; return; }
    if (vector->allocator != nullptr) { auto* replacement = static_cast<std::uint32_t*>(vector->allocator->allocate(static_cast<std::size_t>(requested) * sizeof(std::uint32_t), vector->allocation_flags)); if (replacement != nullptr) { if (vector->resources != nullptr && vector->size != 0u) std::memcpy(replacement, vector->resources, static_cast<std::size_t>(vector->size) * sizeof(std::uint32_t)); vector->allocator->deallocate(vector->resources); vector->resources = replacement; vector->capacity = requested; } }
    cpu->esp += 8u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_004D9970(LiftCpu* cpu, uint32_t stop_address) { double x87_p0;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9992u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD99CCu));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9A06u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9A40u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9A7Au));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9AB4u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9AEEu));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9B2Bu));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    *(uint32_t*)(cpu->esp + 0x14u) = cpu->ecx;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9BA9u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9BE3u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9C20u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9C5Au));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9C94u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9CD1u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9D0Eu));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
...
__declspec(noinline) void sfera_sub_004D9D60(LiftCpu* cpu, uint32_t stop_address) {
    cpu->eax = *(uint32_t*)(void*)&g_sfera_client_config_runtime.gpu_sync_query;
    lift_push32(cpu, cpu->esi);
    cpu->esi = 0u;
    lift_push32(cpu, cpu->edi);
    cpu->edi = cpu->ecx;
    ...
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9D75u));
    (*(uint32_t*)(void*)&g_sfera_client_config_runtime.gpu_sync_query) = cpu->esi;
    label_000D9D7D:
    ...
    reinterpret_cast<UnmanagedResourceBase*>(cpu->ecx)->releaseResource();
    ++cpu->esi;
...
__declspec(noinline) void sfera_sub_004D9DC0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->esi = g_sfera_graphics_runtime.d3d9_device_runtime;
    cpu->eax = *(uint32_t*)(cpu->esi + 4u);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = *(uint32_t*)(cpu->ecx + 0x1D8u);
    lift_push32(cpu, (uintptr_t)&g_sfera_client_config_runtime.gpu_sync_query); lift_push32(cpu, 8u); lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xD9DE3u));
    cpu->ebx = 0u;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->eax;
    ...
    cpu->eax = *(uint32_t*)(cpu->edi + 0x17Cu);
    cpu->ecx = *(uint32_t*)(cpu->eax + (cpu->esi * 4u));
    reinterpret_cast<UnmanagedResourceBase*>(cpu->ecx)->restoreResource();
    ++cpu->esi;
...
__declspec(noinline) void sfera_sub_004D9F50(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->eax) = 0u;
    ...
    lift_push32(cpu, cpu->ecx);
    cpu->ecx = cpu->esi;
    reinterpret_cast<UnmanagedResourceVector*>(cpu->esi)->reserve(*(uint32_t*)(cpu->esp)); cpu->esp += 4u;
...
__declspec(noinline) void sfera_sub_004D9FE0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->eax;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDA0C2u));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    *(uint32_t*)(cpu->eax + 0xCu) = cpu->ecx;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDA148u));
    ...
    *(uint32_t*)(cpu->esi + 0x20u) = cpu->ecx;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDA224u));
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->eax;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDA242u));
...
__declspec(noinline) void sfera_sub_004DA310(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDA31Du));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x40u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDA34Du));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
    ...
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDA3AFu));
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->esi + 0x40u) = cpu->edi;
...
__declspec(noinline) void sfera_sub_004DA450(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDA466u));
...
__declspec(noinline) void sfera_sub_004DA490(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDA4A6u));
    *(uint32_t*)(cpu->esi + 4u) = 0u;
    label_000DA4AF:
...
__declspec(noinline) void sfera_sub_004DA4D0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDA4E6u));
    *(uint32_t*)(cpu->esi + 4u) = 0u;
    label_000DA4EF:
...
__declspec(noinline) void sfera_sub_004DA670(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->edi;
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDA6ACu));
    *(uint32_t*)(cpu->esi + 4u) = cpu->edi;
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDA6BDu));
...
__declspec(noinline) void sfera_sub_004DA720(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->eax;
    ...
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->ecx, LIFT_CODE_TOKEN_RVA(0xDA768u));
    cpu->edx = *(uint32_t*)(cpu->esp + 0x14u);
    cpu->edi = cpu->eax;
...
__declspec(noinline) void sfera_sub_004DA7D0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 0x24u) = cpu->eax;
    ...
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->ecx, LIFT_CODE_TOKEN_RVA(0xDA818u));
    cpu->edx = *(uint32_t*)(cpu->esp + 0x14u);
    cpu->edi = cpu->eax;
    *(uint32_t*)(cpu->edx + 0x40u) = cpu->edi;
...
__declspec(noinline) void sfera_sub_004DA880(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esi + 0x1Cu) = cpu->ebx;
    cpu->ebp = g_sfera_graphics_runtime.d3d9_device_runtime;
...
__declspec(noinline) void sfera_sub_004DAA60(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_push32(cpu, cpu->esi); lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDAA7Cu));
    cpu->esi = cpu->eax;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDAACAu));
    cpu->esi = cpu->eax;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDAB1Bu));
    cpu->esi = cpu->eax;
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDAB6Bu));
    cpu->esi = cpu->eax;
...
__declspec(noinline) void sfera_sub_004DACD0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esp + 8u) = 0u;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDAD00u));
    cpu->ecx = *(uint32_t*)(cpu->esp + 4u);
    lift_push32(cpu, cpu->ecx);
    cpu->ecx = g_sfera_graphics_runtime.d3d9_device_runtime;
    lift_push32(cpu, 0u);
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDAD22u));
    label_000DAD24:
...
__declspec(noinline) void sfera_sub_004DAD30(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDAD43u));
    *(uint32_t*)(cpu->esi + 0x8Cu) = 0u;
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDAD5Fu));
    *(uint32_t*)(cpu->esi + 0x90u) = 0u;
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDAD78u));
    *(uint32_t*)(cpu->esi + 4u) = 0u;
    label_000DAD81:
    cpu->eax = *(uint32_t*)(cpu->esi);
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDAD8Du));
    *(uint32_t*)(cpu->esi) = 0u;
    label_000DAD95:
    cpu->esi = lift_pop32(cpu); cpu->esp += 4u; cpu->eip = stop_address; return;
}
__declspec(noinline) void sfera_sub_004DADA0(LiftCpu* cpu, uint32_t stop_address) { double x87_p0, x87_p1, x87_p2, x87_p3, x87_p4, x87_p5;
    ...
    *(uint32_t*)(cpu->esp + 0x1Cu) = cpu->esi;
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDADCAu));
    cpu->eax = *(uint32_t*)(cpu->esp + 0x10u);
    cpu->ecx = *(uint32_t*)(cpu->eax);
    cpu->edx = cpu->esp + 0x3Cu;
    lift_push32(cpu, cpu->edx); lift_push32(cpu, cpu->eax);
    cpu->eax = *(uint32_t*)(cpu->ecx + 0x30u);
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDADDBu));
    ...
    *(uint32_t*)(cpu->esp + 0x40u) = cpu->edx;
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDAE0Cu));
...
__declspec(noinline) void sfera_sub_004DB000(LiftCpu* cpu, uint32_t stop_address) {
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDB014u));
...
__declspec(noinline) void sfera_sub_004DB030(LiftCpu* cpu, uint32_t stop_address) { double x87_v0, x87_v1, x87_v2, x87_v3, x87_v4, x87_v5;
    ...
    cpu->edx = *(uint32_t*)(cpu->ecx + 8u);
    lift_push32(cpu, cpu->eax);
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDB068u));
    *(uint32_t*)(cpu->ebx) = 0u;
    label_000DB070:
    cpu->eax = *(uint32_t*)(cpu->ebx + 4u);
    cpu->ecx = g_sfera_graphics_runtime.d3d9_device_runtime;
...
__declspec(noinline) void sfera_sub_004DB280(LiftCpu* cpu, uint32_t stop_address) {
    ...
    lift_native_call(cpu, cpu->edx, LIFT_CODE_TOKEN_RVA(0xDB29Au));
    cpu->esi = cpu->eax;
    ...
    *(uint32_t*)(cpu->esp + 0x20u) = 2u;
    ...
    lift_native_call(cpu, cpu->eax, LIFT_CODE_TOKEN_RVA(0xDB2EBu));
...
__declspec(noinline) void sfera_sub_004DB330(LiftCpu* cpu, uint32_t stop_address) { double value_0, value_1;
...
label_000DB3C0:
    ...
    *(float*)(cpu->esp + 0x14u) = (double)*(float*)(cpu->esp + 0x1Cu);
    x87_p0 = (double)*(float*)(cpu->esp + 0x14u);
     value_0 = x87_p0; if (!(((double)*(float*)(cpu->esp + 0x10u))<(value_0))) goto label_000DB427;
...
__declspec(noinline) void sfera_sub_004DBBE0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->esi + 0xCu) = 0x14u;
    ...
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->eax);
    cpu->eax = SferaAbi::address(reinterpret_cast<StdAllocator*>(cpu->ecx)->allocate(*(uint32_t*)(cpu->esp), *(uint32_t*)(cpu->esp + 4u))); cpu->esp += 8u;
    cpu->ecx = *(uint32_t*)(cpu->esi + 0x48u);
    *(uint32_t*)(cpu->esi + 4u) = cpu->eax;
    lift_push32(cpu, cpu->ebx); lift_push32(cpu, cpu->ebp);
    cpu->eax = SferaAbi::address(reinterpret_cast<StdAllocator*>(cpu->ecx)->allocate(*(uint32_t*)(cpu->esp), *(uint32_t*)(cpu->esp + 4u))); cpu->esp += 8u;
...
__declspec(noinline) void sfera_sub_004DBDD0(LiftCpu* cpu, uint32_t stop_address) {
    ...
    *(uint32_t*)(cpu->ebp + 0xCu) = cpu->ecx;
    ...
    lift_push32(cpu, cpu->edx);
    cpu->eax = SferaAbi::address(reinterpret_cast<StdAllocator*>(cpu->ecx)->reallocate(SferaAbi::pointer<void>(*(uint32_t*)(cpu->esp)), *(uint32_t*)(cpu->esp + 4u), *(uint32_t*)(cpu->esp + 8u))); cpu->esp += 0xCu;
...
__declspec(noinline) void sfera_sub_004DD550(LiftCpu* cpu, uint32_t stop_address) {
    ...
    switch (cpu->eax) {
        ...
        default: cpu->eip = 0x4DD560u; throw std::out_of_range("resolved jump-table index out of range"); return;
    }
label_000DD567: ;
...
__declspec(noinline) void sfera_sub_004DD660(LiftCpu* cpu, uint32_t stop_address) { double x87_v0;
    ...
    *(uint8_t*)(cpu->ebp + 0xA0u) = 0u;
    ...
    lift_push32(cpu, LIFT_CODE_TOKEN_VA(0x4DD6DCu)); sfera_memory_allocate_zeroed(cpu, LIFT_CODE_TOKEN_VA(0x4DD6DCu));
    cpu->esp += 4u;
    *(uint32_t*)(cpu->esp + 0x18u) = cpu->eax;
